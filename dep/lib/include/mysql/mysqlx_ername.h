...
{"ER_X_BAD_MESSAGE", ER_X_BAD_MESSAGE, "", NULL, NULL, 0},
    ...
    {"ER_X_BAD_CONNECTION_SESSION_ATTRIBUTE_VALUE_LENGTH",
     ...
     NULL,
     0},
    {"ER_X_BAD_CONNECTION_SESSION_ATTRIBUTE_KEY_LENGTH",
     ER_X_BAD_CONNECTION_SESSION_ATTRIBUTE_KEY_LENGTH,
     "",
     NULL,
     NULL,
     0},
    {"ER_X_BAD_CONNECTION_SESSION_ATTRIBUTE_EMPTY_KEY",
     ER_X_BAD_CONNECTION_SESSION_ATTRIBUTE_EMPTY_KEY,
     "",
     NULL,
     NULL,
    ...
    {"ER_X_SERVICE_ERROR", ER_X_SERVICE_ERROR, "", NULL, NULL, 0}, {"ER_X_SESSION", ER_X_SESSION, "", NULL, NULL, 0},
    ...
    {"ER_X_BAD_SCHEMA", ER_X_BAD_SCHEMA, "", NULL, NULL, 0}, {"ER_X_BAD_TABLE", ER_X_BAD_TABLE, "", NULL, NULL, 0},
