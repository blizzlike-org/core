...
#define mysql_declare_client_plugin(X)                                                                                 \
  MYSQL_PLUGIN_EXPORT st_mysql_client_plugin_##X _mysql_client_plugin_declaration_ = {                                 \
      MYSQL_CLIENT_##X##_PLUGIN, MYSQL_CLIENT_##X##_PLUGIN_INTERFACE_VERSION,
...
/**
  ...
  a pointer to the loaded plugin, or NULL in case of a failure
*/
struct st_mysql_client_plugin *mysql_load_plugin_v(struct MYSQL *mysql, const char *name, int type, int argc,
                                                   va_list args);
