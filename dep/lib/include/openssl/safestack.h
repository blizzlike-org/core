...
#define SKM_DEFINE_STACK_OF(t1, t2, t3)                                                                                \
  ...
  static ossl_unused ossl_inline void sk_##t1##_free(STACK_OF(t1) * sk) { OPENSSL_sk_free((OPENSSL_STACK *)sk); }      \
  static ossl_unused ossl_inline void sk_##t1##_zero(STACK_OF(t1) * sk) { OPENSSL_sk_zero((OPENSSL_STACK *)sk); }      \
  ...
  static ossl_unused ossl_inline void sk_##t1##_sort(STACK_OF(t1) * sk) { OPENSSL_sk_sort((OPENSSL_STACK *)sk); }      \
