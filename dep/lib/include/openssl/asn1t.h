...
#define ASN1_SEQUENCE_END_ref(stname, tname)                                                                           \
  ;                                                                                                                    \
  ASN1_ITEM_start(tname) ASN1_ITYPE_SEQUENCE, V_ASN1_SEQUENCE, tname##_seq_tt,                                         \
      sizeof(tname##_seq_tt) / sizeof(ASN1_TEMPLATE), &tname##_aux, sizeof(stname), #tname ASN1_ITEM_end(tname)
...
#define ASN1_ADB_END(name, flags, field, adb_cb, def, none)                                                            \
  ...
  static const ASN1_ITEM *name##_adb(void) {                                                                           \
    static const ASN1_ADB internal_adb =                                                                               \
        {flags, offsetof(name, field), adb_cb, name##_adbtbl, sizeof(name##_adbtbl) / sizeof(ASN1_ADB_TABLE), def,     \
         none};                                                                                                        \
