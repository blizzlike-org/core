...
static const wchar_t *soap_wstring(struct soap *soap, const char *s, int flag, long minlen, long maxlen,
                                   const char *pattern);
static wchar_t *soap_wcollapse(struct soap *soap, wchar_t *s, int flag, int insitu);
#endif

#ifndef PALM_2
static const char *soap_string(struct soap *soap, const char *s, int flag, long minlen, long maxlen,
                               const char *pattern);
...
#ifndef WITH_LEANER
#ifndef PALM_1
static struct soap_multipart *soap_alloc_multipart(struct soap *, struct soap_multipart **, struct soap_multipart **,
                                                   char *, size_t);
  ...
  while (n) {
    if (soap_valid_socket(sk)) {
      ...
      if (soap->ssl)
        ...
        if (soap->peerlen)
          nwritten = sendto(sk, (char *)s, (SOAP_WINSOCKINT)n, soap->socket_flags, &soap->peer.addr,
...
int SOAP_FMAC2 soap_flush_raw(struct soap *soap, const char *s, size_t n) {
  ...
  DBGMSG(SENT, s, n);
  DBGLOG(TEST,
         SOAP_MESSAGE(fdebug, "Send %u bytes to socket=%d/fd=%d\n", (unsigned int)n, (int)soap->socket, soap->sendfd));
#endif
...
#ifndef PALM_1
SOAP_FMAC1
int SOAP_FMAC2 soap_send_key(struct soap *soap, const char *s) {
...
#ifndef PALM_1
SOAP_FMAC1
int SOAP_FMAC2 soap_send_val(struct soap *soap, const char *s) {
  ...
  if (soap->is) /* recv from C++ stream */
  {
    if (soap->is->good())
      return (size_t)soap->is->read(s, (std::streamsize)n)
          .gcount(); /* downcast to std::streamsize is OK: gcount() returns how much we got in s[] */
    return 0;
  }
#else
    ...
    for (;;) {
...
#endif
      {
        ...
        if ((soap->omode & SOAP_IO_UDP)) {
          ...
          r = recvfrom(sk, s, (SOAP_WINSOCKINT)n, soap->socket_flags, &soap->peer.addr,
                       &k); /* portability note: see SOAP_SOCKLEN_T definition in stdsoap2.h, SOAP_WINSOCKINT cast is
                               safe due to limited range of n in the engine (64K) */
...
#endif
          r = recv(sk, s, (SOAP_WINSOCKINT)n,
                   soap->socket_flags); /* SOAP_WINSOCKINT cast is safe due to limited range of n in the engine (64K) */
#ifdef PALM
...
int SOAP_FMAC2 soap_recv_raw(struct soap *soap) {
      ...
      if (r == Z_OK || r == Z_STREAM_END) {
        ...
        if (ret) {
          ...
          if (soap->count > SOAP_MAXINFLATESIZE && soap->z_ratio_in < SOAP_MINDEFLATERATIO) {
            soap->d_stream->msg = (char *)"caught SOAP_MINDEFLATERATIO explosive decompression guard (remedy: increase "
                                          "SOAP_MAXINFLATESIZE and/or decrease SOAP_MINDEFLATERATIO)";
            return soap->error = SOAP_ZLIB_ERROR;
          }
  ...
  if ((soap->mode & SOAP_IO) == SOAP_IO_CHUNK) /* read HTTP chunked transfer */
  {
    for (;;) {
      ...
      if (soap->chunksize) {
        soap->buflen = ret =
            soap->frecv(soap, soap->buf, soap->chunksize > sizeof(soap->buf) ? sizeof(soap->buf) : soap->chunksize);
...
int SOAP_FMAC2 soap_recv(struct soap *soap) {
  ...
  if (soap->ffilterrecv) {
    ...
    DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Filter recverror = %d bufidx = %lu buflen = %lu\n", soap->recverror,
                              (unsigned long)soap->bufidx, (unsigned long)soap->buflen));
    if (soap->recverror)
      soap->bufidx = soap->buflen = 0;
    else {
      soap->bufidx = soap->buflen = 0;
...
ULONG64
SOAP_FMAC2
soap_tell(struct soap *soap) { return soap->count - soap->buflen + soap->bufidx - (soap->ahead != 0); }
#endif
#endif
...
#ifdef WITH_REPLACE_ILLEGAL_UTF8
  if (!(c == 0x09 || c == 0x0A || c == 0x0D || (c >= 0x80 && c <= 0xD7FF) || (c >= 0xE000 && c <= 0xFFFD) ||
...
int SOAP_FMAC2 soap_xop_forward(struct soap *soap, unsigned char **ptr, int *size, char **id, char **type,
                                char **options) { /* Check MTOM xop:Include element (within hex/base64Binary) */
...
#ifndef PALM_1
SOAP_FMAC1
int SOAP_FMAC2 soap_attachment_forward(struct soap *soap, unsigned char **ptr, int *size, char **id, char **type,
                                       char **options) {
...
void *SOAP_FMAC2 soap_push_block(struct soap *soap, struct soap_blist *b, size_t n) {
  ...
  DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Push block %p of %u bytes on %lu previous blocks (%lu bytes total)\n", (void *)p,
                            (unsigned int)n, (unsigned long)b->item, (unsigned long)b->size));
  b->item++;
...
#ifndef PALM_1
SOAP_FMAC1
void *SOAP_FMAC2 soap_push_block_max(struct soap *soap, struct soap_blist *b, size_t n) {
...
#ifndef PALM_1
SOAP_FMAC1
void SOAP_FMAC2 soap_update_pointers(struct soap *soap, const char *dst, const char *src, size_t len) {
        ...
        if (ip->shaky) {
          ...
          if (ip->ptr && ip->ptr >= start && ip->ptr < end) {
            DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Update ptr %p -> %p\n", ip->ptr,
                                      (void *)((const char *)ip->ptr + (dst - src))));
          ...
          for (fp = ip->flist; fp; fp = fp->next) {
            if (fp->ptr >= start && fp->ptr < end) {
              DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Copy list update id='%s' target type=%d %p -> %p\n", ip->id, fp->type,
                                        fp->ptr, (void *)((char *)fp->ptr + (dst - src))));
  ...
  for (xp = soap->xlist; xp; xp = xp->next) {
    if (xp->ptr && (void *)xp->ptr >= start && (void *)xp->ptr < end) {
      DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Update attachment id='%s' %p -> %p\n", xp->id ? xp->id : SOAP_STR_EOS,
                                (void *)xp->ptr, (void *)((char *)xp->ptr + (dst - src))));
...
int SOAP_FMAC2 soap_resolve(struct soap *soap) {
  ...
  for (i = 0; i < SOAP_IDHASH; i++) {
    ...
    for (ip = soap->iht[i]; ip; ip = ip->next) {
      if (ip->ptr) {
        ...
        ip->link = NULL;
        DBGLOG(TEST,
               if (q) SOAP_MESSAGE(fdebug, "Traversing link chain to resolve id='%s' type=%d\n", ip->id, ip->type));
        while (q) {
          void *p = *q;
          *q = ip->ptr;
          ...
          if (ip->ptr && !soap_has_copies(soap, (const char *)ip->ptr, (const char *)ip->ptr + ip->size)) {
            ...
            while ((fp = ip->flist)) {
              DBGLOG(TEST, SOAP_MESSAGE(
                               fdebug, "Resolving forwarded data type=%d target type=%d location=%p level=%u id='%s'\n",
  ...
  if (id) {
    DBGLOG(TEST, SOAP_MESSAGE(fdebug,
                              ...
                              "this problem to the gSOAP developers\n",
                              id));
...
char *SOAP_FMAC2 soap_next_block(struct soap *soap, struct soap_blist *b) {
  ...
  if (p) {
    b->head = p->next;
    DBGLOG(TEST,
           SOAP_MESSAGE(fdebug, "Next block %p, deleting current block\n", (void *)(b->head ? b->head + 1 : NULL)));
    SOAP_FREE(soap, p);
    if (b->head)
...
struct soap_nlist *SOAP_FMAC2 soap_push_namespace(struct soap *soap, const char *id, const char *ns) {
  ...
  if (sizeof(struct soap_nlist) + n + k > n &&
      (SOAP_MAXALLOCSIZE <= 0 || sizeof(struct soap_nlist) + n + k <= SOAP_MAXALLOCSIZE))
...
void SOAP_FMAC2 soap_pop_namespace(struct soap *soap) {
  ...
  for (np = soap->nlist; np && np->level >= soap->level; np = nq) {
    nq = np->next;
    DBGLOG(TEST,
           SOAP_MESSAGE(fdebug, "Pop namespace binding (level=%u) '%s' level=%u\n", soap->level, np->id, np->level));
    SOAP_FREE(soap, np);
  }
  soap->nlist = np;
}
...
#ifndef PALM_2
SOAP_FMAC1
const char *SOAP_FMAC2 soap_current_namespace_tag(struct soap *soap, const char *tag) {
...
#ifndef PALM_2
SOAP_FMAC1
const char *SOAP_FMAC2 soap_current_namespace_att(struct soap *soap, const char *tag) {
  struct soap_nlist *np;
  const char *s;
  if (!tag || !strncmp(tag, "xml", 3))
    return NULL;
  ...
  if (s) {
    if (!(soap->mode & SOAP_XML_IGNORENS) || SOAP_STRCMP(s + 1, tag2)) /* always fails (except when ignoring ns) */
      return SOAP_TAG_MISMATCH;
             ...
             ((soap->mode & SOAP_XML_STRICT) && !(soap->mode & SOAP_XML_IGNORENS) &&
              soap_match_namespace(soap, tag1, tag2, 0,
                                   0))) /* strict checking: default namespace must be null namespace */
    return SOAP_TAG_MISMATCH;
...
#ifndef PALM_2
SOAP_FMAC1
int SOAP_FMAC2 soap_match_att(struct soap *soap, const char *tag1, const char *tag2) {
  const char *s, *t;
  int err;
  if (!tag1 || !tag2 || !*tag2)
    return SOAP_OK;
...
soap_ssl_init() { /* Note: for MT systems, the main program MUST call soap_ssl_init() before any threads are started */
  if (!soap_ssl_init_done) {
    ...
    if (!RAND_load_file(
            "/dev/urandom",
            1024)) { /* /dev/urandom should exist, if not we do some pertubations to seed the OpenSSL PRNG */
      char buf[1024];
...
#ifndef PALM_2
SOAP_FMAC1
void SOAP_FMAC2 soap_ssl_noinit() { /* Call this first to bypass SSL init is SSL is already initialized elsewhere */
  soap_ssl_init_done = 1;
}
#endif
#endif
...
const char *SOAP_FMAC2 soap_ssl_error(struct soap *soap, int ret) {
  ...
  if (ERR_peek_error()) {
    ...
    switch (ret) {
    case 0:
      soap_strcpy(soap->msgbuf + l, sizeof(soap->msgbuf) - l,
    ...
    case -1: {
      ...
      (SOAP_SNPRINTF(soap->msgbuf + l, sizeof(soap->msgbuf) - l, strlen(s) + 42),
       "Error observed by underlying SSL/TLS BIO: %s", s);
    } break;
    }
  }
  return soap->msgbuf;
...
static int ssl_auth_init(struct soap *soap) {
  ...
  if (!(soap->ssl_flags & SOAP_SSL_NO_DEFAULT_CA_PATH)) {
    if (!SSL_CTX_set_default_verify_paths(soap->ctx))
      return soap_set_receiver_error(soap, "SSL/TLS error", "Can't read default CA PEM file and/or directory",
                                     SOAP_SSL_ERROR);
  }
  if (soap->crlfile) {
  ...
  if (soap->keyfile) {
    if (!SSL_CTX_use_certificate_chain_file(soap->ctx, soap->keyfile))
      return soap_set_receiver_error(soap, "SSL/TLS error", "Can't find or read certificate in private key PEM file",
                                     SOAP_SSL_ERROR);
    if (soap->password) {
  ...
  if (!soap->xcred) {
    ...
    if (soap->keyfile) {
      if (gnutls_certificate_set_x509_key_file(soap->xcred, soap->keyfile, soap->keyfile, GNUTLS_X509_FMT_PEM) <
          0) /* Assumes that key and cert(s) are concatenated in the keyfile */
        return soap_set_receiver_error(soap, "SSL/TLS error", "Can't read private key PEM file", SOAP_SSL_ERROR);
    }
  }
  ...
  if (!soap->ctx) {
    ...
    if (err == GSK_OK)
      err =
          gsk_attribute_set_buffer(soap->ctx, GSK_KEYRING_FILE, soap->keyfile, 0); /* keyfile is a keyring .kdb file */
    if (err == GSK_OK)
...
static int ssl_verify_callback(int ok, X509_STORE_CTX *store) {
  ...
  if (!ok) {
    ...
    case X509_V_ERR_CRL_HAS_EXPIRED:
      ...
      ok = 1;
      fprintf(stderr, "Initialize soap_ssl_client_context with SOAP_SSL_ALLOW_EXPIRED_CERTIFICATE to allow this "
...
static int ssl_verify_callback_allow_expired_certificate(int ok, X509_STORE_CTX *store) {
  ...
  if (!ok) { /* accept self signed certificates, expired certificates, and certficiates w/o CRL */
...
int SOAP_FMAC2 soap_ssl_accept(struct soap *soap) {
  ...
  if (err != GSK_OK)
    return soap_set_receiver_error(soap, gsk_strerror(err), "gsk_secure_socket_init() failed in soap_ssl_accept()",
                                   SOAP_SSL_ERROR);
#endif
...
static SOAP_SOCKET tcp_connect(struct soap *soap, const char *endpoint, const char *host, int port) {
  ...
  if (soap_valid_socket(soap->socket)) {
    if ((soap->omode & SOAP_IO_UDP) && soap->socket == soap->master) {
      ...
      if (soap_memcpy((void *)&soap->peer.storage, sizeof(soap->peer.storage), (const void *)res->ai_addr,
                      res->ai_addrlen)) {
        soap->error = SOAP_EOM;
        soap->fclosesocket(soap, soap->socket);
        freeaddrinfo(res);
      ...
      if (soap->ipv4_multicast_ttl) {
        ...
        if (setsockopt(soap->socket, IPPROTO_IP, IP_MULTICAST_TTL, (char *)&ttl, sizeof(ttl))) {
          ...
          soap_set_receiver_error(soap, tcp_error(soap), "setsockopt IP_MULTICAST_TTL failed in tcp_connect()",
                                  SOAP_TCP_ERROR);
          soap->fclosesocket(soap, soap->socket);
          return soap->socket = SOAP_INVALID_SOCKET;
        }
      ...
      if (soap->ipv4_multicast_if && !soap->ipv6_multicast_if) {
        if (setsockopt(soap->socket, IPPROTO_IP, IP_MULTICAST_IF, (char *)soap->ipv4_multicast_if,
                       sizeof(struct in_addr)))
#ifndef WINDOWS
        {
          soap->errnum = soap_socket_errno(soap->socket);
          soap_set_receiver_error(soap, tcp_error(soap), "setsockopt IP_MULTICAST_IF failed in tcp_connect()",
                                  SOAP_TCP_ERROR);
          soap->fclosesocket(soap, soap->socket);
          return soap->socket = SOAP_INVALID_SOCKET;
        }
...
again:
  ...
  if ((soap->connect_flags & ~SO_LINGER) &&
      setsockopt(sk, SOL_SOCKET, soap->connect_flags & ~SO_LINGER, (char *)&set, sizeof(int))) {
    soap->errnum = soap_socket_errno(sk);
  ...
  if (endpoint && !soap_tag_cmp(endpoint, "https:*")) {
      ...
      if ((r = SSL_connect(soap->ssl)) <= 0) {
        ...
        if (err == SSL_ERROR_WANT_CONNECT || err == SSL_ERROR_WANT_READ || err == SSL_ERROR_WANT_WRITE) {
          ...
          if (s < 0) {
            ...
            soap_set_receiver_error(soap, soap_ssl_error(soap, r), "SSL_connect failed in tcp_connect()",
                                    SOAP_TCP_ERROR);
            soap->fclosesocket(soap, sk);
            return soap->socket = SOAP_INVALID_SOCKET;
          }
              ...
              if (data) {
                ...
                if (val) {
                  ...
                  for (j = 0; j < sk_CONF_VALUE_num(val); j++) {
                    ...
                    if (nval && (!strcmp(nval->name, "DNS") || !strcmp(nval->name, "IP Address")) &&
              ...
              if (!soap_tag_cmp(host, tmp)) {
                ...
                if (tmp) {
                  if (!soap_tag_cmp(host, (const char *)tmp)) {
                    ok = 1;
                    DBGLOG(TEST,
                           SOAP_MESSAGE(fdebug, "SSL: host name %s match with certificate subject %s\n", host, tmp));
    ...
    while ((err = gsk_secure_socket_init(soap->ssl)) != GSK_OK) {
      if (err == GSK_WOULD_BLOCK_READ || err == GSK_WOULD_BLOCK_WRITE) {
        ...
        if (r < 0) {
          DBGLOG(TEST, SOAP_MESSAGE(fdebug, "SSL_connect/select error in tcp_connect\n"));
          soap_set_receiver_error(soap, gsk_strerror(err), "gsk_secure_socket_init failed in tcp_connect()",
                                  SOAP_TCP_ERROR);
          soap->fclosesocket(soap, sk);
          return soap->socket = SOAP_INVALID_SOCKET;
        }
...
#ifndef WITH_NOIO
#ifndef PALM_1
static SOAP_SOCKET tcp_accept(struct soap *soap, SOAP_SOCKET sk, struct sockaddr *addr, int *len) {
  SOAP_SOCKET s;
  (void)soap;
...
soap_bind(struct soap *soap, const char *host, int port, int backlog) {
  ...
  res = *addrinfo;
  if (soap_memcpy((void *)&soap->peer.storage, sizeof(soap->peer.storage), (const void *)addrinfo->ai_addr,
                  addrinfo->ai_addrlen)) {
    freeaddrinfo(addrinfo);
    soap->error = SOAP_EOM;
    return SOAP_INVALID_SOCKET;
...
#ifdef TCP_FASTOPEN
  if (!(soap->omode & SOAP_IO_UDP) &&
      setsockopt(soap->master, IPPROTO_TCP, TCP_FASTOPEN, (char *)&set, sizeof(int))) { /* silently ignore */
...
soap_accept(struct soap *soap) {
  ...
  for (;;) {
    ...
    if (soap_valid_socket(soap->socket)) {
      ...
      char port[16];
      int i;
      getnameinfo(&soap->peer.addr, n, soap->host, sizeof(soap->host), port, sizeof(port),
...
#else
      soap->ip = ntohl(soap->peer.in.sin_addr.s_addr);
      (SOAP_SNPRINTF(soap->host, sizeof(soap->host), 80), "%u.%u.%u.%u", (int)(soap->ip >> 24) & 0xFF,
      ...
      if ((soap->accept_flags & ~SO_LINGER) &&
          setsockopt(soap->socket, SOL_SOCKET, soap->accept_flags & ~SO_LINGER, (char *)&set, sizeof(int))) {
        soap->errnum = soap_socket_errno(soap->socket);
...
#ifndef PALM_1
SOAP_FMAC1
const char *SOAP_FMAC2 soap_http_header_attribute(struct soap *soap, const char *line, const char *key) {
  const char *s = line;
  if (s) {
    while (*s) {
      short flag;
...
static int http_post(struct soap *soap, const char *endpoint, const char *host, int port, const char *path,
                     const char *action, ULONG64 count) {
  const char *s;
  int err;
  size_t l;
  switch (soap->status) {
...
#else
  if (!endpoint ||
      (soap_tag_cmp(endpoint, "http:*") && soap_tag_cmp(endpoint, "https:*") && soap_tag_cmp(endpoint, "httpg:*")))
#endif
        return SOAP_OK;
  ...
  if (port != 80)
    ...
    if (soap->userid && soap->passwd) {
      ...
      (SOAP_SNPRINTF(soap->tmpbuf + 262, sizeof(soap->tmpbuf) - 262, strlen(soap->userid) + strlen(soap->passwd) + 1),
       "%s:%s", soap->userid, soap->passwd);
    ...
    if (soap->proxy_userid && soap->proxy_passwd) {
      soap_strcpy(soap->tmpbuf, sizeof(soap->tmpbuf), "Basic ");
      (SOAP_SNPRINTF(soap->tmpbuf + 262, sizeof(soap->tmpbuf) - 262,
                     strlen(soap->proxy_userid) + strlen(soap->proxy_passwd) + 1),
       "%s:%s", soap->proxy_userid, soap->proxy_passwd);
      soap_s2base64(soap, (const unsigned char *)(soap->tmpbuf + 262), soap->tmpbuf + 6,
                    (int)strlen(soap->tmpbuf + 262));
      err = soap->fposthdr(soap, "Proxy-Authorization", soap->tmpbuf);
      if (err)
...
#endif
#ifdef WMW_RPM_IO
  if (soap->rpmreqid || soap_valid_socket(soap->master) || soap_valid_socket(soap->socket) ||
      soap->os) /* RPM behaves as if standalone */
#else
  if (soap_valid_socket(soap->master) || soap_valid_socket(soap->socket) ||
      soap->os) /* standalone application (socket) or CGI (stdin/out)? */
#endif
...
#ifndef WITH_LEAN
  if (status == 401) {
    (SOAP_SNPRINTF_SAFE(soap->tmpbuf, sizeof(soap->tmpbuf)), "Basic realm=\"%s\"",
     (soap->authrealm && strlen(soap->authrealm) + 14 < sizeof(soap->tmpbuf)) ? soap->authrealm : "gSOAP Web Service");
...
#ifndef PALM_1
SOAP_FMAC1
const char *SOAP_FMAC2 soap_extend_url(struct soap *soap, const char *s, const char *t) {
  if (s)
...
#ifndef PALM_1
SOAP_FMAC1
const char *SOAP_FMAC2 soap_extend_url_query(struct soap *soap, const char *s, const char *t) {
...
struct soap_cookie *SOAP_FMAC2 soap_cookie(struct soap *soap, const char *name, const char *domain, const char *path) {
  ...
  for (p = soap->cookies; p; p = p->next) {
    ...
    if (!strcmp(p->name, name) && ((!domain && !p->domain) || (domain && p->domain && !strcmp(p->domain, domain))) &&
...
void SOAP_FMAC2 soap_clr_cookie(struct soap *soap, const char *name, const char *domain, const char *path) {
  ...
  for (p = &soap->cookies, q = *p; q; q = *p) {
    if (!strcmp(q->name, name) && (!q->domain || !strcmp(q->domain, domain)) &&
...
SOAP_FMAC1
int SOAP_FMAC2 soap_set_cookie_expire(struct soap *soap, const char *name, long maxage, const char *domain,
                                      const char *path) {
  struct soap_cookie *p;
...
SOAP_FMAC1
int SOAP_FMAC2 soap_set_cookie_secure(struct soap *soap, const char *name, const char *domain, const char *path) {
  struct soap_cookie *p;
      ...
      *p = q->next;
      ...
      if (flag && (!q->path || !strncmp(q->path, path, strlen(q->path)))
        ...
        DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Sending cookie %s=%s path=\"/%s\" domain=\"%s\"\n",
                                  q->name ? q->name : "(null)", q->value ? q->value : "(null)",
                                  q->path ? q->path : "(null)", q->domain ? q->domain : "(null)"));
...
#ifndef PALM_2
SOAP_FMAC1
int SOAP_FMAC2 soap_embed(struct soap *soap, const void *p, const void *a, int n, int t) {
  int id;
...
#ifndef PALM_2
SOAP_FMAC1
int SOAP_FMAC2 soap_pointer_enter(struct soap *soap, const void *p, const void *a, int n, int type,
  ...
  *ppp = pp = &soap->pblk->plist[soap->pidx++];
  ...
  DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Pointer enter location=%p array=%p size=%lu type=%d id=%d\n", p, a,
                            (unsigned long)n, type, soap->idnum + 1));
  pp->next = soap->pht[h];
  pp->type = type;
  pp->mark1 = 0;
  pp->mark2 = 0;
...
#ifndef PALM_2
SOAP_FMAC1
int SOAP_FMAC2 soap_array_pointer_lookup(struct soap *soap, const void *p, const void *a, int n, int type,
                                         struct soap_plist **ppp) {
  struct soap_plist *pp;
  *ppp = NULL;
  if (!p || !a)
...
int SOAP_FMAC2 soap_begin_send(struct soap *soap) {
  ...
  if (!soap_valid_socket(soap->socket) && !soap->os &&
      soap->sendfd >= 0) /* Set win32 stdout or soap->sendfd to BINARY, e.g. to support DIME */
#ifdef __BORLANDC__
...
#ifndef PALM_2
SOAP_FMAC1
int SOAP_FMAC2 soap_array_reference(struct soap *soap, const void *p, const void *a, int n, int t) {
  struct soap_plist *pp;
...
#ifndef PALM_2
SOAP_FMAC1
int SOAP_FMAC2 soap_attachment_reference(struct soap *soap, const void *p, const void *a, int n, int t, const char *id,
                                         const char *type) {
  struct soap_plist *pp;
  if (!p || !a || (!soap->encodingStyle && !(soap->omode & SOAP_XML_GRAPH) && !id && !type) ||
      (soap->omode & SOAP_XML_TREE))
    return 1;
  if (soap_array_pointer_lookup(soap, p, a, n, t, &pp)) {
    if (pp->mark1 == 0) {
...
#ifndef PALM_1
SOAP_FMAC1
int SOAP_FMAC2 soap_attachment(struct soap *soap, const char *tag, int id, const void *p, const void *a, int n,
                               const char *aid, const char *atype, const char *aoptions, const char *type, int t) {
  struct soap_plist *pp;
  int i;
  if (!p || !a || (!aid && !atype) ||
      (!soap->encodingStyle && !(soap->omode & (SOAP_ENC_DIME | SOAP_ENC_MIME | SOAP_ENC_MTOM | SOAP_XML_GRAPH))) ||
...
#ifndef PALM_2
SOAP_FMAC1
struct soap_ilist *SOAP_FMAC2 soap_enter(struct soap *soap, const char *id, int t, size_t n) {
  size_t h;
  struct soap_ilist *ip = NULL;
  size_t l = strlen(id);
  if (sizeof(struct soap_ilist) + l > l &&
      (SOAP_MAXALLOCSIZE <= 0 || sizeof(struct soap_ilist) + l <= SOAP_MAXALLOCSIZE))
...
void *SOAP_FMAC2 soap_id_lookup(struct soap *soap, const char *id, void **p, int t, size_t n, unsigned int k,
  ...
  if (!ip) {
    ...
    *p = NULL;
    ...
    DBGLOG(TEST,
           SOAP_MESSAGE(fdebug, "Lookup type incompatibility: ref='%s' id-type=%d ref-type=%d\n", id, ip->type, t));
...
#ifndef PALM_2
SOAP_FMAC1
void *SOAP_FMAC2 soap_id_forward(struct soap *soap, const char *href, void *p, size_t i, int t, int tt, size_t n,
                                 unsigned int k,
  ...
  if (finsert || n < sizeof(void *)) {
    ...
    if ((ip->type != t || ip->size != n) && (!fbase || !fbase(ip->type, t))) {
      DBGLOG(TEST,
             SOAP_MESSAGE(
                 fdebug, "Forward type incompatibility id='%s' expect type=%d size=%lu level=%u got type=%d size=%lu\n",
                 href, ip->type, (unsigned long)ip->size, k, t, (unsigned long)n));
      SOAP_FREE(soap, fp);
      (void)soap_id_nullify(soap, href);
      return NULL;
...
#ifndef PALM_2
SOAP_FMAC1
void *SOAP_FMAC2 soap_id_enter(struct soap *soap, const char *id, void *p, int t, size_t n, const char *type,
  ...
  if (!ip) {
    ...
    DBGLOG(TEST,
           SOAP_MESSAGE(fdebug, "Enter type incompatibility id='%s' expect type=%d size=%lu got type=%d size=%lu\n", id,
                        ip->type, (unsigned long)ip->size, t, (unsigned long)n));
    (void)soap_id_nullify(soap, id);
    return NULL;
  } else {
    ip->type = t;
...
#ifndef PALM_2
SOAP_FMAC1
void **SOAP_FMAC2 soap_id_smart(struct soap *soap, const char *id, int t, size_t n) {
  (void)soap;
  (void)id;
  (void)t;
  (void)n;
...
#ifdef WITH_ZLIB
  if ((soap->mode & SOAP_ENC_ZLIB) && soap->d_stream) { /* Make sure end of compressed content is reached */
...
void SOAP_FMAC2 soap_set_version(struct soap *soap, short version) {
  soap_set_local_namespaces(soap);
  if (soap->version != version && soap->local_namespaces && soap->local_namespaces[0].id &&
...
static void soap_utilize_ns(struct soap *soap, const char *tag, short isearly) {
  ...
  if (np) {
    DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Utilizing namespace of '%s' at level %u utilized=%d at level=%u\n", tag,
                              soap->level + isearly, np->index, np->level));
    if (np->index <= 0) {
...
int SOAP_FMAC2 soap_element(struct soap *soap, const char *tag, int id, const char *type) {
  ...
  if (soap->mode & SOAP_XML_DOM) {
    ...
    DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Adding DOM element tag='%s' %p (parent='%s' %p)\n", tag, elt,
                              soap->dom ? soap->dom->name : "(null)", soap->dom));
    elt->soap = soap;
    elt->next = NULL;
    elt->prnt = soap->dom;
    elt->elts = NULL;
  ...
  if ((soap->mode & SOAP_XML_CANONICAL)) {
    ...
    for (np = soap->nlist; np; np = np->next) {
      if (np->ns && np->index == 1) {
        ...
        DBGLOG(TEST,
               SOAP_MESSAGE(fdebug, "Enabling utilized binding (level=%u) %s='%s' SEC-BEGIN=%d c14ninclude='%s'\n",
                            np->level, soap->tmpbuf, np->ns, soap->event == SOAP_SEC_BEGIN,
                            soap->c14ninclude ? soap->c14ninclude : "(null)"));
        np->index = 2;
        soap->level--;
        ...
        DBGLOG(TEST,
               SOAP_MESSAGE(fdebug, "Binding (level=%u) %s='%s' utilized=%d\n", np->level, np->id, np->ns, np->index));
      }
    }
  }
#endif
...
#ifndef PALM_1
SOAP_FMAC1
int SOAP_FMAC2 soap_element_id(struct soap *soap, const char *tag, int id, const void *p, const void *a, int n,
                               const char *type, int t, char **mark) {
  (void)a;
  (void)n;
  if (!p) {
...
#ifndef PALM_1
SOAP_FMAC1
int SOAP_FMAC2 soap_check_and_mark(struct soap *soap, const void *p, int t, char **mark) {
  if (mark) {
    struct soap_plist *pp;
...
#ifndef PALM_1
SOAP_FMAC1
void *SOAP_FMAC2 soap_mark_lookup(struct soap *soap, const void *p, int t, struct soap_plist **ppp, char **mark) {
  if (!soap)
    return NULL;
...
int SOAP_FMAC2 soap_attribute(struct soap *soap, const char *name, const char *value) {
  ...
  if ((soap->mode & SOAP_XML_CANONICAL)) { /* push namespace */
    if (!strncmp(name, "xmlns", 5) && ((name[5] == ':') || name[5] == '\0')) {
      if (name[5] == ':' && soap->c14ninclude &&
          ((*soap->c14ninclude == '*' || soap_tagsearch(soap->c14ninclude, name + 6))))
...
#ifndef PALM_2
SOAP_FMAC1
const char *SOAP_FMAC2 soap_attr_value(struct soap *soap, const char *name, int flag, int occurs) {
  struct soap_attribute *tp;
  if (*name == '-')
    return SOAP_STR_EOS;
  for (tp = soap->attributes; tp; tp = tp->next) {
...
int SOAP_FMAC2 soap_set_attr(struct soap *soap, const char *name, const char *value, int flag) {
  ...
  if (!tp) {
    ...
    if (sizeof(struct soap_attribute) + l > l &&
        (SOAP_MAXALLOCSIZE <= 0 || sizeof(struct soap_attribute) + l <= SOAP_MAXALLOCSIZE))
      ...
      if (s) /* should also check default namespace when 'type' is not qualified? */
      {
        ...
        if (np && np->ns && soap->local_namespaces) {
          if ((!strcmp(s + 1, "type") && !strcmp(np->ns, soap->local_namespaces[2].ns)) /* xsi:type QName */
              || ((!strcmp(s + 1, "arrayType") || !strcmp(s + 1, "itemType")) &&
                  !strcmp(np->ns, soap->local_namespaces[1].ns))) /* SOAP-ENC:arrayType and SOAP-ENC:itemType QName */
...
int SOAP_FMAC2 soap_peek_element(struct soap *soap) {
  ...
  c = soap_get(soap);
#ifdef WITH_DOM
  /* whitespace leading up to the start tag is significant for DOM as-is (but comments and PIs are removed from this
   * lead) */
  if (soap_coblank(c)) {
    soap->labidx = 0;
    do {
...
#ifndef PALM_2
SOAP_FMAC1
char *SOAP_FMAC2 soap_string_in(struct soap *soap, int flag, long minlen, long maxlen, const char *pattern) {
  char *s;
  char *t = NULL;
  size_t i;
  ULONG64 l = 0;
...
#ifndef PALM_2
SOAP_FMAC1
wchar_t *SOAP_FMAC2 soap_wstring_in(struct soap *soap, int flag, long minlen, long maxlen, const char *pattern) {
  wchar_t *s;
  int i, n = 0, f = 0;
  ULONG64 l = 0;
  soap_wchar c;
...
#ifndef PALM_2
SOAP_FMAC1
int SOAP_FMAC2 soap_s2char(struct soap *soap, const char *s, char **t, int flag, long minlen, long maxlen,
                           const char *pattern) {
  if (s) {
...
#ifndef PALM_2
SOAP_FMAC1
int SOAP_FMAC2 soap_s2stdchar(struct soap *soap, const char *s, std::string *t, int flag, long minlen, long maxlen,
                              const char *pattern) {
  if (s) {
    const char *r = soap_string(soap, s, flag, minlen, maxlen, pattern);
    if (r)
...
#ifndef PALM_2
static char *soap_collapse(struct soap *soap, char *s, int flag,
                           int insitu) { /* flag 4=normalizedString (replace), 5=token (collapse) */
  char *t;
  size_t n;
  if (!s)
    return NULL;
  if (flag == 4) {
    for (t = s; *t && (!soap_coblank((soap_wchar)*t) || *t == 32); t++)
      continue;
    if (*t) { /* replace blanks and control char by space */
      if (!insitu)
  ...
  if (n > 0) {
    if (!soap_coblank((soap_wchar)s[n - 1])) {
      for (t = s; (*t && !soap_coblank((soap_wchar)*t)) || (*t == 32 && (!t[1] || !soap_coblank((soap_wchar)t[1])));
           t++)
        continue;
      if (!*t)
        return s;
...
#ifndef PALM_2
SOAP_FMAC1
int SOAP_FMAC2 soap_s2QName(struct soap *soap, const char *s, char **t, long minlen, long maxlen, const char *pattern) {
  if (s) {
...
#ifndef PALM_2
SOAP_FMAC1
int SOAP_FMAC2 soap_s2stdQName(struct soap *soap, const char *s, std::string *t, long minlen, long maxlen,
                               const char *pattern) {
  if (s) {
    const char *r = soap_QName(soap, s, minlen, maxlen, pattern);
    if (r)
...
#ifdef WITH_FAST
      if ((flag && soap_append_lab(soap, "\"", 1)) || (m && soap_append_lab(soap, r, m)) ||
...
#ifdef WITH_FAST
      if ((m && soap_append_lab(soap, r, m)) || (q && soap_append_lab(soap, q, n - (q - s) + 1)))
        return NULL;
#else
      k = m + (q ? n - (q - s) + 1 : 0);
      b = (char *)soap_push_block(soap, NULL, k);
...
#ifndef WITH_LEAN
SOAP_FMAC1
int SOAP_FMAC2 soap_s2wchar(struct soap *soap, const char *s, wchar_t **t, int flag, long minlen, long maxlen,
                            const char *pattern) {
  if (s) {
...
#ifndef WITH_LEAN
SOAP_FMAC1
int SOAP_FMAC2 soap_s2stdwchar(struct soap *soap, const char *s, std::wstring *t, int flag, long minlen, long maxlen,
                               const char *pattern) {
  if (s) {
    const wchar_t *r = soap_wstring(soap, s, flag, minlen, maxlen, pattern);
    if (r)
            ...
            if (c < 0xF0)
              ...
              if (c < 0xF8)
                ...
                if (c < 0xFC)
                  ...
                  wc = (wchar_t)(((soap_wchar)(c & 0x01) << 30) | (c1 << 24) | (c2 << 18) | (c3 << 12) | (c4 << 6) |
...
#ifndef WITH_LEAN
#ifndef PALM_2
static wchar_t *soap_wcollapse(struct soap *soap, wchar_t *s, int flag,
                               int insitu) { /* flag 4=normalizedString (replace), 5=token (collapse) */
  wchar_t *t;
  size_t n;
  if (!s)
...
const char *SOAP_FMAC2 soap_wchar2s(struct soap *soap, const wchar_t *s) {
  ...
  if (r) { /* Convert wchar to UTF8 (chars above U+10FFFF are silently converted, but should not be used) */
    while ((c = *s++)) {
      if (c > 0 && c < 0x80)
        *t++ = (char)c;
      else {
...
char **SOAP_FMAC2 soap_instring(struct soap *soap, const char *tag, char **p, const char *type, int t, int flag,
                                long minlen, long maxlen, const char *pattern) {
  (void)type;
...
#ifndef PALM_2
SOAP_FMAC1
wchar_t **SOAP_FMAC2 soap_inwstring(struct soap *soap, const char *tag, wchar_t **p, const char *type, int t, int flag,
                                    long minlen, long maxlen, const char *pattern) {
  (void)type;
  if (soap_element_begin_in(soap, tag, 1, NULL)) {
    if (!tag || *tag != '-' || soap->error != SOAP_NO_TAG)
...
static size_t strftime(char *buf, size_t len, const char *format, const struct tm *pT) {
  (void)len;
  (void)format;
#ifndef WITH_NOZONE
  (SOAP_SNPRINTF(buf, len, 20), "%04d-%02d-%02dT%02d:%02d:%02dZ", pT->tm_year + 1900, pT->tm_mon + 1, pT->tm_mday,
   pT->tm_hour, pT->tm_min, pT->tm_sec);
#else
  (SOAP_SNPRINTF(buf, len, 20), "%04d-%02d-%02dT%02d:%02d:%02d", pT->tm_year + 1900, pT->tm_mon + 1, pT->tm_mday,
   pT->tm_hour, pT->tm_min, pT->tm_sec);
#endif
  return len;
}
...
const char *SOAP_FMAC2 soap_dateTime2s(struct soap *soap, time_t n) {
  ...
  if (localtime_r(&n, pT) != SOAP_FUNC_R_ERR) {
    ...
    if (l)
      (SOAP_SNPRINTF(soap->tmpbuf + l, sizeof(soap->tmpbuf) - l, 7), "%+03d:%02d",
...
int SOAP_FMAC2 soap_s2dateTime(struct soap *soap, const char *s, time_t *p) {
  *p = 0;
  if (s) {
    ...
    } else if (!(soap->mode & SOAP_XML_STRICT)) { /* YYYYMMDD */
    ...
    if (*t == 'T' || ((*t == 't' || *t == ' ') && !(soap->mode & SOAP_XML_STRICT))) {
      ...
      } else if (!(soap->mode & SOAP_XML_STRICT)) { /* Thhmmss */
    ...
    if (*t) {
      ...
      if (*t == '+' || *t == '-') {
        ...
        if (*t == ':') { /* +hh:mm */
          ...
          if (h < 0)
            m = -m;
        } else if (!(soap->mode & SOAP_XML_STRICT)) { /* +hhmm */
          h = m / 100;
          m = m % 100;
        } else { /* +hh */
          h = m;
...
static ULONG64 soap_count_attachments(struct soap *soap) {
  ...
  DBGLOG(TEST,
         SOAP_MESSAGE(fdebug, "Calculating the message size with attachments, current count=" SOAP_ULONG_FORMAT "\n",
                      count));
...
int SOAP_FMAC2 soap_putdime(struct soap *soap) {
  ...
  for (content = soap->dime.first; content; content = content->next) {
    ...
    if (soap->fdimereadopen && ((handle = soap->fdimereadopen(soap, (void *)content->ptr, content->id, content->type,
      ...
      if (!size && ((soap->mode & SOAP_ENC_PLAIN) || (soap->mode & SOAP_IO) == SOAP_IO_CHUNK ||
  ...
  if (!content) {
    ...
    if (soap->fmimewriteopen &&
        ((content->ptr = (char *)soap->fmimewriteopen(soap, (void *)handle, content->id, content->type,
                                                      content->description, content->encoding)) != NULL ||
         soap->error)) {
      if (!content->ptr)
        return NULL;
    }
...
const char *SOAP_FMAC2 soap_rand_uuid(struct soap *soap, const char *prefix) {
  ...
  r3 = soap_random;
  r4 = soap_random;
  (SOAP_SNPRINTF(soap->tmpbuf, sizeof(soap->tmpbuf), prefix ? strlen(prefix) + 37 : 37),
   "%s%8.8x-%4.4hx-4%3.3hx-%4.4hx-%4.4hx%8.8x", prefix ? prefix : SOAP_STR_EOS, r1, (short)(r2 >> 16),
...
int SOAP_FMAC2 soap_putmime(struct soap *soap) {
  ...
  for (content = soap->mime.first; content; content = content->next) {
    void *handle;
    if (soap->fmimereadopen && ((handle = soap->fmimereadopen(soap, (void *)content->ptr, content->id, content->type,
      ...
      if (soap_putmimehdr(soap, content))
        return soap->error;
      if (!size) {
        if ((soap->mode & SOAP_ENC_PLAIN) || (soap->mode & SOAP_IO) == SOAP_IO_CHUNK ||
            (soap->mode & SOAP_IO) == SOAP_IO_STORE) {
...
#ifndef WITH_LEANER
#ifndef PALM_1
static struct soap_multipart *soap_alloc_multipart(struct soap *soap, struct soap_multipart **first,
...
int SOAP_FMAC2 soap_begin_recv(struct soap *soap) {
  ...
  *soap->endpoint = '\0';
  ...
  if (!soap_valid_socket(soap->socket) && !soap->is &&
      soap->recvfd >= 0) /* Set win32 stdin or soap->recvfd to BINARY, e.g. to support DIME */
#ifdef __BORLANDC__
  ...
  if (((c >= 'A' && c <= 'Z') || (c >= 'a' && c <= 'z')) &&
      !(soap->mode & (SOAP_ENC_MIME | SOAP_ENC_DIME | SOAP_ENC_ZLIB | SOAP_ENC_PLAIN))) {
...
int SOAP_FMAC2 soap_envelope_begin_in(struct soap *soap) {
  ...
  if (soap_element_begin_in(soap, "SOAP-ENV:Envelope", 0, NULL)) {
    if (soap->error == SOAP_TAG_MISMATCH) {
      ...
      else if (soap->status == 0 || (soap->status >= 200 && soap->status <= 299) || soap->status == 400 ||
               soap->status == 500)
...
#ifndef PALM_1
SOAP_FMAC1
int SOAP_FMAC2 soap_GET(struct soap *soap, const char *endpoint, const char *action) {
...
#ifndef PALM_1
SOAP_FMAC1
int SOAP_FMAC2 soap_PUT(struct soap *soap, const char *endpoint, const char *action, const char *type) {
...
#ifndef PALM_1
SOAP_FMAC1
int SOAP_FMAC2 soap_POST(struct soap *soap, const char *endpoint, const char *action, const char *type) {
  soap_mode omode = soap->omode;
  int err;
  soap->http_content = type;
  if ((omode & SOAP_IO) != SOAP_IO_CHUNK) {
...
int SOAP_FMAC2 soap_DELETE(struct soap *soap, const char *endpoint) {
  if (soap_connect_command(soap, SOAP_DEL, endpoint, NULL) || soap_recv_empty_response(soap))
    return soap_closesock(soap);
  return SOAP_OK;
}
#endif
...
const char *SOAP_FMAC2 soap_http_content_type(struct soap *soap, int status) {
  if (soap->status != SOAP_GET && soap->status != SOAP_DEL && soap->status != SOAP_CONNECT) {
    ...
    if ((status == SOAP_FILE || soap->status == SOAP_PUT || soap->status == SOAP_POST_FILE) && soap->http_content &&
        *soap->http_content && !strchr(soap->http_content, 10) && !strchr(soap->http_content, 13))
      s = soap->http_content;
    ...
    if ((soap->mode & SOAP_ENC_MIME) && soap->mime.boundary) {
      const char *t;
      size_t l;
      (SOAP_SNPRINTF(soap->tmpbuf, sizeof(soap->tmpbuf), strlen(soap->mime.boundary) + 53),
      ...
      if (soap->mime.start) {
        l = strlen(soap->tmpbuf);
        (SOAP_SNPRINTF(soap->tmpbuf + l, sizeof(soap->tmpbuf) - l, strlen(soap->mime.start) + 10), "\"; start=\"%s",
         soap->mime.start);
      }
      if (r) {
        l = strlen(soap->tmpbuf);
...
int SOAP_FMAC2 soap_puthttphdr(struct soap *soap, int status, ULONG64 count) {
  ...
  if (soap->keep_alive) {
    if (soap->keep_alive > 0 && soap->recv_timeout) {
      ...
      if (t < 0)
        t = 1;
      (SOAP_SNPRINTF(soap->tmpbuf, sizeof(soap->tmpbuf), 20), "timeout=%d, max=%d", soap->recv_timeout,
       soap->keep_alive);
...
static const char *soap_set_validation_fault(struct soap *soap, const char *s, const char *t) {
  if (!t)
    t = SOAP_STR_EOS;
  if (*soap->tag)
    (SOAP_SNPRINTF(soap->msgbuf, sizeof(soap->msgbuf), strlen(s) + strlen(t) + strlen(soap->tag) + 47),
     "Validation constraint violation: %s%s in element '%s'", s, t, soap->tag);
  else
    (SOAP_SNPRINTF(soap->msgbuf, sizeof(soap->msgbuf), strlen(s) + strlen(t) + 33),
     "Validation constraint violation: %s%s", s, t);
  return soap->msgbuf;
}
#endif
...
void SOAP_FMAC2 soap_set_fault(struct soap *soap) {
  ...
  case SOAP_MUSTUNDERSTAND:
    *c = "SOAP-ENV:MustUnderstand";
    (SOAP_SNPRINTF(soap->msgbuf, sizeof(soap->msgbuf), strlen(soap->tag) + 65),
     "The data in element '%s' must be understood but cannot be processed", soap->tag);
    *s = soap->msgbuf;
    break;
  ...
  case SOAP_USER_ERROR:
    *s = "User data access error";
    break;
  case SOAP_NO_METHOD:
    (SOAP_SNPRINTF(soap->msgbuf, sizeof(soap->msgbuf), strlen(soap->tag) + 66),
  ...
  case SOAP_DIME_ERROR:
    *s = "DIME format error or max DIME size exceeds SOAP_MAXDIMESIZE currently set to " SOAP_XSTRINGIFY(
        SOAP_MAXDIMESIZE);
    break;
  case SOAP_DIME_HREF:
  ...
  case SOAP_ZLIB_ERROR:
    ...
    (SOAP_SNPRINTF(soap->msgbuf, sizeof(soap->msgbuf),
                   (soap->d_stream && soap->d_stream->msg ? strlen(soap->d_stream->msg) : 0) + 19),
     "Zlib/gzip error: '%s'", soap->d_stream && soap->d_stream->msg ? soap->d_stream->msg : SOAP_STR_EOS);
    *s = soap->msgbuf;
#else
  ...
  case SOAP_EOF:
    ...
    *s = soap_strerror(soap); /* *s = soap->msgbuf */
    ...
    if (strlen(soap->msgbuf) + 25 < sizeof(soap->msgbuf)) {
      soap_memmove((void *)(soap->msgbuf + 25), sizeof(soap->tmpbuf) - 25, (const void *)soap->msgbuf,
  ...
  default:
    ...
    if (soap->error >= 200 && soap->error < 600) {
      ...
      (SOAP_SNPRINTF(soap->msgbuf, sizeof(soap->msgbuf), strlen(t) + 54), "Error %d: HTTP %d %s", soap->error,
       soap->error, t);
      *s = soap->msgbuf;
    } else
#endif
    ...
    if (r > 0) {
      ...
      if (soap->version > 0) {
        ...
        if (soap_response(soap, status) || soap_envelope_begin_out(soap) || soap_putheader(soap) ||
            soap_body_begin_out(soap) || soap_putfault(soap) || soap_body_end_out(soap) ||
        ...
        if (soap->mode & SOAP_IO_LENGTH)
          if (soap_element_begin_out(soap, "fault", 0, NULL) ||
              ...
              soap_outliteral(soap, "detail", (char *const *)d, NULL) || soap_element_end_out(soap, "fault"))
            return soap_closesock(soap);
        (void)soap_end_count(soap);
        if (soap_response(soap, status) || soap_element_begin_out(soap, "fault", 0, NULL) ||
            soap_outstring(soap, "reason", 0, (char *const *)&s, NULL, 0) ||
            soap_outliteral(soap, "detail", (char *const *)d, NULL) || soap_element_end_out(soap, "fault") ||
            soap_end_send(soap))
          return soap_closesock(soap);
...
int SOAP_FMAC2 soap_recv_fault(struct soap *soap, int check) {
  ...
  if (!check) { /* try getfault when no tag or tag mismatched at level 2, otherwise close and return error code */
  ...
  soap->error = SOAP_OK;
  if (soap_getfault(
          soap)) { /* if check>0 and no SOAP Fault is present and no HTTP error then just return to parse request */
    ...
    if (!check && (status == 0 || (status >= 200 && status <= 299)) && !soap->encodingStyle &&
...
static int soap_copy_fault(struct soap *soap, const char *faultcode, const char *faultsubcodeQName,
  ...
  DBGFUN2("soap_copy_fault", "code=%s", faultcode ? faultcode : "(null)", "string=%s",
...
void SOAP_FMAC2 soap_stream_fault(struct soap *soap, std::ostream &os) {
  if (soap_check_state(soap))
    ...
    s = *soap_faultstring(soap);
    d = soap_check_faultdetail(soap);
    os << (soap->version ? "SOAP 1." : "Error ") << (soap->version ? (int)soap->version : soap->error) << " fault "
...
char *SOAP_FMAC2 soap_sprint_fault(struct soap *soap, char *buf, size_t len) {
  if (soap_check_state(soap)) {
    ...
    if (!d)
      d = "[no detail]";
    (SOAP_SNPRINTF(buf, len, strlen(*c) + strlen(v) + strlen(s) + strlen(d) + 72),
     "%s%d fault %s [%s]\n\"%s\"\nDetail: %s\n", soap->version ? "SOAP 1." : "Error ",
     soap->version ? (int)soap->version : soap->error, *c, v, s, d);
  }
  return buf;
}
#endif
...
#ifndef WITH_LEAN
  int i, j, c1, c2;
  if (soap_check_state(soap) == SOAP_OK && soap->error && soap->error != SOAP_STOP && soap->bufidx <= soap->buflen &&
...
int SOAP_FMAC2 soap_register_plugin_arg(struct soap *soap, int (*fcreate)(struct soap *, struct soap_plugin *, void *),
  ...
  if (!err && p->fdelete && p->id) {
    ...
    DBGLOG(TEST,
           SOAP_MESSAGE(fdebug, "Could not register plugin '%s': plugin with the same ID already registered\n", p->id));
    SOAP_FREE(soap, p);
    return SOAP_OK;
  }
  DBGLOG(
