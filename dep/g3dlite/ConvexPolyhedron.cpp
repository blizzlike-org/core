...
bool ConvexPolygon::isEmpty() const { return (_vertex.length() == 0) || (getArea() <= fuzzyEpsilon); }
...
bool ConvexPolyhedron::isEmpty() const { return (face.length() == 0) || (getVolume() <= fuzzyEpsilon); }
