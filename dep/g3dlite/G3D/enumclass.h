...
public:                                                                                                                \
  const char *toString() const {                                                                                       \
    ...
    return NULL;                                                                                                       \
                                                                                                                       ...
                                                                                                                       \
  explicit Classname(const std::string &x) : value((Value)0) { fromString(x); }                                        \
                                                                                                                       \
  Classname(const Any &a) : value((Value)0) { fromString(a.string()); }                                                \
                                                                                                                       \
  operator Any() const { return Any(toString()); }                                                                     \
                                                                                                                       \
  ...
  bool operator==(const Classname other) const { return value == other.value; }                                        \
                                                                                                                       \
  bool operator==(const Classname::Value other) const { return value == other; }                                       \
                                                                                                                       \
  bool operator!=(const Classname other) const { return value != other.value; }                                        \
                                                                                                                       \
  bool operator!=(const Classname::Value other) const { return value != other; }                                       \
  ...
  Classname &operator-=(const int x) {                                                                                 \
    ...
    return *this;                                                                                                      \
                                                                                                                       ...
                                                                                                                       \
  Classname operator+(const int x) const { return Classname((int)value + x); }                                         \
                                                                                                                       \
  Classname operator-(const int x) const { return Classname((int)value - x); }                                         \
                                                                                                                       \
  unsigned int hashCode() const { return (unsigned int)value; }                                                        \
                                                                                                                       \
  void serialize(BinaryOutput &b) const { b.writeInt32(value); }                                                       \
                                                                                                                       \
  void deserialize(BinaryInput &b) { value = (Value)b.readInt32(); }
