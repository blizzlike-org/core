...
/**
 ...
 <table>
  ...
  <tr><td>Matrix4</td><td><code>M4(</code>r0c0<code>, </code>r0c1<code>, </code>r0c2<code>, </code>r0c3<code>,
         ...
         <br>&nbsp;&nbsp;&nbsp;</code>r3c0<code>, </code>r3c1<code>, </code>r3c2<code>,
</code>r3c3<code>)</code></td></tr> <tr><td>CoordinateFrame</td><td><code>CF(</code>r0c0<code>, </code>r0c1<code>,
</code>r0c2<code>,   </code>r0c3<code>, <br>&nbsp;&nbsp;&nbsp;</code>r1c0<code>, </code>r1c1<code>, </code>r1c2<code>,
</code>r1c3<code>, <br>&nbsp;&nbsp;&nbsp;</code>r2c0<code>, </code>r2c1<code>, </code>r2c2<code>,
</code>r2c3<code>)</code></td></tr> <tr><td>CoordinateFrame</td><td><code>CF(V3(</code><i>x</i><code>,
</code><i>y</i><code>, </code><i>z</i><code>), </code><i>yaw deg</i><code>, </code><i>pitch deg</i><code>,
</code><i>optional roll deg</i><code>)</code></td></tr>

  <tr><td>Array</td><td><code>[</code><i>element<sub>0</sub></i><code>, </code><i>element<sub>1</sub></i><code>, </code>
... <code>, </code><i>element<sub>n-1</sub></i><code>]</code></td></tr>
 ...
 AnyVal uses copy-on-mutate, so that <code>AnyVal a = b</code> semantically copies <code>b</code> (like <code>int a =
b</code> would), although in practice it delays the copy until one is mutated so that it is still fast to "copy" large
arrays and tables.
...
private:
  ...
  */
  ...
  inline bool isShared() const { return m_referenceCount && (*m_referenceCount > 1); }

  /** True when m_value is a double pointer */
  inline bool isSharedType() const { return (m_type == TABLE) || (m_type == ARRAY); }
