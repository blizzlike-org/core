...
public:
  ...
  inline const Vector3 &invDirection() const { return m_invDirection; }

  inline Ray() { set(Vector3::zero(), Vector3::unitX()); }

  inline Ray(const Vector3 &origin, const Vector3 &direction) { set(origin, direction); }
   ...
   */
  static Ray fromOriginAndDirection(const Vector3 &point, const Vector3 &direction) { return Ray(point, direction); }

  /** Advances the origin along the direction by @a distance */
  inline Ray bump(float distance) const { return Ray(m_origin + m_direction * distance, m_direction); }
   ...
   */
  float distance(const Vector3 &point) const { return (closestPoint(point) - point).magnitude(); }
  ...
  */
   ...
   */
  float intersectionTime(const Vector3 &v0, const Vector3 &v1, const Vector3 &v2, const Vector3 &edge01,
                         const Vector3 &edge02, double &w0, double &w1, double &w2) const;
  ...
  */
  inline float intersectionTime(const Vector3 &vert0, const Vector3 &vert1, const Vector3 &vert2, const Vector3 &edge01,
  ...
  inline float intersectionTime(const Vector3 &vert0, const Vector3 &vert1, const Vector3 &vert2, double &w0,
  ...
  inline float intersectionTime(const Triangle &triangle) const {
    return intersectionTime(triangle.vertex(0), triangle.vertex(1), triangle.vertex(2), triangle.edge01(),
                            triangle.edge02());
  }

  inline float intersectionTime(const Triangle &triangle, double &w0, double &w1, double &w2) const {
    return intersectionTime(triangle.vertex(0), triangle.vertex(1), triangle.vertex(2), triangle.edge01(),
                            triangle.edge02(), w0, w1, w2);
  }
...
inline float Ray::intersectionTime(const Vector3 &vert0, const Vector3 &vert1, const Vector3 &vert2,
                                   const Vector3 &edge1, const Vector3 &edge2) const {
...
inline float Ray::intersectionTime(const Vector3 &vert0, const Vector3 &vert1, const Vector3 &vert2,
                                   const Vector3 &edge1, const Vector3 &edge2, double &w0, double &w1,
                                   double &w2) const {
