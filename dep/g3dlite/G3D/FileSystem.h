...
private:
  ...
  */
  ...
  /** Called from list() */
  void listHelper(const std::string &shortSpec, const std::string &parentPath, Array<std::string> &result,
...
public:
...
#ifdef G3D_WIN32
  /** \copydoc _drives */
  static const Array<std::string> &drives() { return instance()._drives(); }
#endif

  /** \copydoc _inZipfile */
  static bool inZipfile(const std::string &path, std::string &zipfile) { return instance()._inZipfile(path, zipfile); }

  /** \copydoc _clearCache */
  static void clearCache(const std::string &path = "") { instance()._clearCache(path); }

  /** \copydoc _fopen */
  static FILE *fopen(const char *filename, const char *mode) { return instance()._fopen(filename, mode); }

  static void fclose(FILE *f) { ::fclose(f); }

  static bool inZipfile(const std::string &path) { return instance()._inZipfile(path); }

  /** \copydoc isZipfile */
  static bool isZipfile(const std::string &path) { return instance()._isZipfile(path); }

  /** \copydoc _setCacheLifetime */
  void setCacheLifetime(float t) { instance()._setCacheLifetime(t); }

  /** \copydoc _cacheLifetime */
  static float cacheLifetime() { return instance()._cacheLifetime(); }

  /** \copydoc _createDirectory */
  static void createDirectory(const std::string &path) { instance()._createDirectory(path); }
  ...
  /** \copydoc _exists */
  static bool exists(const std::string &f, bool trustCache = true) { return instance()._exists(f, trustCache); }

  /** \copydoc _isDirectory */
  static bool isDirectory(const std::string &path) { return instance()._isDirectory(path); }

  /** \copydoc _isFile */
  static bool isFile(const std::string &path) { return instance()._isFile(path); }
  ...
  /** \copydoc _isNewer */
  static bool isNewer(const std::string &src, const std::string &dst) { return instance()._isNewer(src, dst); }

  /** \copydoc _size */
  static int64 size(const std::string &path) { return instance()._size(path); }
...
public:
   ...
   */
  static void parse(const std::string &filename, std::string &drive, Array<std::string> &path, std::string &base,
                    std::string &ext);
