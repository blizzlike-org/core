...
*/
template <class T, class PositionFunc = PositionTrait<T>, class HashFunc = HashTrait<T>,
...
public:
  ...
  */
  ...
  /**
   ...
   creates a full oct-tree, which tends to optimize peak performance (some areas of the scene will terminate after few
   recursive splits) at the expense of peak performance.
   */
