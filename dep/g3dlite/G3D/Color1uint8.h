...
Consider a number line from 0 to 1 and a corresponding one from 0 to 255.  If we use iRound(x * 255), then the mapping
for three critical intervals are:
...
public:
  ...
  inline bool operator==(const Color1uint8 &other) const { return value == other.value; }
