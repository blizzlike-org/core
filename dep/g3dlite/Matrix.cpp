...
Matrix3 Matrix::toMatrix3() const {
  ...
  return Matrix3(impl->get(0, 0), impl->get(0, 1), impl->get(0, 2), impl->get(1, 0), impl->get(1, 1), impl->get(1, 2),
...
Matrix4 Matrix::toMatrix4() const {
  ...
  return Matrix4(impl->get(0, 0), impl->get(0, 1), impl->get(0, 2), impl->get(0, 3), impl->get(1, 0), impl->get(1, 1),
                 impl->get(1, 2), impl->get(1, 3), impl->get(2, 0), impl->get(2, 1), impl->get(2, 2), impl->get(2, 3),
...
void Matrix::Impl::inverseInPlaceGaussJordan() {
  debugAssertM(R == C, format("Cannot perform Gauss-Jordan inverse on a non-square matrix."
                              " (Argument was %dx%d)",
                              R, C));
