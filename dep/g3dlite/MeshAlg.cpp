...
void MeshAlg::generateGrid(Array<Vector3> &vertex, Array<Vector2> &texCoord, Array<int> &index, int wCells, int hCells,
                           const Vector2 &textureScale, bool spaceCentered, bool twoSided, const CoordinateFrame &xform,
...
void MeshAlg::computeNormals(const Array<Vector3> &vertexGeometry, const Array<Face> &faceArray,
...
void MeshAlg::computeFaceNormals(const Array<Vector3> &vertexArray, const Array<MeshAlg::Face> &faceArray,
                                 Array<Vector3> &faceNormals, bool normalize) {
...
void MeshAlg::identifyBackfaces(const Array<Vector3> &vertexArray, const Array<MeshAlg::Face> &faceArray,
                                const Vector4 &HP, Array<bool> &backface) {
...
void MeshAlg::identifyBackfaces(const Array<Vector3> &vertexArray, const Array<MeshAlg::Face> &faceArray,
                                const Vector4 &HP, Array<bool> &backface, const Array<Vector3> &faceNormals) {
...
void MeshAlg::computeAreaStatistics(const Array<Vector3> &vertexArray, const Array<int> &indexArray,
...
void MeshAlg::computeBounds(const Array<Vector3> &vertexArray, const Array<int> &indexArray, AABox &box,
                            Sphere &sphere) {
...
void MeshAlg::computeTangentSpaceBasis(const Array<Vector3> &vertexArray, const Array<Vector2> &texCoordArray,
