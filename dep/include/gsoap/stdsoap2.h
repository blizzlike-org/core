...
#ifndef WITH_LEAN
#define SOAP_MAXPTRS                                                                                                   \
  (4) /* maximum depth + 1 of id-ref deserialized pointer types (int* has depth 0, int*** has depth 2) */
#else
...
/* maximum string content length if not already constrained by XML schema validation maxLength constraints, zero or
 * negative means unlimited string lengths are allowed unless restricted by XML schema maxLength */
...
#define soap_strcpy(buf, len, src)                                                                                     \
  (void)((buf) == NULL || (len) <= 0 || (strncpy((buf), (src), (len)-1), (buf)[(len)-1] = '\0') || 1)
#endif
...
#define soap_strncpy(buf, len, src, num)                                                                               \
  ((buf) == NULL || ((size_t)(len) > (size_t)(num) ? strncpy_s((buf), (len), (src), (num)) : ((buf)[0] = '\0', 1)))
#else
#define soap_strncpy(buf, len, src, num)                                                                               \
  ((buf) == NULL || ((size_t)(len) > (size_t)(num) ? (strncpy((buf), (src), (num)), (buf)[(size_t)(num)] = '\0')       \
                                                   : ((buf)[0] = '\0', 1)))
#endif
...
#define soap_strncat(buf, len, src, num)                                                                               \
  ((buf) == NULL || ((size_t)(len) > strlen((buf)) + (size_t)(num) ? strncat_s((buf), (len), (src), (num)) : 1))
#else
#define soap_strncat(buf, len, src, num)                                                                               \
  ((buf) == NULL ||                                                                                                    \
   ((size_t)(len) > strlen((buf)) + (size_t)(num) ? (strncat((buf), (src), (num)), (buf)[(size_t)(len)-1] = '\0')      \
                                                  : 1))
#endif
...
#define soap_memcpy(buf, len, src, num)                                                                                \
  ((buf) && (size_t)(len) >= (size_t)(num) ? memcpy_s((buf), (len), (src), (num)) : SOAP_ERANGE)
#else
#define soap_memcpy(buf, len, src, num)                                                                                \
  ((buf) && (size_t)(len) >= (size_t)(num) ? !memcpy((buf), (src), (num)) : SOAP_ERANGE)
#endif

/* move memory (returns SOAP_ERANGE on overrun, zero if OK) */
#if _MSC_VER >= 1400
#define soap_memmove(buf, len, src, num)                                                                               \
  ((buf) && (size_t)(len) >= (size_t)(num) ? memmove_s((buf), (len), (src), (num)) : SOAP_ERANGE)
#else
#define soap_memmove(buf, len, src, num)                                                                               \
  ((buf) && (size_t)(len) >= (size_t)(num) ? !memmove((buf), (src), (num)) : SOAP_ERANGE)
#endif
...
#define soap_xml_error_check(e)                                                                                        \
  ((e) == SOAP_TAG_MISMATCH || (e) == SOAP_NO_TAG || (e) == SOAP_SYNTAX_ERROR || (e) == SOAP_NAMESPACE ||              \
   (e) == SOAP_TYPE || (e) == SOAP_DUPLICATE_ID || (e) == SOAP_MISSING_ID || (e) == SOAP_REQUIRED ||                   \
   (e) == SOAP_PROHIBITED || (e) == SOAP_OCCURS || (e) == SOAP_LENGTH || (e) == SOAP_LEVEL || (e) == SOAP_PATTERN ||   \
   (e) == SOAP_NULL || (e) == SOAP_HREF || (e) == SOAP_FIXED || (e) == SOAP_EMPTY)
  ...
  {                                                                                                                    \
    if (soap) {                                                                                                        \
      ...
      if (soap->fdebug[SOAP_INDEX_##DBGFILE]) {                                                                        \
        ...
        fprintf(fdebug, "%02d%02d%02d %02d:%02d:%02d.%03d|", (int)_localTime.wYear % 100, (int)_localTime.wMonth,      \
                (int)_localTime.wDay, (int)_localTime.wHour, (int)_localTime.wMinute, (int)_localTime.wSecond,         \
  ...
  {                                                                                                                    \
    if (soap) {                                                                                                        \
      ...
      if (soap->fdebug[SOAP_INDEX_##DBGFILE]) {                                                                        \
        ...
        fprintf(fdebug, "%02d%02d%02d %02d:%02d:%02d.%06ld|", (int)_tm.tm_year % 100, (int)_tm.tm_mon + 1,             \
                (int)_tm.tm_mday, (int)_tm.tm_hour, (int)_tm.tm_min, (int)_tm.tm_sec, (long)_tv.tv_usec);              \
        CMD;                                                                                                           \
        fflush(fdebug);                                                                                                \
      }                                                                                                                \
    }                                                                                                                  \
...
#define DBGFUN4(FNAME, FMT1, ARG1, FMT2, ARG2, FMT3, ARG3, FMT4, ARG4)                                                 \
  DBGLOG(TEST, SOAP_MESSAGE(fdebug, "%s(%d): %s(" FMT1 ", " FMT2 ", " FMT3 ", " FMT4 ")\n", __FILE__, __LINE__, FNAME, \
                            (ARG1), (ARG2), (ARG3), (ARG4)))
#endif
#ifndef DBGHEX
...
SOAP_FMAC1 struct soap_dom_element *SOAP_FMAC2 soap_elt_set(struct soap_dom_element *elt, const char *ns,
                                                            const char *tag);
SOAP_FMAC1 struct soap_dom_element *SOAP_FMAC2 soap_elt_set_w(struct soap_dom_element *elt, const char *ns,
                                                              const wchar_t *tag);

SOAP_FMAC1 struct soap_dom_attribute *SOAP_FMAC2 soap_att(struct soap_dom_element *elt, const char *ns,
                                                          const char *tag);
SOAP_FMAC1 struct soap_dom_attribute *SOAP_FMAC2 soap_att_w(struct soap_dom_element *elt, const char *ns,
                                                            const wchar_t *tag);
SOAP_FMAC1 struct soap_dom_element *SOAP_FMAC2 soap_elt(struct soap_dom_element *elt, const char *ns, const char *tag);
SOAP_FMAC1 struct soap_dom_element *SOAP_FMAC2 soap_elt_w(struct soap_dom_element *elt, const char *ns,
                                                          const wchar_t *tag);
SOAP_FMAC1 struct soap_dom_element *SOAP_FMAC2 soap_nth_elt(struct soap_dom_element *elt, const char *ns,
                                                            const char *tag, size_t n);
SOAP_FMAC1 struct soap_dom_element *SOAP_FMAC2 soap_nth_elt_w(struct soap_dom_element *elt, const char *ns,
                                                              const wchar_t *tag, size_t n);
...
SOAP_FMAC1 struct soap_dom_attribute *SOAP_FMAC2 soap_att_set(struct soap_dom_attribute *att, const char *ns,
                                                              const char *tag);
SOAP_FMAC1 struct soap_dom_attribute *SOAP_FMAC2 soap_att_set_w(struct soap_dom_attribute *att, const char *ns,
                                                                const wchar_t *tag);
SOAP_FMAC1 struct soap_dom_attribute *SOAP_FMAC2 soap_att_add(struct soap_dom_attribute *att, const char *ns,
                                                              const char *tag);
SOAP_FMAC1 struct soap_dom_attribute *SOAP_FMAC2 soap_att_add_w(struct soap_dom_attribute *att, const char *ns,
                                                                const wchar_t *tag);
...
SOAP_FMAC1 struct soap_dom_attribute *SOAP_FMAC2 soap_att_get(const struct soap_dom_element *elt, const char *ns,
                                                              const char *tag);
SOAP_FMAC1 struct soap_dom_attribute *SOAP_FMAC2 soap_att_get_w(const struct soap_dom_element *elt, const char *ns,
                                                                const wchar_t *tag);
SOAP_FMAC1 struct soap_dom_element *SOAP_FMAC2 soap_elt_get(const struct soap_dom_element *elt, const char *ns,
                                                            const char *tag);
SOAP_FMAC1 struct soap_dom_element *SOAP_FMAC2 soap_elt_get_w(const struct soap_dom_element *elt, const char *ns,
                                                              const wchar_t *tag);
...
SOAP_FMAC1 struct soap_dom_attribute *SOAP_FMAC2 soap_att_find(struct soap_dom_element *elt, const char *ns,
                                                               const char *patt);
SOAP_FMAC1 struct soap_dom_attribute *SOAP_FMAC2 soap_att_find_next(const struct soap_dom_attribute *att,
                                                                    const char *ns, const char *patt);
SOAP_FMAC1 struct soap_dom_element *SOAP_FMAC2 soap_elt_find(struct soap_dom_element *elt, const char *ns,
                                                             const char *patt);
SOAP_FMAC1 struct soap_dom_element *SOAP_FMAC2 soap_elt_find_next(const struct soap_dom_element *elt, const char *ns,
                                                                  const char *patt);
SOAP_FMAC1 struct soap_dom_element *SOAP_FMAC2 soap_elt_find_type(struct soap_dom_element *elt, const char *ns,
                                                                  const char *patt, int type);
SOAP_FMAC1 struct soap_dom_element *SOAP_FMAC2 soap_elt_find_next_type(const struct soap_dom_element *elt,
                                                                       const char *ns, const char *patt, int type);
...
SOAP_FMAC1 size_t SOAP_FMAC2 soap_elt_size_type(struct soap_dom_element *elt, const char *ns, const char *patt,
                                                int type);
...
SOAP_FMAC1 struct soap_dom_element *SOAP_FMAC2 soap_dom_find(struct soap_dom_element *begin,
                                                             const struct soap_dom_element *end, const char *ns,
                                                             const char *patt, int type);
...
#ifndef WITH_LEANER
SOAP_FMAC1 struct soap_dom_element *SOAP_FMAC2 soap_dup_xsd__anyType(struct soap *soap, struct soap_dom_element *d,
...
SOAP_FMAC1 int SOAP_FMAC2 soap_dom_call(struct soap *soap, const char *endpoint, const char *action,
                                        const struct soap_dom_element *in, struct soap_dom_element *out);
#endif
...
struct SOAP_CMAC soap {
  ...
  const char *http_extra_header;      /* optional custom HTTP header of the form 'key: val' (multiple headers should be
  ...
  char tmpbuf[SOAP_TMPLEN]; /* in/out buffer for HTTP/MIME headers, simpleType values, element and attribute tag names,
                               and DIME must be >=1024 bytes */
...
SOAP_FMAC1 int SOAP_FMAC2 soap_pointer_enter(struct soap *, const void *p, const void *a, int n, int t,
                                             struct soap_plist **);
SOAP_FMAC1 int SOAP_FMAC2 soap_array_pointer_lookup(struct soap *, const void *p, const void *a, int n, int t,
                                                    struct soap_plist **);
#ifndef WITH_NOIDREF
...
SOAP_FMAC1 int SOAP_FMAC2 soap_attachment_reference(struct soap *soap, const void *p, const void *a, int n, int t,
...
SOAP_FMAC1 void *SOAP_FMAC2 soap_mark_lookup(struct soap *soap, const void *p, int t, struct soap_plist **pp,
                                             char **mark);
...
SOAP_FMAC1 void *SOAP_FMAC2 soap_id_forward(
    struct soap *, const char *id, void *p, size_t i, int t, int tt, size_t n, unsigned int k,
    void (*finsert)(struct soap *, int, int, void *, size_t, const void *, void **), int (*fbase)(int, int));
SOAP_FMAC1 int SOAP_FMAC2 soap_id_nullify(struct soap *, const char *);
#endif
SOAP_FMAC1 void *SOAP_FMAC2
soap_id_enter(struct soap *, const char *id, void *p, int t, size_t n, const char *type, const char *arrayType,
              void *(*finstantiate)(struct soap *, int, const char *, const char *, size_t *), int (*fbase)(int, int));
...
SOAP_FMAC1 int SOAP_FMAC2 soap_element_id(struct soap *, const char *tag, int id, const void *p, const void *a, int n,
...
SOAP_FMAC1 int SOAP_FMAC2 soap_s2char(struct soap *, const char *, char **, int, long minlen, long maxlen,
                                      const char *pattern);
...
#ifndef WITH_COMPAT
#ifdef __cplusplus
SOAP_FMAC1 int SOAP_FMAC2 soap_s2stdQName(struct soap *, const char *, std::string *, long minlen, long maxlen,
                                          const char *pattern);
SOAP_FMAC1 int SOAP_FMAC2 soap_s2stdchar(struct soap *, const char *, std::string *, int, long minlen, long maxlen,
                                         const char *pattern);
SOAP_FMAC1 int SOAP_FMAC2 soap_s2stdwchar(struct soap *, const char *, std::wstring *, int, long minlen, long maxlen,
                                          const char *pattern);
#endif
#endif

#if !defined(WITH_LEAN) || defined(WITH_NTLM)
SOAP_FMAC1 int SOAP_FMAC2 soap_s2wchar(struct soap *, const char *, wchar_t **, int, long minlen, long maxlen,
                                       const char *pattern);
...
#ifndef WITH_LEANER
SOAP_FMAC1 wchar_t **SOAP_FMAC2 soap_inwstring(struct soap *, const char *tag, wchar_t **p, const char *, int, int,
...
#ifndef WITH_LEANER
SOAP_FMAC1 int SOAP_FMAC2 soap_attachment(struct soap *, const char *, int, const void *, const void *, int,
...
template <class T> struct soap_block {
