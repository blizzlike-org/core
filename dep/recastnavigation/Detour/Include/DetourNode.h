...
struct dtNode {
  ...
  unsigned int state : DT_NODE_STATE_BITS; ///< extra state information. A polyRef can have multiple nodes with
                                           ///< different extra info. see DT_MAX_STATES_PER_NODE
...
public:
  ...
  inline int getMemUsed() const {
    return sizeof(*this) + sizeof(dtNode) * m_maxNodes + sizeof(dtNodeIndex) * m_maxNodes +
