...
bool dtCreateNavMeshData(dtNavMeshCreateParams *params, unsigned char **outData, int *outDataSize) {
  ...
  const int dataSize = headerSize + vertsSize + polysSize + linksSize + detailMeshesSize + detailVertsSize +
                       detailTrisSize + bvTreeSize + offMeshConsSize;
...
bool dtNavMeshDataSwapEndian(unsigned char *data, const int /*dataSize*/) {
  ...
  d += linksSize; // Ignore links; they technically should be endian-swapped but all their data is overwritten on load
                  // anyway.
