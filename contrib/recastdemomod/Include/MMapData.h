...
public:
  ...
  void BuildNavMeshOfTile(unsigned int tx, unsigned int ty, MeshObjects const *meshObjects, rcConfig const *cfg,
                          float agentHeight, float agentRadius, float agentClimb, SamplePartitionType partitionType);
  void BuildMoveMapTile(unsigned int tileX, unsigned int tileY, MeshObjects const *meshObjects, rcConfig *cfg,
