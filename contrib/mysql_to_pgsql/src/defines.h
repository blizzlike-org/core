...
inline string ConvertNativeType(enum_field_types mysqlType, uint32 length) {
...
inline bool IsNeeedEscapeString(enum_field_types mysqlType) {
  switch (mysqlType) {
  case FIELD_TYPE_VAR_STRING:
  case FIELD_TYPE_STRING:
...
inline void PG_Exec_str(string sql, PGconn *mPGconn) {
