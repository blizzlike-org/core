...
bool wdt_MWMO::prepareLoadedData() { return fcc == fcc_MWMO; }

bool wdt_MPHD::prepareLoadedData() { return fcc == fcc_MPHD; }

bool wdt_MAIN::prepareLoadedData() { return fcc == fcc_MAIN; }
