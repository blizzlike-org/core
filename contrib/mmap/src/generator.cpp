...
bool handleArgs(int argc, char **argv, int &mapId, int &tileX, int &tileY, bool &skipLiquid, bool &skipContinents,
                bool &skipJunkMaps, bool &skipBattlegrounds, bool &debugOutput, bool &silent,
                bool &buildOnlyGameobjectModels, char *&offMeshInputPath, char *&configInputPath) {
  char *param = NULL;
...
int main(int argc, char **argv) {
  ...
  bool validParam =
      handleArgs(argc, argv, mapId, tileX, tileY, skipLiquid, skipContinents, skipJunkMaps, skipBattlegrounds, debug,
                 silent, buildOnlyGameobjectModels, offMeshInputPath, configInputPath);
  ...
  MapBuilder builder(configInputPath, skipLiquid, skipContinents, skipJunkMaps, skipBattlegrounds, debug,
                     offMeshInputPath);
