...
void __fastcall TFrmMain::sgEditKeyDown(TObject *Sender, WORD &Key, TShiftState Shift) {
...
void __fastcall TFrmMain::sgEditSelectCell(TObject *Sender, int ACol, int ARow, bool &CanSelect) {
  //
}
//---------------------------------------------------------------------------
