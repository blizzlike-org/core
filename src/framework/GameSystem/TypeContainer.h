 ...
 */
template <class OBJECT> struct ContainerMapList { GridRefManager<OBJECT> _element; };
...
public:
  template <class SPECIFIC_TYPE> size_t Count() const { return MaNGOS::Count(i_elements, (SPECIFIC_TYPE *)nullptr); }
