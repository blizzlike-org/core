 ...
 */
template <class T, class Key = std::string> class ObjectRegistry {
public:
  ...
  unsigned int GetRegisteredItems(std::vector<Key> &l) const {
    ...
    for (typename RegistryMapType::const_iterator iter = i_registeredObjects.begin(); iter != i_registeredObjects.end();
         ++iter)
      l[sz++] = iter->first;
