...
template <class Class, typename ParamType1, typename ParamType2> class _Callback<Class, ParamType1, ParamType2> {
protected:
...
template <class Class, typename ParamType1> class _Callback<Class, ParamType1> {
protected:
...
template <class Class> class _Callback<Class> {
protected:
...
template <typename ParamType1, typename ParamType2> class _SCallback<ParamType1, ParamType2> {
protected:
...
template <typename ParamType1> class _SCallback<ParamType1> {
protected:
...
template <class CB> class _ICallback : public CB, public ICallback {
public:
...
template <class Class> class Callback<Class> : public _ICallback<_Callback<Class>> {
private:
...
template <class CB> class _IQueryCallback : public CB, public IQueryCallback {
public:
...
public:
  QueryCallback(Class *object, typename QC3::Method method, QueryResult *result, ParamType1 param1, ParamType2 param2,
                ParamType3 param3)
...
template <class Class> class QueryCallback<Class> : public _IQueryCallback<_Callback<Class, QueryResult *>> {
private:
...
template <> class SQueryCallback<> : public _IQueryCallback<_SCallback<QueryResult *>> {
private:
