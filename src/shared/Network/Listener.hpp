...
namespace MaNGOS {
template <typename SocketType> class Listener {
private:
...
template <typename SocketType> Listener<SocketType>::~Listener() {
...
template <typename SocketType> void Listener<SocketType>::BeginAccept() {
