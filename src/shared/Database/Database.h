...
public:
  ...
  // Query / member
  template <class Class> bool AsyncQuery(Class *object, void (Class::*method)(QueryResult *), const char *sql);
  ...
  bool AsyncPQuery(Class *object, void (Class::*method)(QueryResult *, ParamType1, ParamType2, ParamType3),
                   ParamType1 param1, ParamType2 param2, ParamType3 param3, const char *format, ...) ATTR_PRINTF(7, 8);
  // PQuery / static
  template <typename ParamType1>
...
protected:
  Database()
      : m_nQueryConnPoolSize(1), m_pAsyncConn(nullptr), m_pResultQueue(nullptr), m_threadBody(nullptr),
        m_delayThread(nullptr), m_allowAsyncTransactions(false), m_iStmtIndex(-1), m_logSQL(false),
        m_pingIntervallms(0) {
    m_nQueryCounter = -1;
  }
