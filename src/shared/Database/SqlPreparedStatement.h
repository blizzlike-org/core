...
public:
  ...
  template <typename T> SqlStmtFieldData(T param) { set(param); }

  template <typename T1> void set(T1 param1);
...
public:
  ...
  template <typename ParamType1> bool PExecute(ParamType1 param1) {
    arg(param1);
    return Execute();
  }

  template <typename ParamType1, typename ParamType2> bool PExecute(ParamType1 param1, ParamType2 param2) {
    arg(param1);
    arg(param2);
    return Execute();
  }
...
private:
  ...
  template <typename ParamType> void arg(ParamType val) {
