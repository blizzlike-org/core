...
public:
  ...
  WorldPacket(const WorldPacket &packet, std::chrono::steady_clock::time_point receivedTime)
      : ByteBuffer(packet), m_opcode(packet.m_opcode), m_receivedTime(receivedTime) {}
...
protected:
  ...
  std::chrono::steady_clock::time_point
      m_receivedTime; // only set for a specific set of opcodes, for performance reasons.
};
#endif
