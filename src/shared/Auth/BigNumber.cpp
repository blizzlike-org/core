...
int BigNumber::SetHexStr(const char *str) { return BN_hex2bn(&_bn, str); }
...
const char *BigNumber::AsHexStr() const { return BN_bn2hex(_bn); }

const char *BigNumber::AsDecStr() const { return BN_bn2dec(_bn); }
