...
public:
  enum eFlags : uint32 {
    ...
    Enter_Cycle = 0x00200000, // Everytimes appears with cyclic flag in monster move packet, erases first spline vertex
                              // after first cycle done
    ...
    // flags that shouldn't be appended into SMSG_MONSTER_MOVE\SMSG_MONSTER_MOVE_TRANSPORT packet, should be more
    // probably
