...
bool IdleMovementGenerator::Update(Unit &, const uint32 &) { return true; }

void DistractMovementGenerator::Initialize(Unit &owner) { owner.addUnitState(UNIT_STAT_DISTRACTED); }
