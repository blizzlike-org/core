...
public:
  ...
  virtual bool GetResetPosition(Unit &, float & /*x*/, float & /*y*/, float & /*z*/, float & /*o*/) const {
    return false;
  }
...
template <class T, class D> class MovementGeneratorMedium : public MovementGenerator {
public:
...
public:
  ...
  template <class U = T, typename std::enable_if<false == std::is_same<U, Unit>::value, U>::type * = nullptr>
  bool GetResetPosition(U & /*u*/, float & /*x*/, float & /*y*/, float & /*z*/, float & /*o*/) const {
    return false;
  }
};
...
template <class REAL_MOVEMENT> struct MovementGeneratorFactory : public SelectableMovement {
