...
static const PlaguelandsTowerEvent plaguelandsTowerEvents[MAX_EP_TOWERS][4] = {
    {
        {EVENT_NORTHPASS_PROGRESS_ALLIANCE, ALLIANCE, BROADCAST_TEXT_OPVP_EP_CAPTURE_NPT_A,
    ...
    {
        {EVENT_CROWNGUARD_PROGRESS_ALLIANCE, ALLIANCE, BROADCAST_TEXT_OPVP_EP_CAPTURE_CGT_A,
    ...
    {
        {EVENT_EASTWALL_PROGRESS_ALLIANCE, ALLIANCE, BROADCAST_TEXT_OPVP_EP_CAPTURE_EWT_A,
    ...
    {
        {EVENT_PLAGUEWOOD_PROGRESS_ALLIANCE, ALLIANCE, BROADCAST_TEXT_OPVP_EP_CAPTURE_PWT_A,
...
static const uint32 plaguelandsBanners[MAX_EP_TOWERS] = {GO_TOWER_BANNER_NORTHPASS, GO_TOWER_BANNER_CROWNGUARD,
