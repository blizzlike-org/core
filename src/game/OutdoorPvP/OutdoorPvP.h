...
enum CapturePointArtKits { CAPTURE_ARTKIT_ALLIANCE = 2, CAPTURE_ARTKIT_HORDE = 1, CAPTURE_ARTKIT_NEUTRAL = 21 };

enum CapturePointAnimations { CAPTURE_ANIM_ALLIANCE = 1, CAPTURE_ANIM_HORDE = 0, CAPTURE_ANIM_NEUTRAL = 2 };
...
protected:
  ...
  uint32 GetBannerArtKit(Team team, uint32 artKitAlliance = CAPTURE_ARTKIT_ALLIANCE,
