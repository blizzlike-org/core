...
enum InstanceConditionIDs // Suggested values used with CONDITION_INSTANCE_SCRIPT for some generic uses
{
  ...
  INSTANCE_CONDITION_ID_FIRE_BRIGADE_PRACTICE_GOLDSHIRE =
      18000, // must be first and all subsequent numbers matching ShadeOfTheHorsemanVillages enum
...
public:
  ...
  virtual bool CheckConditionCriteriaMeet(Player const *source, uint32 instance_condition_id,
