...
bool InstanceData::CheckConditionCriteriaMeet(Player const * /*source*/, uint32 instance_condition_id,
  ...
  sLog.outError("Condition system call InstanceData::CheckConditionCriteriaMeet but instance script for map %u not "
                "have implementation for player condition criteria with internal id %u (called from %u)",
