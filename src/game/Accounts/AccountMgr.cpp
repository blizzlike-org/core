...
AccountOpResult AccountMgr::CreateAccount(std::string username, std::string password) const {
  ...
  bool update_sv = LoginDatabase.PExecute("INSERT INTO account(username,v,s,joindate) VALUES('%s','%s','%s',NOW())",
...
AccountOpResult AccountMgr::CreateAccount(std::string username, std::string password, uint32 expansion) const {
  ...
  bool update_sv =
      LoginDatabase.PExecute("INSERT INTO account(username,v,s,joindate,expansion) VALUES('%s','%s','%s',NOW(), %u)",
...
AccountOpResult AccountMgr::ChangeUsername(uint32 accid, std::string new_uname, std::string new_passwd) const {
  ...
  bool update_sv = LoginDatabase.PExecute("UPDATE account SET v='%s',s='%s',username='%s' WHERE id='%u'", v_hex, s_hex,
                                          safe_new_uname.c_str(), accid);
...
AccountOpResult AccountMgr::ChangePassword(uint32 accid, std::string new_passwd) const {
  ...
  bool update_sv = LoginDatabase.PExecute("UPDATE account SET v='%s', s='%s' WHERE id='%u'", v_hex, s_hex, accid);
