...
namespace VMAP {
template <class TValue> class IntersectionCallBack {
public:
  TValue *closestEntity;
  G3D::Vector3 hitLocation;
  G3D::Vector3 hitNormal;

  void operator()(const G3D::Ray &ray, const TValue *entity, bool pStopAtFirstHit, bool ignoreM2Model,
                  float &distance) {
...
private:
public:
  static bool collisionLocationForMovingPointFixedAABox(const G3D::Vector3 &origin, const G3D::Vector3 &dir,
