...
enum { SPELL_HOLY, SPELL_SHADOWMAGIC, SPELL_DISCIPLINE };
...
private:
  ...
  // holy
  uint32 BINDING_HEAL, CIRCLE_OF_HEALING, CLEARCASTING, DESPERATE_PRAYER, FLASH_HEAL, GREATER_HEAL, HEAL, HOLY_FIRE,
      HOLY_NOVA, LESSER_HEAL, MANA_BURN, PRAYER_OF_HEALING, PRAYER_OF_MENDING, RENEW, RESURRECTION, SHACKLE_UNDEAD,
      SMITE, CURE_DISEASE, ABOLISH_DISEASE, PRIEST_DISPEL_MAGIC;

  // ranged
  uint32 SHOOT;

  // shadowmagic
  uint32 FADE, SHADOW_WORD_PAIN, MIND_BLAST, SCREAM, MIND_FLAY, DEVOURING_PLAGUE, SHADOW_PROTECTION, VAMPIRIC_TOUCH,
      PRAYER_OF_SHADOW_PROTECTION, SHADOWFIEND, SHADOWFORM, VAMPIRIC_EMBRACE;

  // discipline
  uint32 POWER_WORD_SHIELD, INNER_FIRE, POWER_WORD_FORTITUDE, PRAYER_OF_FORTITUDE, FEAR_WARD, POWER_INFUSION,
      MASS_DISPEL, DIVINE_SPIRIT, PRAYER_OF_SPIRIT, INNER_FOCUS;

  // racial
  uint32 ARCANE_TORRENT, GIFT_OF_THE_NAARU, STONEFORM, ELUNES_GRACE, ESCAPE_ARTIST, PERCEPTION, SHADOWMELD, WAR_STOMP,
