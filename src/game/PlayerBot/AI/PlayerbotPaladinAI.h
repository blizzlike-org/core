...
public:
  // Retribution
  uint32 RETRIBUTION_AURA, SEAL_OF_COMMAND, JUDGEMENT, GREATER_BLESSING_OF_WISDOM, GREATER_BLESSING_OF_MIGHT,
      BLESSING_OF_WISDOM, BLESSING_OF_MIGHT, HAMMER_OF_JUSTICE, RIGHTEOUS_FURY, CRUSADER_AURA, CRUSADER_STRIKE,
      AVENGING_WRATH, JUDGEMENT_OF_JUSTICE, ART_OF_WAR;

  // Holy
  uint32 FLASH_OF_LIGHT, HOLY_LIGHT, DIVINE_SHIELD, HAMMER_OF_WRATH, CONSECRATION, CONCENTRATION_AURA, DIVINE_FAVOR,
      SACRED_SHIELD, HOLY_SHOCK, HOLY_WRATH, LAY_ON_HANDS, EXORCISM, REDEMPTION, DIVINE_PLEA, SEAL_OF_JUSTICE,
      SEAL_OF_LIGHT, SEAL_OF_RIGHTEOUSNESS, SEAL_OF_VENGEANCE, SEAL_OF_WISDOM, SEAL_OF_THE_CRUSADER, PURIFY, CLEANSE;

  // Protection
  uint32 GREATER_BLESSING_OF_KINGS, BLESSING_OF_KINGS, BLESSING_OF_PROTECTION, SHADOW_RESISTANCE_AURA, DEVOTION_AURA,
      FIRE_RESISTANCE_AURA, FROST_RESISTANCE_AURA, DEFENSIVE_STANCE, BERSERKER_STANCE, BATTLE_STANCE, DIVINE_PROTECTION,
      DIVINE_INTERVENTION, HOLY_SHIELD, AVENGERS_SHIELD, RIGHTEOUS_DEFENSE, BLESSING_OF_SANCTUARY,
      GREATER_BLESSING_OF_SANCTUARY, BLESSING_OF_SACRIFICE;
