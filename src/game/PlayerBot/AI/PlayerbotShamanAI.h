...
enum { SPELL_ENHANCEMENT, SPELL_RESTORATION, SPELL_ELEMENTAL };
...
private:
  ...
  // ENHANCEMENT
  uint32 ROCKBITER_WEAPON, STONESKIN_TOTEM, LIGHTNING_SHIELD, FLAMETONGUE_WEAPON, STRENGTH_OF_EARTH_TOTEM, FOCUSED,
      FROSTBRAND_WEAPON, FROST_RESISTANCE_TOTEM, FLAMETONGUE_TOTEM, FIRE_RESISTANCE_TOTEM, WINDFURY_WEAPON,
      GROUNDING_TOTEM, NATURE_RESISTANCE_TOTEM, WIND_FURY_TOTEM, STORMSTRIKE, SHAMANISTIC_RAGE, WRATH_OF_AIR_TOTEM,
      EARTH_ELEMENTAL_TOTEM, BLOODLUST, HEROISM;

  // RESTORATION
  uint32 HEALING_WAVE, LESSER_HEALING_WAVE, ANCESTRAL_SPIRIT, TREMOR_TOTEM, HEALING_STREAM_TOTEM, MANA_SPRING_TOTEM,
      CHAIN_HEAL, MANA_TIDE_TOTEM, EARTH_SHIELD, CURE_DISEASE_SHAMAN, CURE_POISON_SHAMAN;

  // ELEMENTAL
  uint32 LIGHTNING_BOLT, EARTH_SHOCK, STONECLAW_TOTEM, FLAME_SHOCK, SEARING_TOTEM, PURGE, FIRE_NOVA_TOTEM, WIND_SHOCK,
      FROST_SHOCK, MAGMA_TOTEM, CHAIN_LIGHTNING, TOTEM_OF_WRATH, FIRE_ELEMENTAL_TOTEM, EARTHBIND_TOTEM,
      ELEMENTAL_MASTERY;

  // racial
  uint32 ARCANE_TORRENT, GIFT_OF_THE_NAARU, STONEFORM, ESCAPE_ARTIST, PERCEPTION, SHADOWMELD, BLOOD_FURY, WAR_STOMP,
      BERSERKING, WILL_OF_THE_FORSAKEN;

  // totem buffs
  uint32 STRENGTH_OF_EARTH_EFFECT, FLAMETONGUE_EFFECT, MAGMA_TOTEM_EFFECT, STONECLAW_EFFECT, FIRE_RESISTANCE_EFFECT,
      FROST_RESISTANCE_EFFECT, GROUDNING_EFFECT, NATURE_RESISTANCE_EFFECT, STONESKIN_EFFECT, WINDFURY_EFFECT,
      WRATH_OF_AIR_EFFECT, CLEANSING_TOTEM_EFFECT, HEALING_STREAM_EFFECT, MANA_SPRING_EFFECT, TREMOR_TOTEM_EFFECT,
      TOTEM_OF_WRATH_EFFECT, EARTHBIND_EFFECT;
