...
enum { SPELL_FROST, SPELL_FIRE, SPELL_ARCANE };
...
enum MageTalents { IMPROVED_SCORCH_1 = 11095, IMPROVED_SCORCH_2 = 12872, IMPROVED_SCORCH_3 = 12873 };

static const uint32 uiImprovedScorch[3] = {IMPROVED_SCORCH_1, IMPROVED_SCORCH_2, IMPROVED_SCORCH_3};
...
private:
  ...
  // ARCANE
  uint32 ARCANE_MISSILES, ARCANE_EXPLOSION, COUNTERSPELL, SLOW, ARCANE_BLAST, EVOCATION, POLYMORPH, PRESENCE_OF_MIND,
      ARCANE_POWER;
  // ranged
  uint32 SHOOT;

  // FIRE
  uint32 FIREBALL, FIRE_BLAST, FLAMESTRIKE, SCORCH, FIRE_VULNERABILITY, IMPROVED_SCORCH, PYROBLAST, BLAST_WAVE,
      COMBUSTION, DRAGONS_BREATH, FIRE_WARD;

  // FROST
  uint32 FROSTBOLT, FROST_NOVA, BLIZZARD, ICY_VEINS, CONE_OF_COLD, ICE_BARRIER, SUMMON_WATER_ELEMENTAL, ICE_LANCE,
      FROST_WARD, ICE_BLOCK, COLD_SNAP;

  // buffs
  uint32 FROST_ARMOR, ICE_ARMOR, MAGE_ARMOR, MOLTEN_ARMOR, ARCANE_INTELLECT, ARCANE_BRILLIANCE, MANA_SHIELD,
      DAMPEN_MAGIC, AMPLIFY_MAGIC, MAGE_REMOVE_CURSE;
  ...
  uint32 CONJURE_WATER, CONJURE_FOOD, CONJURE_MANA_GEM;
};
