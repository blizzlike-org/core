...
enum { RogueCombat, RogueSpellPreventing, RogueThreat, RogueStealth };
...
private:
  ...
  // COMBAT
  uint32 ADRENALINE_RUSH, SINISTER_STRIKE, BACKSTAB, GOUGE, EVASION, SPRINT, KICK, FEINT, SHIV;

  // SUBTLETY
  uint32 SHADOWSTEP, STEALTH, VANISH, HEMORRHAGE, BLIND, PICK_POCKET, CLOAK_OF_SHADOWS, CRIPPLING_POISON, DEADLY_POISON,
      MIND_NUMBING_POISON, GHOSTLY_STRIKE, DISTRACT, PREPARATION, PREMEDITATION;

  // ASSASSINATION
  uint32 COLD_BLOOD, EVISCERATE, SLICE_DICE, GARROTE, EXPOSE_ARMOR, AMBUSH, RUPTURE, CHEAP_SHOT, KIDNEY_SHOT, MUTILATE,
      ENVENOM, DEADLY_THROW;
