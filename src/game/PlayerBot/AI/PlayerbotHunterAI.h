...
private:
  ...
  uint32 PET_SUMMON, PET_DISMISS, PET_REVIVE, PET_MEND, PET_FEED, BESTIAL_WRATH, BAD_ATTITUDE, SONIC_BLAST,
      DEMORALIZING_SCREECH, INTIMIDATION;

  uint32 AUTO_SHOT, HUNTERS_MARK, ARCANE_SHOT, CONCUSSIVE_SHOT, DISTRACTING_SHOT, MULTI_SHOT, SERPENT_STING,
      SCORPID_STING, VIPER_STING, WYVERN_STING, AIMED_SHOT, VOLLEY, BLACK_ARROW, TRANQUILIZING_SHOT;
