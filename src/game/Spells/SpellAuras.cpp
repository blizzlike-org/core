...
pAuraHandler AuraHandler[TOTAL_AURAS] = {
    ...
    &Aura::HandleNoImmediateEffect,  // 14 SPELL_AURA_MOD_DAMAGE_TAKEN   implemented in Unit::MeleeDamageBonusTaken and
    ...
    &Aura::HandleAuraProcTriggerSpell, // 42 SPELL_AURA_PROC_TRIGGER_SPELL  implemented in Unit::ProcDamageAndSpellFor
                                       // and Unit::HandleProcTriggerSpell
    ...
    &Aura::HandleNoImmediateEffect, // 59 SPELL_AURA_MOD_DAMAGE_DONE_CREATURE implemented in Unit::MeleeDamageBonusDone
    ...
    &Aura::HandleNoImmediateEffect,       // 75 SPELL_AURA_MOD_LANGUAGE           implemented in
    ...
    &Aura::HandleNoImmediateEffect,       // 81 SPELL_AURA_SPLIT_DAMAGE_PCT       implemented in
    ...
    &Aura::HandleNoImmediateEffect, // 87 SPELL_AURA_MOD_DAMAGE_PERCENT_TAKEN implemented in Unit::MeleeDamageBonusTaken
                                    // and Unit::SpellDamageBonusTaken
    ...
    &Aura::HandleNoImmediateEffect,    // 102 SPELL_AURA_MOD_MELEE_ATTACK_POWER_VERSUS implemented in
    ...
    &Aura::HandleNoImmediateEffect, // 114 SPELL_AURA_MOD_RANGED_DAMAGE_TAKEN_PCT implemented in
                                    // Unit::MeleeDamageBonusTaken
    &Aura::HandleNoImmediateEffect, // 115 SPELL_AURA_MOD_HEALING                 implemented in
                                    // Unit::SpellBaseHealingBonusTaken
    &Aura::HandleNoImmediateEffect, // 116 SPELL_AURA_MOD_REGEN_DURING_COMBAT     imppemented in Player::RegenerateAll
                                    // and Player::RegenerateHealth
    &Aura::HandleNoImmediateEffect, // 117 SPELL_AURA_MOD_MECHANIC_RESISTANCE     implemented in
                                    // Unit::MagicSpellHitResult
    &Aura::HandleModHealingPCT,     // 118 SPELL_AURA_MOD_HEALING_PCT             implemented in
    ...
    &Aura::HandleNoImmediateEffect, // 126 SPELL_AURA_MOD_MELEE_DAMAGE_TAKEN_PCT implemented in
                                    // Unit::MeleeDamageBonusTaken
    &Aura::HandleNoImmediateEffect, // 127 SPELL_AURA_RANGED_ATTACK_POWER_ATTACKER_BONUS implemented in
                                    // Unit::MeleeDamageBonusDone
    &Aura::HandleModPossessPet,     // 128 SPELL_AURA_MOD_POSSESS_PET
    &Aura::HandleAuraModIncreaseSpeed,         // 129 SPELL_AURA_MOD_SPEED_ALWAYS
    &Aura::HandleAuraModIncreaseMountedSpeed,  // 130 SPELL_AURA_MOD_MOUNTED_SPEED_ALWAYS
    &Aura::HandleNoImmediateEffect,            // 131 SPELL_AURA_MOD_RANGED_ATTACK_POWER_VERSUS implemented in
                                               // Unit::MeleeDamageBonusDone
    &Aura::HandleAuraModIncreaseEnergyPercent, // 132 SPELL_AURA_MOD_INCREASE_ENERGY_PERCENT
    &Aura::HandleAuraModIncreaseHealthPercent, // 133 SPELL_AURA_MOD_INCREASE_HEALTH_PERCENT
    &Aura::HandleAuraModRegenInterrupt,        // 134 SPELL_AURA_MOD_MANA_REGEN_INTERRUPT
    &Aura::HandleModHealingDone,               // 135 SPELL_AURA_MOD_HEALING_DONE
    &Aura::HandleNoImmediateEffect,            // 136 SPELL_AURA_MOD_HEALING_DONE_PERCENT   implemented in
    ...
    &Aura::HandleAuraSafeFall,                 // 144 SPELL_AURA_SAFE_FALL                  implemented in
    ...
    &Aura::HandleModMechanicImmunityMask,      // 147 SPELL_AURA_MECHANIC_IMMUNITY_MASK     implemented in
                                               // Unit::IsImmuneToSpell and Unit::IsImmuneToSpellEffect (check part)
    &Aura::HandleAuraRetainComboPoints,        // 148 SPELL_AURA_RETAIN_COMBO_POINTS
    &Aura::HandleNoImmediateEffect,  // 149 SPELL_AURA_RESIST_PUSHBACK            implemented in Spell::Delayed and
                                     // Spell::DelayedChannel
    &Aura::HandleShieldBlockValue,   // 150 SPELL_AURA_MOD_SHIELD_BLOCKVALUE_PCT
    &Aura::HandleAuraTrackStealthed, // 151 SPELL_AURA_TRACK_STEALTHED
    &Aura::HandleNoImmediateEffect,  // 152 SPELL_AURA_MOD_DETECTED_RANGE         implemented in
                                     // Creature::GetAttackDistance
    &Aura::HandleNoImmediateEffect,  // 153 SPELL_AURA_SPLIT_DAMAGE_FLAT          implemented in
                                     // Unit::CalculateAbsorbAndResist
    ...
    &Aura::HandleNoImmediateEffect,  // 156 SPELL_AURA_MOD_REPUTATION_GAIN        implemented in
    ...
    &Aura::HandleNoImmediateEffect, // 160 SPELL_AURA_MOD_AOE_AVOIDANCE          implemented in
                                    // Unit::MagicSpellHitResult
    &Aura::HandleNoImmediateEffect, // 161 SPELL_AURA_MOD_HEALTH_REGEN_IN_COMBAT implemented in Player::RegenerateAll
                                    // and Player::RegenerateHealth
    &Aura::HandleAuraPowerBurn,     // 162 SPELL_AURA_POWER_BURN_MANA
    &Aura::HandleNoImmediateEffect, // 163 SPELL_AURA_MOD_CRIT_DAMAGE_BONUS      implemented in
                                    // Unit::CalculateMeleeDamage and Unit::SpellCriticalDamageBonus
    ...
    &Aura::HandleNoImmediateEffect,               // 168 SPELL_AURA_MOD_DAMAGE_DONE_VERSUS            implemented in
                                                  // Unit::SpellDamageBonusDone, Unit::MeleeDamageBonusDone
    &Aura::HandleNoImmediateEffect,               // 169 SPELL_AURA_MOD_CRIT_PERCENT_VERSUS           implemented in
                                    // Unit::DealDamageBySchool, Unit::DoAttackDamage, Unit::SpellCriticalBonus
    ...
    &Aura::HandleModSpellDamagePercentFromStat,  // 174 SPELL_AURA_MOD_SPELL_DAMAGE_OF_STAT_PERCENT  implemented in
                                                 // Unit::SpellBaseDamageBonusDone
    &Aura::HandleModSpellHealingPercentFromStat, // 175 SPELL_AURA_MOD_SPELL_HEALING_OF_STAT_PERCENT implemented in
                                                 // Unit::SpellBaseHealingBonusDone
    &Aura::HandleSpiritOfRedemption, // 176 SPELL_AURA_SPIRIT_OF_REDEMPTION   only for Spirit of Redemption spell, die
                                     // at aura end
    &Aura::HandleAoECharm,           // 177 SPELL_AURA_AOE_CHARM
    &Aura::HandleNoImmediateEffect,  // 178 SPELL_AURA_MOD_DEBUFF_RESISTANCE          implemented in
                                     // Unit::MagicSpellHitResult
    &Aura::HandleNoImmediateEffect,  // 179 SPELL_AURA_MOD_ATTACKER_SPELL_CRIT_CHANCE implemented in
                                     // Unit::SpellCriticalBonus
    &Aura::HandleNoImmediateEffect,  // 180 SPELL_AURA_MOD_FLAT_SPELL_DAMAGE_VERSUS   implemented in
                                     // Unit::SpellDamageBonusDone
    &Aura::HandleUnused,             // 181 SPELL_AURA_MOD_FLAT_SPELL_CRIT_DAMAGE_VERSUS unused
    &Aura::HandleAuraModResistenceOfStatPercent, // 182 SPELL_AURA_MOD_RESISTANCE_OF_STAT_PERCENT
    &Aura::HandleNoImmediateEffect,      // 183 SPELL_AURA_MOD_CRITICAL_THREAT only used in 28746, implemented in
                                         // ThreatCalcHelper::CalcThreat
    &Aura::HandleNoImmediateEffect,      // 184 SPELL_AURA_MOD_ATTACKER_MELEE_HIT_CHANCE  implemented in
                                         // Unit::CalculateEffectiveMissChance
    &Aura::HandleNoImmediateEffect,      // 185 SPELL_AURA_MOD_ATTACKER_RANGED_HIT_CHANCE implemented in
                                         // Unit::CalculateEffectiveMissChance
    &Aura::HandleNoImmediateEffect,      // 186 SPELL_AURA_MOD_ATTACKER_SPELL_HIT_CHANCE  implemented in
                                         // Unit::MagicSpellHitResult
    &Aura::HandleNoImmediateEffect,      // 187 SPELL_AURA_MOD_ATTACKER_MELEE_CRIT_CHANCE  implemented in
                                         // Unit::CalculateEffectiveCritChance
    &Aura::HandleNoImmediateEffect,      // 188 SPELL_AURA_MOD_ATTACKER_RANGED_CRIT_CHANCE implemented in
                                         // Unit::CalculateEffectiveCritChance
    &Aura::HandleModRating,              // 189 SPELL_AURA_MOD_RATING
    &Aura::HandleNoImmediateEffect,      // 190 SPELL_AURA_MOD_FACTION_REPUTATION_GAIN     implemented in
                                         // Player::CalculateReputationGain
    ...
    &Aura::HandleNoImmediateEffect, // 197 SPELL_AURA_MOD_ATTACKER_SPELL_AND_WEAPON_CRIT_CHANCE implemented in
                                    // Unit::SpellCriticalBonus Unit::GetUnitCriticalChance
    &Aura::HandleUnused,            // 198 SPELL_AURA_MOD_ALL_WEAPON_SKILLS
    &Aura::HandleNoImmediateEffect, // 199 SPELL_AURA_MOD_INCREASES_SPELL_PCT_TO_HIT  implemented in
                                    // Unit::MagicSpellHitResult
    &Aura::HandleNoImmediateEffect, // 200 SPELL_AURA_MOD_XP_PCT                      implemented in Player::GiveXP
    &Aura::HandleAuraAllowFlight,   // 201 SPELL_AURA_FLY                             this aura enable flight mode...
    &Aura::HandleNoImmediateEffect, // 202 SPELL_AURA_IGNORE_COMBAT_RESULT            implemented in
                                    // Unit::MeleeSpellHitResult
    &Aura::HandleNoImmediateEffect, // 203 SPELL_AURA_MOD_ATTACKER_MELEE_CRIT_DAMAGE  implemented in
                                    // Unit::CalculateMeleeDamage and Unit::SpellCriticalDamageBonus
    &Aura::HandleNoImmediateEffect, // 204 SPELL_AURA_MOD_ATTACKER_RANGED_CRIT_DAMAGE implemented in
                                    // Unit::CalculateMeleeDamage and Unit::SpellCriticalDamageBonus
    &Aura::HandleNoImmediateEffect, // 205 SPELL_AURA_MOD_ATTACKER_SPELL_CRIT_DAMAGE  implemented in
    ...
    &Aura::HandleNoImmediateEffect,             // 229 SPELL_AURA_MOD_AOE_DAMAGE_AVOIDANCE        implemented in
                                                // Unit::SpellDamageBonusTaken
    &Aura::HandleAuraModIncreaseMaxHealth,      // 230 Commanding Shout
    &Aura::HandleNoImmediateEffect,             // 231 SPELL_AURA_PROC_TRIGGER_SPELL_WITH_VALUE
    &Aura::HandleNoImmediateEffect,             // 232 SPELL_AURA_MECHANIC_DURATION_MOD           implement in
                                                // Unit::CalculateAuraDuration
    &Aura::HandleNULL,                // 233 set model id to the one of the creature with id m_modifier.m_miscvalue
    &Aura::HandleNoImmediateEffect,   // 234 SPELL_AURA_MECHANIC_DURATION_MOD_NOT_STACK implement in
                                      // Unit::CalculateAuraDuration
    &Aura::HandleAuraModDispelResist, // 235 SPELL_AURA_MOD_DISPEL_RESIST               implement in
                                      // Unit::MagicSpellHitResult
    &Aura::HandleUnused,              // 236 unused
    &Aura::HandleModSpellDamagePercentFromAttackPower,  // 237 SPELL_AURA_MOD_SPELL_DAMAGE_OF_ATTACK_POWER  implemented
                                                        // in Unit::SpellBaseDamageBonusDone
    &Aura::HandleModSpellHealingPercentFromAttackPower, // 238 SPELL_AURA_MOD_SPELL_HEALING_OF_ATTACK_POWER implemented
                                                        // in Unit::SpellBaseHealingBonusDone
    ...
    &Aura::HandleAuraMirrorImage,    // 247 SPELL_AURA_MIRROR_IMAGE                      target to become a clone of the
                                     // caster
    &Aura::HandleNoImmediateEffect,  // 248 SPELL_AURA_MOD_COMBAT_RESULT_CHANCE         implemented in
                                     // Unit::CalculateEffectiveDodgeChance, Unit::CalculateEffectiveParryChance,
                                     // Unit::CalculateEffectiveBlockChance
    &Aura::HandleNULL,               // 249
...
Aura::Aura(SpellEntry const *spellproto, SpellEffectIndex eff, int32 const *currentDamage,
           int32 const *currentBasePoints, SpellAuraHolder *holder, Unit *target, Unit *caster, Item *castItem)
    : m_spellmod(nullptr), m_periodicTimer(0), m_periodicTick(0), m_removeMode(AURA_REMOVE_BY_DEFAULT), m_effIndex(eff),
      m_positive(false), m_isPeriodic(false), m_isAreaAura(false), m_isPersistent(false), m_magnetUsed(false),
      m_spellAuraHolder(holder), m_scriptValue(0) {
  ...
  if (caster) {
    if (!damage && castItem && castItem->GetItemSuffixFactor()) {
      ItemRandomSuffixEntry const *item_rand_suffix =
          sItemRandomSuffixStore.LookupEntry(abs(castItem->GetItemRandomPropertyId()));
      if (item_rand_suffix) {
        for (int k = 0; k < 3; ++k) {
          SpellItemEnchantmentEntry const *pEnchant =
              sSpellItemEnchantmentStore.LookupEntry(item_rand_suffix->enchant_id[k]);
          if (pEnchant) {
...
AreaAura::AreaAura(SpellEntry const *spellproto, SpellEffectIndex eff, int32 const *currentDamage,
                   int32 const *currentBasePoints, SpellAuraHolder *holder, Unit *target, Unit *caster, Item *castItem,
                   uint32 originalRankSpellId)
    : Aura(spellproto, eff, currentDamage, currentBasePoints, holder, target, caster, castItem),
...
PersistentAreaAura::PersistentAreaAura(SpellEntry const *spellproto, SpellEffectIndex eff, int32 const *currentDamage,
                                       int32 const *currentBasePoints, SpellAuraHolder *holder, Unit *target,
...
SingleEnemyTargetAura::SingleEnemyTargetAura(SpellEntry const *spellproto, SpellEffectIndex eff,
                                             int32 const *currentDamage, int32 const *currentBasePoints,
                                             SpellAuraHolder *holder, Unit *target, Unit *caster, Item *castItem)
    : Aura(spellproto, eff, currentDamage, currentBasePoints, holder, target, caster, castItem) {
  if (caster)
...
Aura *CreateAura(SpellEntry const *spellproto, SpellEffectIndex eff, int32 const *currentDamage,
                 int32 const *currentBasePoints, SpellAuraHolder *holder, Unit *target, Unit *caster, Item *castItem) {
  ...
  if (SpellEntry const *triggeredSpellInfo = sSpellTemplate.LookupEntry<SpellEntry>(triggeredSpellId))
    for (unsigned int i : triggeredSpellInfo->EffectImplicitTargetA)
      if (i == TARGET_UNIT_CHANNEL_TARGET)
        return new SingleEnemyTargetAura(spellproto, eff, currentDamage, currentBasePoints, holder, target, caster,
                                         castItem);

  return new Aura(spellproto, eff, currentDamage, currentBasePoints, holder, target, caster, castItem);
}

SpellAuraHolder *CreateSpellAuraHolder(SpellEntry const *spellproto, Unit *target, WorldObject *caster,
                                       Item *castItem /*= nullptr*/, SpellEntry const *triggeredBy /*= nullptr*/) {
...
void Aura::Update(uint32 diff) {
  if (m_isPeriodic) {
    ...
    if (m_periodicTimer <= 0) // tick also at m_periodicTimer==0 to prevent lost last tick in case max m_duration ==
                              // (max m_periodicTimer)*N
    {
...
void AreaAura::Update(uint32 diff) {
  ...
  if (GetCasterGuid() == GetTarget()->GetObjectGuid()) {
    ...
    if (!caster->hasUnitState(UNIT_STAT_ISOLATED)) {
      ...
      case AREA_AURA_PARTY: {
          ...
          if (pGroup) {
            ...
            for (GroupReference *itr = pGroup->GetFirstMember(); itr != nullptr; itr = itr->next()) {
              ...
              if (Target && Target->IsAlive() && Target->GetSubGroup() == subgroup &&
                  caster->CanAssistSpell(Target, GetSpellProto())) {
        ...
        } else // handle aura party for creatures
        {
          ...
          for (auto target : nearbyTargets) {
            // Due to the lack of support for NPC groups or formations, are considered of the same party NPCs with same
            // faction than caster
      ...
      for (auto &target : targets) {
        ...
        if (GetCasterGuid() ==
            target->GetObjectGuid()) // if caster is same as target then no need to change rank of the spell
          actualSpellInfo = GetSpellProto();
        else
          actualSpellInfo = sSpellMgr.SelectAuraRankForLevel(
              GetSpellProto(), target->getLevel()); // use spell id according level of the target
        if (!actualSpellInfo)
          continue;
        ...
        AreaAura *aur = new AreaAura(actualSpellInfo, m_effIndex, &actualDamage, &actualBasePoints, holder, target,
                                     caster, nullptr, GetSpellProto()->Id);
  ...
  } else // aura at non-caster
  {
    ...
    uint32 originalRankSpellId = m_originalRankSpellId
                                     ? m_originalRankSpellId
    ...
    if (!caster || caster->hasUnitState(UNIT_STAT_ISOLATED) || !caster->HasAura(originalRankSpellId, GetEffIndex()) ||
...
bool Aura::CanProcFrom(SpellEntry const *spell, uint32 EventProcEx, uint32 procEx, bool active,
                       bool useClassMask) const {
...
void Aura::ReapplyAffectedPassiveAuras(Unit *target, bool owner_mode) {
  ...
  if (!affectedSelf.empty()) {
    ...
    for (std::map<uint32, ObjectGuid>::const_iterator map_itr = affectedSelf.begin(); map_itr != affectedSelf.end();
         ++map_itr) {
...
void Aura::PickTargetsForSpellTrigger(Unit *&triggerCaster, Unit *&triggerTarget, WorldObject *&triggerTargetObject,
  ...
  case TARGET_LOCATION_CASTER_SRC: // TODO: this needs to be done whenever target isnt important, doing it per case for
                                   // safety
                                   //[[fallthrough]]
...
void Aura::CastTriggeredSpell(PeriodicTriggerData &data) {
  Spell *spell =
      new Spell(data.caster, data.spellInfo, TRIGGERED_OLD_TRIGGERED, data.caster->GetObjectGuid(), GetSpellProto());
  SpellCastTargets targets;
  if (data.spellInfo->Targets & TARGET_FLAG_DEST_LOCATION) {
    if (data.targetObject)
      targets.setDestination(data.targetObject->GetPositionX(), data.targetObject->GetPositionY(),
                             data.targetObject->GetPositionZ());
    else if (data.target)
  ...
  if (data.spellInfo->Targets & TARGET_FLAG_SOURCE_LOCATION) {
    if (data.targetObject)
      targets.setSource(data.targetObject->GetPositionX(), data.targetObject->GetPositionY(),
                        data.targetObject->GetPositionZ());
    else if (data.target)
...
void Aura::TriggerSpell() {
  ...
  if (triggeredSpellInfo == nullptr) {
    ...
    case SPELLFAMILY_GENERIC: {
      ...
      case 812: // Periodic Mana Burn
      {
        ...
        triggerTarget =
            ((Creature *)GetTarget())
                ->SelectAttackingTarget(ATTACKING_TARGET_TOPAGGRO, 0, trigger_spell_id, SELECT_FLAG_POWER_MANA);
        if (!triggerTarget)
          return;
      ...
      case 25371: // Consume
      {
        ...
        triggerTarget->CastCustomSpell(triggerTarget, 25373, &bpDamage, nullptr, nullptr, TRIGGERED_OLD_TRIGGERED,
      ...
      case 27819: {
        ...
        triggerTarget->CastCustomSpell(triggerTarget, 27820, &bpDamage, nullptr, nullptr, TRIGGERED_OLD_TRIGGERED,
                                       nullptr, this, triggerTarget->GetObjectGuid());
        return;
      }
        //                    // Controller Timer
        //                    case 28095: break;
      ...
      {
        uint32 spellForTick[6] = {30116, 30117, 30118,
                                  30119, 30118, 30117}; // Circling back and forth through the 4 plague areas
      ...
      case 30427: // Extract Gas
      {
        ...
        if (caster->GetTypeId() == TYPEID_PLAYER && triggerTarget->GetTypeId() == TYPEID_UNIT &&
      ...
      case 31373: // Spellcloth
      {
        ...
        triggerTarget->SummonCreature(17870, 0.0f, 0.0f, 0.0f, triggerTarget->GetOrientation(), TEMPSPAWN_DEAD_DESPAWN,
                                      0);
        return;
      }
      ...
      case 31944: // Doomfire
      {
        ...
        triggerTarget->CastCustomSpell(triggerTarget, 31969, &damage, nullptr, nullptr, TRIGGERED_OLD_TRIGGERED,
                                       nullptr, this, casterGUID);
        return;
      }
        //                    // Teleport Test
      ...
      case 39346: {
        ...
        triggerTarget->CastCustomSpell(triggerTarget, 35283, &damage, nullptr, nullptr, TRIGGERED_OLD_TRIGGERED,
                                       nullptr, this, casterGUID);
        return;
      }
      // Gravity Lapse
      ...
      case 34821: // Arcane Flurry (Melee Component)
      {
        ...
        triggerTarget = ((Creature *)GetTarget())
                            ->SelectAttackingTarget(ATTACKING_TARGET_RANDOM, 0, trigger_spell_id, SELECT_FLAG_PLAYER);
        if (!triggerTarget)
          return;
      ...
      case 36350:                 // They Must Burn Bomb Aura (self)
        ...
        //                    // Vision Guide
      case 36573:
        return; // atm implemented in dbscripts
      ...
      case 39105: // Activate Nether-wraith Beacon (31742 Nether-wraith Beacon item)
      {
        ...
        Creature *wraith = triggerTarget->SummonCreature(22408, fX, fY, fZ, triggerTarget->GetOrientation(),
      ...
      case 39645: {
        ...
        triggerTarget->CastCustomSpell(triggerTarget, 39646, &damageForTick[GetAuraTicks() - 1], nullptr, nullptr,
                                       TRIGGERED_OLD_TRIGGERED, nullptr);
        return;
      } break;
      case 39857: // Tear of Azzinoth Summon Channel - it's not really supposed to do anything,and this only prevents
                  // the console spam
      ...
      case 40867: // Random Periodic
      {
        ...
        if (target->GetTypeId() == TYPEID_UNIT)
          triggerTarget = static_cast<Creature *>(target)->SelectAttackingTarget(ATTACKING_TARGET_RANDOM, 0,
                                                                                 trigger_spell_id, SELECT_FLAG_PLAYER);
        return;
      }
        //                    // Prismatic Shield
        //                    case 40879: break;
    ...
    case SPELLFAMILY_DRUID: {
      ...
      case 26999: {
        ...
        target->CastCustomSpell(target, 22845, &FRTriggerBasePoints, nullptr, nullptr, TRIGGERED_OLD_TRIGGERED, nullptr,
                                this);
        return;
      }
      default:
    ...
    // for channeled spell cast applied from aura owner to channel target (persistent aura affects already applied to
    // true target) come periodic casts applied to targets, so need select proper caster (ex. 15790) interesting 2
    // cases: periodic aura at caster of channeled spell
    ...
    {
      triggerCaster->CastCustomSpell(nullptr, trigger_spell_id, &m_modifier.m_amount, nullptr, nullptr,
    ...
    case 29768: // Overload
    {
      ...
      if (damage > 3200)
        damage = 3200;
      triggerCaster->CastCustomSpell(triggerTarget, triggeredSpellInfo, &damage, nullptr, nullptr,
                                     TRIGGERED_OLD_TRIGGERED, nullptr, this, casterGUID);
      return;
    }
    case 32930: // Blue beam
      return;   // Never seems to go off in sniffs - hides errors
    /*case 30502:                                   // Dark Spin - Only Effect0 s.30505 should be affect, else s.30508
    doesnt work anymore
    {
        if (GetCaster()->GetTypeId() != TYPEID_UNIT)
            return;

        triggerTarget = ((Creature*)GetCaster())->SelectAttackingTarget(ATTACKING_TARGET_RANDOM, 0, trigger_spell_id,
    SELECT_FLAG_PLAYER); if (!triggerTarget) return;
    ...
    case 37098: // Rain of Bones - Nightbane
    {
      ...
      case 16:
      case 20:
        target->CastSpell(triggerTargetObject->GetPositionX(), triggerTargetObject->GetPositionY(),
                          triggerTargetObject->GetPositionZ(), 30170, TRIGGERED_OLD_TRIGGERED);
        break;
      }
      break;
    }
    ...
    case 41480: // Deadly Strike
    {
      if (target->GetTypeId() == TYPEID_UNIT) // each tick has to target a random target
        triggerTarget = static_cast<Creature *>(target)->SelectAttackingTarget(ATTACKING_TARGET_RANDOM, 0, 41485,
                                                                               SELECT_FLAG_PLAYER);
      break;
    }
  ...
  } else if (!GetAuraScript()) // if scripter scripted spell, it is handled somehow
  {
    if (Unit *caster = GetCaster()) {
      if (triggerTarget->GetTypeId() != TYPEID_UNIT ||
          !sScriptDevAIMgr.OnEffectDummy(caster, GetId(), GetEffIndex(), (Creature *)triggerTarget, ObjectGuid()))
        sLog.outError("Aura::TriggerSpell: Spell %u have 0 in EffectTriggered[%d], not handled custom case?", GetId(),
                      GetEffIndex());
    }
  }
}
...
void Aura::HandleAuraDummy(bool apply, bool Real) {
    ...
    case SPELLFAMILY_GENERIC: {
      ...
      case 10255: // Stoned
      {
        if (Unit *caster = GetCaster()) {
          ...
          caster->SetFlag(UNIT_FIELD_FLAGS,
                          UNIT_FLAG_IMMUNE_TO_PLAYER | UNIT_FLAG_IMMUNE_TO_NPC | UNIT_FLAG_NOT_SELECTABLE);
      ...
      case 31606: // Stormcrow Amulet
      {
        ...
        // we must assume db or script set display id to native at ending flight (if not, target is stuck with this
        // model)
        if (cInfo)
      ...
      case 31736: // Ironvine Seeds
      {
        ...
        Creature *SteamPumpOverseer = target->SummonCreature(
            18340, pCaster->GetPositionX() - 20, pCaster->GetPositionY() + 20, pCaster->GetPositionZ(),
            target->GetOrientation(), TEMPSPAWN_TIMED_OOC_DESPAWN, 10000);

        if (SteamPumpOverseer && pCaster)
          SteamPumpOverseer->GetMotionMaster()->MovePoint(0, pCaster->GetPositionX(), pCaster->GetPositionY(),
  ...
  // AT REMOVE
    ...
    case 42517: // Beam to Zelfrax
    {
      ...
      target->SummonCreature(23864, -2985.01f, -3853.649f, 44.23183f, 5.51524f, TEMPSPAWN_TIMED_OOC_OR_DEAD_DESPAWN,
                             60000);
      return;
    }
    case 44191: // Flame Strike
    {
      target->CastSpell(nullptr, target->GetUInt32Value(UNIT_CREATED_BY_SPELL) == 44192 ? 44190 : 46163,
    ...
    case 45934: // Dark Fiend
    {
      ...
      if (m_removeMode == AURA_REMOVE_BY_DISPEL)
        Unit::DealDamage(target, target, target->GetHealth(), nullptr, DIRECT_DAMAGE, SPELL_SCHOOL_MASK_NORMAL, nullptr,
                         false);
      return;
    }
  ...
  case SPELLFAMILY_GENERIC: {
    ...
    case 37025: // Coilfang Water
    {
      if (apply) {
        if (InstanceData *pInst = target->GetInstanceData()) {
          ...
          if (pInst->CheckConditionCriteriaMeet(playerTarget, INSTANCE_CONDITION_ID_LURKER, nullptr,
                                                CONDITION_FROM_HARDCODED)) {
            if (pInst->CheckConditionCriteriaMeet(playerTarget, INSTANCE_CONDITION_ID_SCALDING_WATER, nullptr,
                                                  CONDITION_FROM_HARDCODED))
    ...
    {
      // aura animate dead (fainted) state for the duration, but we need to animate the death itself (correct way
      // below?)
      if (Unit *pCaster = GetCaster())
      ...
      if (apply) {
        if (Unit *caster = GetCaster()) {
          ...
          if (target->GetTypeId() != TYPEID_PLAYER || !((Player *)target)->GetSession()->PlayerLoading()) {
            ...
            m_modifier.m_amount =
                caster->SpellHealingBonusDone(target, GetSpellProto(), m_modifier.m_amount, SPELL_DIRECT_DAMAGE);
            m_modifier.m_amount =
                target->SpellHealingBonusTaken(caster, GetSpellProto(), m_modifier.m_amount, SPELL_DIRECT_DAMAGE);
          }
        }
      } else {
        ...
        if (target->IsInWorld()) {
          ...
          target->CastCustomSpell(nullptr, 33778, &amount, nullptr, nullptr, TRIGGERED_OLD_TRIGGERED, nullptr, this,
                                  GetCasterGuid());
        }
      }
      return;
...
void Aura::HandleWaterBreathing(bool apply, bool /*Real*/) {
  ...
  if (target->GetTypeId() == TYPEID_PLAYER)
    static_cast<Player *>(target)->SetWaterBreathingIntervalMultiplier(
        apply ? 0 : target->GetTotalAuraMultiplier(SPELL_AURA_MOD_WATER_BREATHING));
}
...
void Aura::HandleModWaterBreathing(bool /*apply*/, bool /*Real*/) {
  ...
  if (target->GetTypeId() == TYPEID_PLAYER)
    static_cast<Player *>(target)->SetWaterBreathingIntervalMultiplier(
        target->GetTotalAuraMultiplier(SPELL_AURA_MOD_WATER_BREATHING));
}
  ...
  if (apply) {
    ...
    if (PowerType != POWER_MANA) {
      ...
      case FORM_BERSERKERSTANCE: {
        ...
        uint32 Rage_val = 0;
        // Stance mastery + Tactical mastery (both passive, and last have aura only in defense stance, but need apply at
        // any stance switch)
        if (target->GetTypeId() == TYPEID_PLAYER) {
...
void Aura::HandleAuraTransform(bool apply, bool Real) {
  ...
  if (apply) {
    ...
    if (m_modifier.m_miscvalue == 0) {
      ...
      case 16739: // Orb of Deception
      {
        ...
        // Troll Female
        case 1479:
          m_modifier.m_amount = 10134;
          break;
        // Troll Male
        case 1478:
          m_modifier.m_amount = 10135;
          break;
        // Tauren Male
        case 59:
          m_modifier.m_amount = 10136;
          break;
        // Human Male
        case 49:
          m_modifier.m_amount = 10137;
          break;
        // Human Female
        case 50:
          m_modifier.m_amount = 10138;
          break;
        // Orc Male
        case 51:
          m_modifier.m_amount = 10139;
          break;
        // Orc Female
        case 52:
          m_modifier.m_amount = 10140;
          break;
        // Dwarf Male
        case 53:
          m_modifier.m_amount = 10141;
          break;
        // Dwarf Female
        case 54:
          m_modifier.m_amount = 10142;
          break;
        // NightElf Male
        case 55:
          m_modifier.m_amount = 10143;
          break;
        // NightElf Female
        case 56:
          m_modifier.m_amount = 10144;
          break;
        // Undead Female
        case 58:
          m_modifier.m_amount = 10145;
          break;
        // Undead Male
        case 57:
          m_modifier.m_amount = 10146;
          break;
        // Tauren Female
        case 60:
          m_modifier.m_amount = 10147;
          break;
        // Gnome Male
        case 1563:
          m_modifier.m_amount = 10148;
          break;
        // Gnome Female
        case 1564:
          m_modifier.m_amount = 10149;
          break;
        // BloodElf Female
        case 15475:
          m_modifier.m_amount = 17830;
          break;
        // BloodElf Male
        case 15476:
          m_modifier.m_amount = 17829;
          break;
        // Dranei Female
        case 16126:
          m_modifier.m_amount = 17828;
          break;
        // Dranei Male
        case 16125:
          m_modifier.m_amount = 17827;
          break;
        default:
          break;
        }
  ...
  } else // !apply
  {
    ...
    if (target->GetTypeId() == TYPEID_UNIT && restoreEquip)
      static_cast<Creature *>(target)->LoadEquipment(
          static_cast<Creature *>(target)->GetCreatureInfo()->EquipmentTemplateId, true);
  }
}
...
void Aura::HandleChannelDeathItem(bool apply, bool Real) {
  if (Real && !apply) {
    ...
    if (itemType == 6265) {
      ...
      // 1.11.0: If you cast Drain Soul while shadowburn is on the victim, you will no longer receive two soul shards
      // upon the victim's death.
      for (auto const &aura : victim->GetAurasByType(SPELL_AURA_CHANNEL_DEATH_ITEM))
        if (aura != this && caster->GetObjectGuid() == aura->GetCasterGuid() &&
            aura->GetSpellProto()->EffectItemType[aura->GetEffIndex()] == itemType)
          return;
    }
    ...
    InventoryResult msg =
        ((Player *)caster)->CanStoreNewItem(NULL_BAG, NULL_SLOT, dest, itemType, count, &noSpaceForCount);
    if (msg != EQUIP_ERR_OK) {
...
void Aura::HandleModCharm(bool apply, bool Real) {
  ...
  if (apply) {
    ...
    // * Seems to be non-unique for NPCs - allows overwriting advertised charm by offloading existing one (e.g.
    // Chromatic Mutation)
    // * Seems to be always unique for players - remove player's existing advertised charm (no evidence against this
    // found yet)
    if (playerCaster)
      caster->BreakCharmOutgoing(true);
...
void Aura::HandleAuraModDisarm(bool apply, bool Real) {
  ...
  // main-hand attack speed already set to special value for feral form already and don't must change and reset at
  // remove.
  ...
  if (apply) {
    ...
    case 27068: {
      ...
      case 27068:
        ...
        break;
      default:
        sLog.outError("Spell selection called for unexpected original spell %u, new spell for this spell family?",
                      GetId());
        return;
      }
...
void Aura::HandleModStealth(bool apply, bool Real) {
  Unit *target = GetTarget();
  // TODO: add mask
  target->GetVisibilityData().AddStealthStrength(StealthType(m_modifier.m_miscvalue),
...
void Aura::HandleModStealthDetect(bool apply, bool /*Real*/) {
  GetTarget()->GetVisibilityData().AddStealthDetectionStrength(StealthType(m_modifier.m_miscvalue),
                                                               apply ? m_modifier.m_amount : -m_modifier.m_amount);
}

void Aura::HandleModStealthLevel(bool apply, bool /*Real*/) {
  GetTarget()->GetVisibilityData().AddStealthStrength(StealthType(m_modifier.m_miscvalue),
                                                      apply ? m_modifier.m_amount : -m_modifier.m_amount);
}
...
void Aura::HandleInvisibility(bool apply, bool Real) {
  ...
  target->GetVisibilityData().AddInvisibilityValue(m_modifier.m_miscvalue,
                                                   apply ? m_modifier.m_amount : -m_modifier.m_amount);
  ...
  if (trueApply) {
    ...
    if (Real && target->GetTypeId() == TYPEID_PLAYER) {
      if (((Player *)target)
              ->IsSelfMover()) // check if the player doesnt have a mover, when player is hidden during MC of creature
      {
        // apply glow vision
  ...
  if (!apply) {
    ...
    case 38544: {
      ...
      if (pPlayer->GetMover() != target) {
        if (Creature *mover =
                (Creature *)pPlayer->GetMover()) // this spell uses DoSummonPossesed so remove this on removal
        {
...
void Aura::HandleInvisibilityDetect(bool apply, bool Real) {
  ...
  target->GetVisibilityData().AddInvisibilityDetectValue(m_modifier.m_miscvalue,
                                                         apply ? m_modifier.m_amount : -m_modifier.m_amount);
  if (!apply) {
...
void Aura::HandleAuraModSchoolImmunity(bool apply, bool Real) {
  ...
  if (Real && apply && GetSpellProto()->HasAttribute(SPELL_ATTR_EX_DISPEL_AURAS_ON_IMMUNITY) &&
...
void Aura::HandlePeriodicTriggerSpell(bool apply, bool /*Real*/) {
  ...
  if (apply) {
    ...
    case 43648: // Electrical Storm - Akil'zon - cast teleport self
      target->CastSpell(
          nullptr, 44006,
          TRIGGERED_OLD_TRIGGERED); // done here instead of script effect due to auras being applied after effects
      break;
    default:
      break;
    }
    ...
    case 42783: // Wrath of the Astrom...
      if (m_removeMode == AURA_REMOVE_BY_EXPIRE && GetEffIndex() + 1 < MAX_EFFECT_INDEX)
        target->CastSpell(target, GetSpellProto()->CalculateSimpleValue(SpellEffectIndex(GetEffIndex() + 1)),
                          TRIGGERED_OLD_TRIGGERED, nullptr, nullptr, GetCasterGuid());
      return;
    case 42177: // Alert Drums
      if (m_removeMode == AURA_REMOVE_BY_EXPIRE) {
        if (UnitAI *ai = target->AI())
  ...
  if (apply) // only on initial cast apply SP
    if (const SpellEntry *entry = GetSpellProto())
      if (GetHolder()->GetAuraCharges() == entry->procCharges)
        m_modifier.m_amount =
            GetCaster()->SpellHealingBonusDone(GetTarget(), GetSpellProto(), m_modifier.m_amount, HEAL);
}
...
void Aura::HandlePeriodicHeal(bool apply, bool /*Real*/) {
  ...
  if (apply) {
    ...
    switch (GetSpellProto()->Id) {
    case 12939:
      m_modifier.m_amount = target->GetMaxHealth() / 3;
      break; // Polymorph Heal Effect
    default:
      m_modifier.m_amount =
          caster->SpellHealingBonusDone(target, GetSpellProto(), m_modifier.m_amount, DOT, GetStackAmount());
      break;
    }
  } else if (GetSpellProto()->Id == 43421) // Malacrass - Lifebloom
  ...
  if (apply) {
    ...
    if (m_modifier.m_auraname == SPELL_AURA_PERIODIC_DAMAGE) {
      ...
      if (spellProto->DmgClass == SPELL_DAMAGE_CLASS_NONE || spellProto->DmgClass == SPELL_DAMAGE_CLASS_MAGIC)
        m_modifier.m_amount =
            caster->SpellDamageBonusDone(target, GetSpellProto(), m_modifier.m_amount, DOT, GetStackAmount());
      // MeleeDamagebonusDone for weapon based spells
      else {
        WeaponAttackType attackType = GetWeaponAttackType(GetSpellProto());
        m_modifier.m_amount =
            caster->MeleeDamageBonusDone(target, m_modifier.m_amount, attackType,
                                         SpellSchoolMask(spellProto->SchoolMask), spellProto, DOT, GetStackAmount());
      }
    }
  }
  // remove time effects
...
void Aura::HandlePeriodicLeech(bool apply, bool /*Real*/) {
  ...
  if (apply) {
    ...
    m_modifier.m_amount =
        caster->SpellDamageBonusDone(GetTarget(), GetSpellProto(), m_modifier.m_amount, DOT, GetStackAmount());
  }
}
...
void Aura::HandleAuraModResistanceExclusive(bool apply, bool /*Real*/) {
  ...
  for (uint32 i = SPELL_SCHOOL_NORMAL; i < MAX_SPELL_SCHOOL; ++i) {
    if (m_modifier.m_miscvalue & (1 << i)) {
      ...
      if (amount > bonusMax) {
        target->HandleStatModifier(UnitMods(UNIT_MOD_RESISTANCE_START + i), TOTAL_VALUE,
                                   float(apply ? bonusMax : amount), false);
        target->HandleStatModifier(UnitMods(UNIT_MOD_RESISTANCE_START + i), TOTAL_VALUE,
                                   float(apply ? amount : bonusMax), true);
        // UI bonus info:
        ...
        target->HandleStatModifier(UnitMods(UNIT_MOD_RESISTANCE_START + i), TOTAL_VALUE,
                                   float(apply ? malusMax : amount), false);
        target->HandleStatModifier(UnitMods(UNIT_MOD_RESISTANCE_START + i), TOTAL_VALUE,
                                   float(apply ? amount : malusMax), true);
        // UI malus info:
...
void Aura::HandleAuraModResistance(bool apply, bool /*Real*/) {
  ...
  for (uint32 i = SPELL_SCHOOL_NORMAL; i < MAX_SPELL_SCHOOL; ++i) {
    if (m_modifier.m_miscvalue & (1 << i)) {
      target->HandleStatModifier(UnitMods(UNIT_MOD_RESISTANCE_START + i), TOTAL_VALUE, float(m_modifier.m_amount),
                                 apply);
      // UI bonus/malus info:
...
void Aura::HandleModBaseResistance(bool apply, bool /*Real*/) {
  ...
  for (uint32 i = SPELL_SCHOOL_NORMAL; i < MAX_SPELL_SCHOOL; ++i) {
    if (m_modifier.m_miscvalue & (1 << i))
      target->HandleStatModifier(UnitMods(UNIT_MOD_RESISTANCE_START + i), BASE_VALUE, float(m_modifier.m_amount),
                                 apply);
  }
}
...
void Aura::HandleAuraModStat(bool apply, bool /*Real*/) {
  ...
  if (GetSpellProto()->IsFitToFamilyMask(0x0000000000008000)) // improved scorpid sting
  {
    if (apply) {
      ...
      target->RemoveAurasTriggeredBySpell(GetId(),
                                          GetCasterGuid()); // just do it every time, lookup is too time consuming
  }
  ...
  for (int32 i = STAT_STRENGTH; i < MAX_STATS; ++i) {
    ...
    if (m_modifier.m_miscvalue < 0 || m_modifier.m_miscvalue == i) {
      float amount =
          m_removeMode == AURA_REMOVE_BY_GAINED_STACK ? float(m_modifier.m_recentAmount) : float(m_modifier.m_amount);
...
void Aura::HandleModTotalPercentStat(bool apply, bool /*Real*/) {
  ...
  if (m_modifier.m_miscvalue == STAT_STAMINA && maxHPValue > 0 && GetSpellProto()->HasAttribute(SPELL_ATTR_ABILITY)) {
    // newHP = (curHP / maxHP) * newMaxHP = (newMaxHP * curHP) / maxHP -> which is better because no int -> double ->
    // int conversion is needed
...
void Aura::HandleAuraModIncreaseEnergy(bool apply, bool /*Real*/) {
  ...
  target->HandleStatModifier(
      unitMod, TOTAL_VALUE,
      float(m_removeMode == AURA_REMOVE_BY_GAINED_STACK ? m_modifier.m_recentAmount : m_modifier.m_amount), apply);
}
...
void Aura::HandleModPowerCostPCT(bool apply, bool Real) {
  ...
  float amount =
      (m_removeMode == AURA_REMOVE_BY_GAINED_STACK ? m_modifier.m_recentAmount : m_modifier.m_amount) / 100.0f;
      ...
      if (HotWSpellId) {
        ...
        for (auto i : mModTotalStatPct) {
          if (i->GetSpellProto()->SpellIconID == 240 && i->GetModifier()->m_miscvalue == 3) {
            ...
            target->CastCustomSpell(target, HotWSpellId, &HotWMod, nullptr, nullptr, TRIGGERED_OLD_TRIGGERED, nullptr,
                                    this);
            break;
          }
        }
      ...
      if (SpellBonusEntry const *bonus = sSpellMgr.GetSpellBonusData(spellProto->Id)) {
        ...
        case SPELLFAMILY_PRIEST:
          ...
          if (spellProto->SpellFamilyFlags & uint64(0x0000000000000001)) {
            DoneActualBenefit =
                caster->SpellBaseHealingBonusDone(GetSpellSchoolMask(spellProto)) * bonus->direct_damage;
            break;
          }
          break;
        default:
...
void Aura::PeriodicTick() {
  ...
  case SPELL_AURA_PERIODIC_DAMAGE_PERCENT: {
    ...
    case 38772: {
      uint32 percent = GetEffIndex() < EFFECT_INDEX_2 && spellProto->Effect[GetEffIndex()] == SPELL_EFFECT_DUMMY
    ...
    if (spellProto->Effect[GetEffIndex()] ==
            SPELL_EFFECT_PERSISTENT_AREA_AURA && // safe case - caster always will exist
    ...
    if (!spellProto->HasAttribute(SPELL_ATTR_UNAFFECTED_BY_INVULNERABILITY) ||
        overrideImmune) // confirmed Impaling spine goes through immunity
    {
    ...
    if ((spellProto->DmgClass == SPELL_DAMAGE_CLASS_NONE && isNotBleed) ||
    ...
    // MeleeDamagebonus for weapon based spells
      ...
      pdamage = target->MeleeDamageBonusTaken(caster, pdamage, attackType, SpellSchoolMask(spellProto->SchoolMask),
                                              spellProto, DOT, GetStackAmount());
    }

    pdamage -= target->GetResilienceRatingDamageReduction(pdamage, SpellDmgClass(spellProto->DmgClass), true);

    target->CalculateDamageAbsorbAndResist(caster, GetSpellSchoolMask(spellProto), DOT, pdamage, &absorb, &resist,
                                           IsReflectableSpell(spellProto), IsResistableSpell(spellProto));
    ...
    Unit::ProcDamageAndSpell(ProcSystemArguments(caster, target, procAttacker, procVictim, PROC_EX_NORMAL_HIT, pdamage,
  ...
  case SPELL_AURA_PERIODIC_HEALTH_FUNNEL: {
    ...
    target->CalculateDamageAbsorbAndResist(pCaster, GetSpellSchoolMask(spellProto), DOT, pdamage, &absorb, &resist,
                                           IsReflectableSpell(spellProto), IsResistableSpell(spellProto));
    ...
    pCaster->SendSpellNonMeleeDamageLog(target, GetId(), pdamage, GetSpellSchoolMask(spellProto), absorb, resist, true,
                                        0);

    float multiplier =
        spellProto->EffectMultipleValue[GetEffIndex()] > 0 ? spellProto->EffectMultipleValue[GetEffIndex()] : 1;
    ...
    CleanDamage cleanDamage = CleanDamage(pdamage, BASE_ATTACK, MELEE_HIT_NORMAL);
    int32 new_damage = Unit::DealDamage(pCaster, target, pdamage, &cleanDamage, DOT, GetSpellSchoolMask(spellProto),
                                        spellProto, false);
    Unit::ProcDamageAndSpell(ProcSystemArguments(pCaster, target, procAttacker, procVictim, PROC_EX_NORMAL_HIT, pdamage,
                                                 BASE_ATTACK, spellProto));
    ...
    uint32 heal =
        pCaster->SpellHealingBonusTaken(pCaster, spellProto, int32(new_damage * multiplier), DOT, GetStackAmount());
    ...
    if (m_modifier.m_auraname == SPELL_AURA_PERIODIC_LEECH)
      break;
    pCaster->getHostileRefManager().threatAssist(pCaster, gain * 0.5f * sSpellMgr.GetSpellThreatMultiplier(spellProto),
                                                 spellProto, false, true);
    break;
  }
  ...
  case SPELL_AURA_OBS_MOD_HEALTH: {
    ...
    if (target->IsImmuneToSchool(spellProto,
                                 (1 << GetEffIndex()))) // TODO: Check if we need to check for avoiding immune
    {
      Unit::SendSpellOrDamageImmune(GetCasterGuid(), target, spellProto->Id);
      break;
    }
    ...
    if (pCaster->IsInCombat() && !pCaster->IsCrowdControlled())
      target->getHostileRefManager().threatAssist(
          pCaster, float(gain) * 0.5f * sSpellMgr.GetSpellThreatMultiplier(spellProto), spellProto, false, true);

    Unit::ProcDamageAndSpell(ProcSystemArguments(pCaster, target, procAttacker, procVictim, procEx, gain, BASE_ATTACK,
                                                 spellProto, nullptr, gain, true));
    ...
    if (target != pCaster && spellProto->SpellVisual == 163) {
      ...
      if (pCaster->GetHealth() > damage) {
        pCaster->SendSpellNonMeleeDamageLog(pCaster, GetId(), damage, GetSpellSchoolMask(spellProto), absorb, 0, true,
                                            0, false);
        CleanDamage cleanDamage = CleanDamage(damage, BASE_ATTACK, MELEE_HIT_NORMAL);
        Unit::DealDamage(pCaster, pCaster, damage, &cleanDamage, NODAMAGE, GetSpellSchoolMask(spellProto), spellProto,
                         true);
      } else {
  ...
  case SPELL_AURA_PERIODIC_MANA_LEECH: {
    ...
    if (!spellProto->HasAttribute(
            SPELL_ATTR_UNAFFECTED_BY_INVULNERABILITY)) // confirmed Impaling spine goes through immunity
    {
      if (target->IsImmuneToDamage(GetSpellSchoolMask(spellProto))) {
        Unit::SendSpellOrDamageImmune(GetCasterGuid(), target, spellProto->Id);
        break;
    ...
    drain_amount -= target->GetResilienceRatingDamageReduction(uint32(drain_amount),
                                                               SpellDmgClass(spellProto->DmgClass), false, power);
  ...
  case SPELL_AURA_POWER_BURN_MANA: {
    ...
    pdamage -=
        target->GetResilienceRatingDamageReduction(pdamage, SpellDmgClass(spellProto->DmgClass), false, powerType);
    ...
    Unit::DealDamageMods(pCaster, spellDamageInfo.target, spellDamageInfo.damage, &spellDamageInfo.absorb,
                         SPELL_DIRECT_DAMAGE, spellProto);
    ...
    Unit::ProcDamageAndSpell(ProcSystemArguments(pCaster, spellDamageInfo.target, procAttacker, procVictim, procEx,
                                                 spellDamageInfo.damage, BASE_ATTACK, spellProto));
    break;
  }
  case SPELL_AURA_MOD_REGEN: {
    ...
    if (Unit *caster = GetCaster())
      target->getHostileRefManager().threatAssist(
          caster, float(gain) * 0.5f * sSpellMgr.GetSpellThreatMultiplier(spellProto), spellProto, false, true);
    break;
  }
...
void Aura::PeriodicDummyTick() {
  ...
  case SPELLFAMILY_GENERIC: {
    ...
    case 41170: {
      if (roll_chance_i(5)) {
        ...
        target->CastCustomSpell(nullptr, spell->Id == 6946 ? 6945 : 41356, nullptr, &damageValue, nullptr,
                                TRIGGERED_OLD_TRIGGERED);
      }
      return;
    }
    ...
    case 23487: // Separation Anxiety (Garr)
      if (Unit *caster = GetCaster()) {
        ...
        if (caster->IsAlive() && !caster->IsWithinDistInMap(target, m_radius))
          target->CastSpell(target, (spell->Id == 21094 ? 21095 : 23492), TRIGGERED_OLD_TRIGGERED,
                            nullptr); // Spell 21095: Separation Anxiety for Majordomo Executus' adds, 23492: Separation
                                      // Anxiety for Garr's adds
      }
      return;
  ...
  case SPELLFAMILY_HUNTER: {
    ...
    case 34074: // Dummy implementation for mana restoration
    {
      ...
      target->CastCustomSpell(nullptr, 34075, &restorationValue, nullptr, nullptr,
                              TRIGGERED_OLD_TRIGGERED); // TODO: Send SMSG_SPELL_START
      return;
    }
...
void Aura::HandleAuraSafeFall(bool Apply, bool Real) {
  ...
  if (Apply && Real && GetId() == 32474 && GetTarget()->GetTypeId() == TYPEID_PLAYER &&
    ...
    ((Player *)GetTarget())
        ->ActivateTaxiPathTo(506, GetId()); // on DB load flight path is initiated on its own after its safe to do so
}
...
bool Aura::HasMechanic(uint32 mechanic) const {
  return GetSpellProto()->Mechanic == mechanic || GetSpellProto()->EffectMechanic[m_effIndex] == mechanic;
}

inline bool IsRemovedOnShapeshiftLost(SpellEntry const *spellproto, ObjectGuid const &casterGuid,
  ...
  if (casterGuid == targetGuid) {
    if (spellproto->Stances) {
      ...
      if (!spellproto->HasAttribute(SPELL_ATTR_EX2_NOT_NEED_SHAPESHIFT) &&
          !spellproto->HasAttribute(SPELL_ATTR_NOT_SHAPESHIFT))
        return true;
    } else if (spellproto->SpellFamilyName == SPELLFAMILY_DRUID &&
               spellproto->EffectApplyAuraName[0] == SPELL_AURA_MOD_DODGE_PERCENT)
      return true;
  }
...
SpellAuraHolder::SpellAuraHolder(SpellEntry const *spellproto, Unit *target, WorldObject *caster, Item *castItem,
    ...
    : m_spellProto(spellproto), m_target(target), m_castItemGuid(castItem ? castItem->GetObjectGuid() : ObjectGuid()),
      m_triggeredBy(triggeredBy), m_spellAuraHolderState(SPELLAURAHOLDER_STATE_CREATED), m_auraSlot(MAX_AURAS),
      m_auraLevel(1), m_procCharges(0), m_stackAmount(1), m_timeCla(1000), m_heartbeatResistChance(0),
      m_heartbeatResistInterval(0), m_heartbeatResistTimer(0), m_removeMode(AURA_REMOVE_BY_DEFAULT),
      m_AuraDRGroup(DIMINISHING_NONE), m_permanent(false), m_isRemovedOnShapeLost(true), m_deleted(false),
      m_skipUpdate(false), m_auraScript(SpellScriptMgr::GetAuraScript(spellproto->Id)) {
  MANGOS_ASSERT(target);
  MANGOS_ASSERT(spellproto && spellproto == sSpellTemplate.LookupEntry<SpellEntry>(spellproto->Id) &&
                "`info` must be pointer to sSpellTemplate element");
  ...
  m_trackedAuraType =
      sSpellMgr.IsSingleTargetSpell(spellproto) ? TRACK_AURA_TYPE_SINGLE_TARGET : TRACK_AURA_TYPE_NOT_TRACKED;
...
void SpellAuraHolder::AddAura(Aura *aura, SpellEffectIndex index) { m_auras[index] = aura; }
...
SpellAuraHolder::~SpellAuraHolder() {
  // note: auras in delete list won't be affected since they clear themselves from holder when adding to
  // deletedAuraslist
  for (int32 i = 0; i < MAX_EFFECT_INDEX; ++i)
    delete m_auras[i];
}
    ...
    if (m_timeCla <= 0) {
      if (Unit *caster = GetCaster()) {
        ...
        if (GetSpellProto()->SpellVisual != 163) {
          ...
          int32 manaPerSecond =
              GetSpellProto()->manaPerSecond + GetSpellProto()->manaPerSecondPerLevel * caster->getLevel();
...
bool SpellAuraHolder::IsSaveToDbHolder() const {
  return !IsPassive() && !IsChanneledSpell(GetSpellProto()) && !IsItemAura(GetSpellProto()) &&
         (GetTrackedAuraType() == TRACK_AURA_TYPE_NOT_TRACKED ||
          (GetTrackedAuraType() == TRACK_AURA_TYPE_SINGLE_TARGET && GetCasterGuid() == GetTarget()->GetObjectGuid()));
}
  ...
  if (add) {
    ...
    for (uint32 i = 0; i < MAX_EFFECT_INDEX; ++i) {
      ...
      if ((flags & AFLAG_HARMFUL) && (flags & AFLAG_HELPFUL))
        break;
      flags |= (IsPositiveEffectTargetMode(m_spellProto, SpellEffectIndex(i), caster, m_target) ? AFLAG_HELPFUL
                                                                                                : AFLAG_HARMFUL);
    }
    ...
    flags |= ((IsPositive() && !m_spellProto->HasAttribute(SPELL_ATTR_CANT_CANCEL)) ? AFLAG_CANCELABLE
                                                                                    : AFLAG_NOT_CANCELABLE);
...
void SpellAuraHolder::SetCreationDelayFlag() { m_skipUpdate = true; }
...
void SpellAuraHolder::UpdateAuraDuration() {
  ...
  // not send in case player loading (will not work anyway until player not added to map), sent in visibility change
  // code
...
void SpellAuraHolder::UpdateHeartbeatResist(uint32 diff) {
  ...
  while (m_heartbeatResistTimer < 0) {
    ...
    DEBUG_FILTER_LOG(LOG_FILTER_COMBAT, "UpdateHeartbeatResist: Update tick for spell %u with %i ms interval",
                     m_spellProto->Id, m_heartbeatResistInterval);

    const bool resist = roll_chance_f(m_heartbeatResistChance);

    DEBUG_FILTER_LOG(LOG_FILTER_COMBAT, "UpdateHeartbeatResist: Result: %s (chance %.2f)", (resist ? "RESIST" : "HIT"),
                     double(m_heartbeatResistChance));
...
GameObjectAura::GameObjectAura(SpellEntry const *spellproto, SpellEffectIndex eff, int32 const *currentDamage,
                               int32 const *currentBasePoints, SpellAuraHolder *holder, Unit *target,
                               GameObject * /*caster*/)
