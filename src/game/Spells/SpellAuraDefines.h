...
enum AuraFlags {
  ...
  AFLAG_HELPFUL = 0x01,
  AFLAG_HARMFUL = 0x02,
  AFLAG_PASSIVE_DEPRECATED = 0x04, // Pre-WotLK: debuffs can't be queried using this flag. Unused in UI since 1.10.0,
                                   // new meaning unknown (still the same?)
...
enum AreaAuraType { AREA_AURA_PARTY, AREA_AURA_FRIEND, AREA_AURA_ENEMY, AREA_AURA_PET, AREA_AURA_OWNER };
/** @} */
#endif
