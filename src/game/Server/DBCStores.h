...
enum ContentLevels { CONTENT_1_60 = 0, CONTENT_61_70 };
...
bool IsPointInAreaTriggerZone(AreaTriggerEntry const *atEntry, uint32 mapid, float x, float y, float z,
                              float delta = 0.0f);
...
// extern DBCStorage <WorldMapAreaEntry>           sWorldMapAreaStore; -- use Zone2MapCoordinates and
// Map2ZoneCoordinates extern DBCStorage <WorldMapOverlayEntry>         sWorldMapOverlayStore; -- not used currently
