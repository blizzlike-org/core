...
enum AreaFlags {
  ...
  AREA_FLAG_NEED_FLY =
      0x00001000, // only Netherwing Ledge, Socrethar's Seat, Tempest Keep, The Arcatraz, The Botanica, The Mechanar,
  ...
  AREA_FLAG_OUTLAND2 =
      0x00004000, // outland zones? (only Circle of Blood Arena not have this flag, but have 0x00000400 flag)
...
enum SpawnMask {
  SPAWNMASK_REGULAR =
      (1 << REGULAR_DIFFICULTY), // any any maps without spawn modes (continents/subway) or in minimal spawnmode
...
enum MapTypes { MAP_COMMON = 0, MAP_INSTANCE = 1, MAP_RAID = 2, MAP_BATTLEGROUND = 3, MAP_ARENA = 4 };
...
enum SummonPropFlags {
  ...
  SUMMON_PROP_FLAG_INHERIT_FACTION =
      0x0200,                      // 51 spells in 3.0.3, something defensive (Faction inheriting is much guesswork)
