...
OpcodeHandler opcodeTable[NUM_MSG_TYPES] = {
    ...
    /*0x0A7*/
    {"CMSG_CHANNEL_ANNOUNCEMENTS", STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,
     &WorldSession::HandleChannelAnnouncementsOpcode},
    /*0x0A8*/
    ...
    /*0x0E3*/
    {"CMSG_FORCE_RUN_SPEED_CHANGE_ACK", STATUS_LOGGEDIN, PROCESS_THREADSAFE,
    ...
    /*0x0E5*/
    {"CMSG_FORCE_RUN_BACK_SPEED_CHANGE_ACK", STATUS_LOGGEDIN, PROCESS_THREADSAFE,
     &WorldSession::HandleForceSpeedChangeAckOpcodes},
    /*0x0E6*/ {"SMSG_FORCE_SWIM_SPEED_CHANGE", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x0E7*/
    {"CMSG_FORCE_SWIM_SPEED_CHANGE_ACK", STATUS_LOGGEDIN, PROCESS_THREADSAFE,
     &WorldSession::HandleForceSpeedChangeAckOpcodes},
    ...
    /*0x11C*/
    {"CMSG_CANCEL_TRADE", STATUS_LOGGEDIN_OR_RECENTLY_LOGGEDOUT, PROCESS_THREADUNSAFE,
    ...
    /*0x182*/
    {"CMSG_QUESTGIVER_STATUS_QUERY", STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,
    ...
    /*0x186*/
    {"CMSG_QUESTGIVER_QUERY_QUEST", STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,
     &WorldSession::HandleQuestgiverQueryQuestOpcode},
    /*0x187*/
    {"CMSG_QUESTGIVER_QUEST_AUTOLAUNCH", STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,
    ...
    /*0x189*/
    {"CMSG_QUESTGIVER_ACCEPT_QUEST", STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,
     &WorldSession::HandleQuestgiverAcceptQuestOpcode},
    /*0x18A*/
    {"CMSG_QUESTGIVER_COMPLETE_QUEST", STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,
    ...
    /*0x18C*/
    {"CMSG_QUESTGIVER_REQUEST_REWARD", STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,
    ...
    /*0x18E*/
    {"CMSG_QUESTGIVER_CHOOSE_REWARD", STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,
    ...
    /*0x1AA*/
    {"CMSG_TAXINODE_STATUS_QUERY", STATUS_LOGGEDIN, PROCESS_THREADSAFE, &WorldSession::HandleTaxiNodeStatusQueryOpcode},
    /*0x1AB*/ {"SMSG_TAXINODE_STATUS", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x1AC*/
    {"CMSG_TAXIQUERYAVAILABLENODES", STATUS_LOGGEDIN, PROCESS_THREADSAFE, &WorldSession::HandleTaxiQueryAvailableNodes},
    ...
    /*0x1F2*/
    {"MSG_TABARDVENDOR_ACTIVATE", STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,
    ...
    /*0x20B*/
    {"CMSG_UPDATE_ACCOUNT_DATA", STATUS_LOGGEDIN_OR_RECENTLY_LOGGEDOUT, PROCESS_THREADUNSAFE,
    ...
    /*0x217*/
    {"CMSG_GMTICKET_DELETETICKET", STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,
     &WorldSession::HandleGMTicketDeleteTicketOpcode},
    ...
    /*0x21A*/
    {"CMSG_GMTICKET_SYSTEMSTATUS", STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,
    ...
    /*0x21C*/
    {"CMSG_SPIRIT_HEALER_ACTIVATE", STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,
    ...
    /*0x234*/
    {"CMSG_GUILD_SET_PUBLIC_NOTE", STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,
     &WorldSession::HandleGuildSetPublicNoteOpcode},
    /*0x235*/
    {"CMSG_GUILD_SET_OFFICER_NOTE", STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,
    ...
    /*0x259*/
    {"CMSG_AUCTION_LIST_OWNER_ITEMS", STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,
    ...
    /*0x264*/
    {"CMSG_AUCTION_LIST_BIDDER_ITEMS", STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,
    ...
    /*0x26D*/
    {"CMSG_CANCEL_AUTO_REPEAT_SPELL", STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,
    ...
    /*0x27E*/
    {"CMSG_GROUP_CHANGE_SUB_GROUP", STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,
     &WorldSession::HandleGroupChangeSubGroupOpcode},
    /*0x27F*/
    {"CMSG_REQUEST_PARTY_MEMBER_STATS", STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,
    ...
    /*0x28F*/
    {"CMSG_GROUP_ASSISTANT_LEADER", STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,
    ...
    /*0x2DB*/
    {"CMSG_FORCE_WALK_SPEED_CHANGE_ACK", STATUS_LOGGEDIN, PROCESS_THREADSAFE,
     &WorldSession::HandleForceSpeedChangeAckOpcodes},
    /*0x2DC*/ {"SMSG_FORCE_SWIM_BACK_SPEED_CHANGE", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x2DD*/
    {"CMSG_FORCE_SWIM_BACK_SPEED_CHANGE_ACK", STATUS_LOGGEDIN, PROCESS_THREADSAFE,
     &WorldSession::HandleForceSpeedChangeAckOpcodes},
    /*0x2DE*/ {"SMSG_FORCE_TURN_RATE_CHANGE", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x2DF*/
    {"CMSG_FORCE_TURN_RATE_CHANGE_ACK", STATUS_LOGGEDIN, PROCESS_THREADSAFE,
     &WorldSession::HandleForceSpeedChangeAckOpcodes},
    ...
    /*0x2E2*/
    {"CMSG_AREA_SPIRIT_HEALER_QUERY", STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,
     &WorldSession::HandleAreaSpiritHealerQueryOpcode},
    /*0x2E3*/
    {"CMSG_AREA_SPIRIT_HEALER_QUEUE", STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,
    ...
    /*0x2E9*/
    {"MSG_BATTLEGROUND_PLAYER_POSITIONS", STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,
    ...
    /*0x329*/
    {"MSG_SET_DUNGEON_DIFFICULTY", STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,
    ...
    /*0x34B*/
    {"CMSG_ARENA_TEAM_QUERY", STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleArenaTeamQueryOpcode},
    /*0x34C*/ {"SMSG_ARENA_TEAM_QUERY_RESPONSE", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x34D*/
    {"CMSG_ARENA_TEAM_ROSTER", STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleArenaTeamRosterOpcode},
    ...
    /*0x358*/
    {"CMSG_BATTLEMASTER_JOIN_ARENA", STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleBattlemasterJoinArena},
    ...
    /*0x35D*/
    {"CMSG_LFG_CLEAR_AUTOJOIN", STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleLfgClearAutoJoinOpcode},
    /*0x35E*/ {"CMSG_LFM_SET_AUTOFILL", STATUS_AUTHED, PROCESS_THREADUNSAFE, &WorldSession::HandleLfmSetAutoFillOpcode},
    /*0x35F*/
    {"CMSG_LFM_CLEAR_AUTOFILL", STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleLfmClearAutoFillOpcode},
    ...
    /*0x363*/
    {"CMSG_CLEAR_LOOKING_FOR_GROUP", STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleLfgClearOpcode},
    /*0x364*/
    {"CMSG_CLEAR_LOOKING_FOR_MORE", STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleLfmClearOpcode},
    ...
    /*0x375*/
    {"CMSG_CANCEL_MOUNT_AURA", STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleCancelMountAuraOpcode},
    /*0x376*/ {"SMSG_ARENA_ERROR", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x377*/
    {"MSG_INSPECT_ARENA_TEAMS", STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleInspectArenaTeamsOpcode},
    /*0x378*/ {"SMSG_DEATH_RELEASE_LOC", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x379*/
    {"CMSG_CANCEL_TEMP_ENCHANTMENT", STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,
    ...
    /*0x382*/
    {"CMSG_FORCE_FLIGHT_SPEED_CHANGE_ACK", STATUS_LOGGEDIN, PROCESS_THREADSAFE,
     &WorldSession::HandleForceSpeedChangeAckOpcodes},
    /*0x383*/ {"SMSG_FORCE_FLIGHT_BACK_SPEED_CHANGE", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x384*/
    {"CMSG_FORCE_FLIGHT_BACK_SPEED_CHANGE_ACK", STATUS_LOGGEDIN, PROCESS_THREADSAFE,
     &WorldSession::HandleForceSpeedChangeAckOpcodes},
    ...
    /*0x39B*/
    {"SMSG_CHEAT_DUMP_ITEMS_DEBUG_ONLY_RESPONSE", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x39C*/
    {"SMSG_CHEAT_DUMP_ITEMS_DEBUG_ONLY_RESPONSE_WRITE_FILE", STATUS_NEVER, PROCESS_INPLACE,
    ...
    /*0x3B4*/
    {"CMSG_COMMENTATOR_ENABLE", STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleCommentatorModeOpcode},
    ...
    /*0x3C5*/
    {"MSG_RAID_READY_CHECK_FINISHED", STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,
    ...
    /*0x3D1*/
    {"CMSG_CHANNEL_DISPLAY_LIST", STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,
    ...
    /*0x3D3*/
    {"CMSG_GET_CHANNEL_MEMBER_COUNT", STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,
     &WorldSession::HandleGetChannelMemberCountOpcode},
    /*0x3D4*/ {"SMSG_CHANNEL_MEMBER_COUNT", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x3D5*/
    {"CMSG_CHANNEL_VOICE_ON", STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleChannelVoiceOnOpcode},
    ...
    /*0x3EB*/
    {"CMSG_GUILD_BANK_DEPOSIT_MONEY", STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,
     &WorldSession::HandleGuildBankDepositMoney},
    /*0x3EC*/
    {"CMSG_GUILD_BANK_WITHDRAW_MONEY", STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,
    ...
    /*0x3EE*/
    {"CMSG_SET_CHANNEL_WATCH", STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleSetChannelWatchOpcode},
    ...
    /*0x3FD*/
    {"MSG_GUILD_BANK_MONEY_WITHDRAWN", STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,
     &WorldSession::HandleGuildBankMoneyWithdrawn},
    /*0x3FE*/
    {"MSG_GUILD_EVENT_LOG_QUERY", STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleGuildEventLogQueryOpcode},
    ...
    /*0x405*/
    {"SMSG_IGNORE_DIMINISHING_RETURNS_CHEAT", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    ...
    /*0x416*/
    {"CMSG_QUESTGIVER_STATUS_MULTIPLE_QUERY", STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,
    ...
    /*0x418*/
    {"CMSG_SET_PLAYER_DECLINED_NAMES", STATUS_AUTHED, PROCESS_THREADUNSAFE,
     &WorldSession::HandleSetPlayerDeclinedNamesOpcode},
    /*0x419*/
    {"SMSG_SET_PLAYER_DECLINED_NAMES_RESULT", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
