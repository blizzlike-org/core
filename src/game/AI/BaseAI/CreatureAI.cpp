...
CreatureAI::CreatureAI(Creature *creature)
    : UnitAI(creature), m_creature(creature), m_deathPrevention(false), m_deathPrevented(false) {
...
void CreatureAI::DoCallForHelp(float radius) { m_creature->CallForHelp(radius); }
