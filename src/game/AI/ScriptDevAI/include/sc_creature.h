...
public:
  ...
  SpellEntry const *SelectSpell(Unit *target, int32 school, int32 mechanic, SelectTarget selectTargets,
  ...
  void SetEquipmentSlots(bool loadDefault, int32 mainHand = EQUIP_NO_CHANGE, int32 offHand = EQUIP_NO_CHANGE,
...
struct Scripted_NoMovementAI : public ScriptedAI {
  Scripted_NoMovementAI(Creature *creature) : ScriptedAI(creature) { SetCombatMovement(false); }
