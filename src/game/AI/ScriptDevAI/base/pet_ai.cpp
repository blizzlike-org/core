...
SD%Complete: 50
SDComment: Intended to be used with Guardian/Protector/Minipets. Little/no control over when pet enter/leave combat.
Must be considered to be under development. SDCategory: Npc EndScriptData */
...
void ScriptedPetAI::UpdatePetAI(const uint32 /*diff*/) { DoMeleeAttackIfReady(); }
...
void ScriptedPetAI::CombatStop() { ResetPetCombat(); }
