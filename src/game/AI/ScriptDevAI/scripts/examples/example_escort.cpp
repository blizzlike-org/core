...
struct example_escortAI : public npc_escortAI {
  ...
  void WaypointReached(uint32 uiWP) override {
    ...
    case 3:
      ...
      m_creature->SummonCreature(NPC_FELBOAR, m_creature->GetPositionX() + 5.0f, m_creature->GetPositionY() + 7.0f,
                                 m_creature->GetPositionZ(), 0.0f, TEMPSPAWN_TIMED_OOC_DESPAWN, 3000);
      break;
    case 4:
...
UnitAI *GetAI_example_escort(Creature *pCreature) { return new example_escortAI(pCreature); }
