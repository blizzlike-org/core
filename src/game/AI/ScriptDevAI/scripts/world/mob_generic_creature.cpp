  ...
  void UpdateAI(const uint32 diff) override {
    ...
    if (m_creature->CanReachWithMeleeAttack(m_creature->GetVictim())) {
      ...
      if (info)
        ...
        info = SelectSpell(m_creature->GetVictim(), -1, -1, SELECT_TARGET_ANY_ENEMY, 0, 0, ATTACK_DISTANCE, 0,
...
UnitAI *GetAI_generic_creature(Creature *pCreature) { return new generic_creatureAI(pCreature); }
