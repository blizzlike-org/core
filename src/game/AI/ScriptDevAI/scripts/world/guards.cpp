...
struct guard_hallows_end_helperAI : public guardAI {
  guard_hallows_end_helperAI(Creature *creature) : guardAI(creature) { Reset(); }
...
UnitAI *GetAI_guard_azuremyst(Creature *pCreature) { return new guard_hallows_end_helperAI(pCreature); }

UnitAI *GetAI_guard_bluffwatcher(Creature *pCreature) { return new guardAI(pCreature); }

UnitAI *GetAI_guard_contested(Creature *pCreature) { return new guardAI(pCreature); }

UnitAI *GetAI_guard_darnassus(Creature *pCreature) { return new guardAI(pCreature); }

UnitAI *GetAI_guard_dunmorogh(Creature *pCreature) { return new guard_hallows_end_helperAI(pCreature); }

UnitAI *GetAI_guard_durotar(Creature *pCreature) { return new guard_hallows_end_helperAI(pCreature); }

UnitAI *GetAI_guard_elwynnforest(Creature *pCreature) { return new guard_hallows_end_helperAI(pCreature); }

UnitAI *GetAI_guard_eversong(Creature *pCreature) { return new guard_hallows_end_helperAI(pCreature); }

UnitAI *GetAI_guard_exodar(Creature *pCreature) { return new guardAI(pCreature); }

UnitAI *GetAI_guard_ironforge(Creature *pCreature) { return new guardAI(pCreature); }

UnitAI *GetAI_guard_mulgore(Creature *pCreature) { return new guardAI(pCreature); }

UnitAI *GetAI_guard_orgrimmar(Creature *pCreature) { return new guardAI_orgrimmar(pCreature); }

UnitAI *GetAI_guard_shattrath(Creature *pCreature) { return new guardAI(pCreature); }
...
UnitAI *GetAI_guard_shattrath_aldor(Creature *pCreature) { return new guard_shattrath_aldorAI(pCreature); }
...
UnitAI *GetAI_guard_shattrath_scryer(Creature *pCreature) { return new guard_shattrath_scryerAI(pCreature); }

UnitAI *GetAI_guard_silvermoon(Creature *pCreature) { return new guardAI(pCreature); }
...
struct guardAI_stormwind : public guardAI {
  guardAI_stormwind(Creature *creature) : guardAI(creature) { Reset(); }

  uint32 m_saluteWaitTimer;

  void Reset() override { m_saluteWaitTimer = 0; }
...
UnitAI *GetAI_guard_stormwind(Creature *pCreature) { return new guardAI_stormwind(pCreature); }

UnitAI *GetAI_guard_teldrassil(Creature *pCreature) { return new guardAI(pCreature); }

UnitAI *GetAI_guard_tirisfal(Creature *pCreature) { return new guardAI(pCreature); }

UnitAI *GetAI_guard_undercity(Creature *pCreature) { return new guardAI(pCreature); }
