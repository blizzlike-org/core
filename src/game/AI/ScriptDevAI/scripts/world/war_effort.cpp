...
bool QuestRewarded_war_effort(Player * /*player*/, Creature * /*creature*/, Quest const *quest) {
  ...
  case QUEST_HORDE_COPPER_BARS_2:
    resource = AQ_COPPER_BAR_HORDE;
    break;
  case QUEST_ALLIANCE_COPPER_BARS_1:
  case QUEST_ALLIANCE_COPPER_BARS_2:
    resource = AQ_COPPER_BAR_ALLY;
    break;
  case QUEST_ALLIANCE_PURPLE_LOTUS_1:
  case QUEST_ALLIANCE_PURPLE_LOTUS_2:
    resource = AQ_PURPLE_LOTUS_ALLY;
    break;
  case QUEST_ALLIANCE_SPOTTED_YELLOWTAIL_1:
  case QUEST_ALLIANCE_SPOTTED_YELLOWTAIL_2:
    resource = AQ_SPOTTED_YELLOWTAIL_ALLY;
    break;
  case QUEST_HORDE_SPOTTED_YELLOWTAIL_1:
  case QUEST_HORDE_SPOTTED_YELLOWTAIL_2:
    resource = AQ_SPOTTED_YELLOWTAIL_HORDE;
    break;
  case QUEST_ALLIANCE_THICK_LEATHER_1:
  case QUEST_ALLIANCE_THICK_LEATHER_2:
    resource = AQ_THICK_LEATHER_ALLY;
    break;
  case QUEST_HORDE_THICK_LEATHER_1:
  case QUEST_HORDE_THICK_LEATHER_2:
    resource = AQ_THICK_LEATHER_HORDE;
    break;
  case QUEST_ALLIANCE_RUNECLOTH_BANDAGES_1:
  case QUEST_ALLIANCE_RUNECLOTH_BANDAGES_2:
    resource = AQ_RUNECLOTH_BANDAGE_ALLY;
    break;
  case QUEST_HORDE_RUNECLOTH_BANDAGES_1:
  case QUEST_HORDE_RUNECLOTH_BANDAGES_2:
    resource = AQ_RUNECLOTH_BANDAGE_HORDE;
    break;
  case QUEST_HORDE_PURPLE_LOTUS_1:
  case QUEST_HORDE_PURPLE_LOTUS_2:
    resource = AQ_PURPLE_LOTUS_HORDE;
    break;
  // horde
  case QUEST_HORDE_PEACEBLOOM_1:
  case QUEST_HORDE_PEACEBLOOM_2:
    resource = AQ_PEACEBLOOM;
    break;
  case QUEST_HORDE_WOOL_BANDAGES_1:
  case QUEST_HORDE_WOOL_BANDAGES_2:
    resource = AQ_WOOL_BANDAGE;
    break;
  case QUEST_HORDE_LEAN_WOLF_STEAKS_1:
  case QUEST_HORDE_LEAN_WOLF_STEAKS_2:
    resource = AQ_LEAN_WOLF_STEAK;
    break;
  case QUEST_HORDE_TIN_BARS_1:
  case QUEST_HORDE_TIN_BARS_2:
    resource = AQ_TIN_BAR;
    break;
  case QUEST_HORDE_FIREBLOOM_1:
  case QUEST_HORDE_FIREBLOOM_2:
    resource = AQ_FIREBLOOM;
    break;
  case QUEST_HORDE_HEAVY_LEATHER_1:
  case QUEST_HORDE_HEAVY_LEATHER_2:
    resource = AQ_HEAVY_LEATHER;
    break;
  case QUEST_HORDE_MITHRIL_BARS_1:
  case QUEST_HORDE_MITHRIL_BARS_2:
    resource = AQ_MITHRIL_BAR;
    break;
  case QUEST_HORDE_BAKED_SALMON_1:
  case QUEST_HORDE_BAKED_SALMON_2:
    resource = AQ_BAKED_SALMON;
    break;
  case QUEST_HORDE_RUGGED_LEATHER_1:
  case QUEST_HORDE_RUGGED_LEATHER_2:
    resource = AQ_RUGGED_LEATHER;
    break;
  case QUEST_HORDE_MAGEWEAVE_BANDAGE_1:
  case QUEST_HORDE_MAGEWEAVE_BANDAGE_2:
    resource = AQ_MAGEWEAVE_BANDAGE;
    break;
  // alliance
  case QUEST_ALLIANCE_LINEN_BANDAGE_1:
  case QUEST_ALLIANCE_LINEN_BANDAGE_2:
    resource = AQ_LINEN_BANDAGE;
    break;
  case QUEST_ALLIANCE_RAINBOW_FIN_ALBACORE_1:
  case QUEST_ALLIANCE_RAINBOW_FIN_ALBACORE_2:
    resource = AQ_RAINBOW_FIN_ALBACORE;
    break;
  case QUEST_ALLIANCE_LIGHT_LEATHER_1:
  case QUEST_ALLIANCE_LIGHT_LEATHER_2:
    resource = AQ_LIGHT_LEATHER;
    break;
  case QUEST_ALLIANCE_STRANGLEKELP_1:
  case QUEST_ALLIANCE_STRANGLEKELP_2:
    resource = AQ_STRANGLEKELP;
    break;
  case QUEST_ALLIANCE_MEDIUM_LEATHER_1:
  case QUEST_ALLIANCE_MEDIUM_LEATHER_2:
    resource = AQ_MEDIUM_LEATHER;
    break;
  case QUEST_ALLIANCE_SILK_BANDAGES_1:
  case QUEST_ALLIANCE_SILK_BANDAGES_2:
    resource = AQ_SILK_BANDAGE;
    break;
  case QUEST_ALLIANCE_IRON_BARS_1:
  case QUEST_ALLIANCE_IRON_BARS_2:
    resource = AQ_IRON_BAR;
    break;
  case QUEST_ALLIANCE_ROAST_RAPTOR_1:
  case QUEST_ALLIANCE_ROAST_RAPTOR_2:
    resource = AQ_ROAST_RAPTOR;
    break;
  case QUEST_ALLIANCE_ARTHAS_TEARS_1:
  case QUEST_ALLIANCE_ARTHAS_TEARS_2:
    resource = AQ_ARTHAS_TEARS;
    break;
  case QUEST_ALLIANCE_THORIUM_BARS_1:
  case QUEST_ALLIANCE_THORIUM_BARS_2:
    resource = AQ_THORIUM_BAR;
    break;
  default:
    return false;
  }
