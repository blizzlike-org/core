...
UnitAI *GetAI_boss_nethermancer_sepethrea(Creature *pCreature) { return new boss_nethermancer_sepethreaAI(pCreature); }
...
struct npc_raging_flamesAI : public ScriptedAI {
  ...
  void Aggro(Unit * /*pWho*/) override { FixateRandomTarget(); }
...
UnitAI *GetAI_npc_raging_flames(Creature *pCreature) { return new npc_raging_flamesAI(pCreature); }
