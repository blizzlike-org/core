...
// static const uint32 saplingsSummonSpells[10] = {34727, 34730, 34731, 34732, 34733, 34734, 34735, 34736, 34737,
// 34739};
static const uint32 saplingsSummonSpells[6] = {34727, 34731, 34733,
                                               34734, 34736, 34739}; // actually ones used on retail
...
UnitAI *GetAI_boss_warp_splinter(Creature *pCreature) { return new boss_warp_splinterAI(pCreature); }

UnitAI *GetAI_npc_sapling(Creature *pCreature) { return new npc_saplingAI(pCreature); }
