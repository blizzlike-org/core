...
static const uint32 aPeriodicBeams[] = {SPELL_SINFUL_PERIODIC, SPELL_SINISTER_PERIODIC, SPELL_VILE_PERIODIC,
...
struct boss_shahrazAI : public CombatAI {
  boss_shahrazAI(Creature *creature)
      : CombatAI(creature, SHAHRAZ_ACTION_MAX),
  ...
  void ExecuteAction(uint32 action) override {
    ...
    case SHAHRAZ_ACTION_BEAM: {
      ...
      if (DoCastSpellIfCan(nullptr, aPeriodicBeams[m_currentBeam]) == CAST_OK) {
        switch (urand(0, 2)) {
        case 0:
          DoScriptText(SAY_BEAM_1, m_creature);
          break;
        case 1:
          DoScriptText(SAY_BEAM_2, m_creature);
          break;
        case 2:
          DoScriptText(SAY_BEAM_3, m_creature);
          break;
        }
    ...
    case SHAHRAZ_ACTION_FATAL_ATTRACTION: {
      ...
      if (DoCastSpellIfCan(nullptr, SPELL_FATAL_ATTRACTION) == CAST_OK) {
        switch (urand(0, 2)) {
        case 0:
          DoScriptText(SAY_ATTRACTION_1, m_creature);
          break;
        case 1:
          DoScriptText(SAY_ATTRACTION_3, m_creature);
          break;
        case 2:
          DoScriptText(SAY_ATTRACTION_3, m_creature);
          break;
...
UnitAI *GetAI_boss_shahraz(Creature *creature) { return new boss_shahrazAI(creature); }
