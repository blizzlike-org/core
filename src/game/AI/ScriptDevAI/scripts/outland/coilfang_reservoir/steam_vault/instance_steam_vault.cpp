...
instance_steam_vault::instance_steam_vault(Map *pMap) : ScriptedInstance(pMap) { Initialize(); }

void instance_steam_vault::Initialize() { memset(&m_auiEncounter, 0, sizeof(m_auiEncounter)); }
...
InstanceData *GetInstanceData_instance_steam_vault(Map *pMap) { return new instance_steam_vault(pMap); }
