...
struct mob_steamrigger_mechanicAI : public ScriptedAI {
  ...
  void Reset() override { m_bCanStartAttack = false; }
  ...
  void MoveInLineOfSight(Unit *pWho) override {
    ...
    if (pWho->GetEntry() == NPC_STEAMRIGGER) {
      if (m_pInstance->GetData(TYPE_MEKGINEER_STEAMRIGGER) == IN_PROGRESS) {
        ...
        // This will also stop creature movement and will allow them to continue to follow the boss after channeling is
        // finished or the boss is out of range
