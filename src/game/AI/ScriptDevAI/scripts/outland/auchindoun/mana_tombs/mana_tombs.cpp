...
struct npc_shaheenAI : public npc_escortAI, private DialogueHelper {
  npc_shaheenAI(Creature *pCreature) : npc_escortAI(pCreature), DialogueHelper(aIntroDialogue) {
  ...
  void WaypointReached(uint32 uiPointId) override {
    ...
    case 8:
      ...
      // summon first wave
      m_creature->SummonCreature(NPC_ETHEREAL_THEURGIST, -375.86f, -129.16f, -0.95f, 4.82f,
                                 TEMPSPAWN_TIMED_OOC_OR_DEAD_DESPAWN, 60000);
      m_creature->SummonCreature(NPC_ETHEREAL_THEURGIST, -370.67f, -199.79f, -0.95f, 1.52f,
                                 TEMPSPAWN_TIMED_OOC_OR_DEAD_DESPAWN, 60000);
      m_creature->SummonCreature(NPC_ETHEREAL_SPELLBINDER, -371.12f, -129.07f, -0.95f, 4.82f,
                                 TEMPSPAWN_TIMED_OOC_OR_DEAD_DESPAWN, 60000);
      m_creature->SummonCreature(NPC_ETHEREAL_SPELLBINDER, -375.18f, -199.58f, -0.95f, 1.52f,
                                 TEMPSPAWN_TIMED_OOC_OR_DEAD_DESPAWN, 60000);
      break;
    case 9:
    ...
    case 18:
      ...
      // summon second wave
      m_creature->SummonCreature(NPC_ETHEREAL_SORCERER, -278.17f, -195.50f, 0.68f, 1.22f,
                                 TEMPSPAWN_TIMED_OOC_OR_DEAD_DESPAWN, 60000);
      m_creature->SummonCreature(NPC_ETHEREAL_SORCERER, -234.51f, -197.03f, -0.95f, 1.92f,
                                 TEMPSPAWN_TIMED_OOC_OR_DEAD_DESPAWN, 60000);
      m_creature->SummonCreature(NPC_ETHEREAL_CRYPT_RAIDER, -282.28f, -194.44f, 0.44f, 1.22f,
                                 TEMPSPAWN_TIMED_OOC_OR_DEAD_DESPAWN, 60000);
      m_creature->SummonCreature(NPC_ETHEREAL_CRYPT_RAIDER, -231.15f, -194.53f, -0.95f, 1.52f,
                                 TEMPSPAWN_TIMED_OOC_OR_DEAD_DESPAWN, 60000);
      break;
    case 25:
      // summon third wave
      m_creature->SummonCreature(NPC_NEXUS_TERROR, -37.30f, -222.44f, -0.33f, 3.01f,
                                 TEMPSPAWN_TIMED_OOC_OR_DEAD_DESPAWN, 240000);
      m_creature->SummonCreature(NPC_NEXUS_TERROR, -15.76f, -225.36f, 0.79f, 2.93f, TEMPSPAWN_TIMED_OOC_OR_DEAD_DESPAWN,
                                 240000);
      break;
    case 27:
      if (m_uiSummonCount)
    ...
    case 41:
      SetEscortPaused(true);
      m_creature->SummonCreature(NPC_SHADOW_LORD_XIRAXIS, -47.10f, -0.49f, -0.95f, 3.45f,
                                 TEMPSPAWN_TIMED_OOC_OR_DEAD_DESPAWN, 60000);
      break;
    case 42:
  ...
  Creature *GetSpeakerByEntry(uint32 uiEntry) override {
    switch (uiEntry) {
    case NPC_ENGINEER_SHAEEN:
      return m_creature;
    case NPC_SHADOW_LORD_XIRAXIS:
      return m_creature->GetMap()->GetCreature(m_xiraxisGuid);
    default:
      return nullptr;
    }
  }
...
UnitAI *GetAI_npc_shaheen(Creature *pCreature) { return new npc_shaheenAI(pCreature); }
