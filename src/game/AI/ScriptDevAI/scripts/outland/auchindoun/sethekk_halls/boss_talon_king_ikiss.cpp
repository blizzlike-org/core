...
struct boss_talon_king_ikissAI : public ScriptedAI, public CombatActions {
  ...
  void KilledUnit(Unit * /*pVctim*/) override { DoScriptText(urand(0, 1) ? SAY_SLAY_1 : SAY_SLAY_2, m_creature); }
  ...
  void UpdateAI(const uint32 diff) override {
    ...
    if (m_creature->GetHealthPercent() < m_HealthPercent) {
      if (DoCastSpellIfCan(m_creature, SPELL_BLINK, CAST_INTERRUPT_PREVIOUS) == CAST_OK) {
        ...
        case 0:
          m_HealthPercent = 50.0f;
          break;
        case 1:
          m_HealthPercent = 25.0f;
          break;
        case 2:
...
UnitAI *GetAI_boss_talon_king_ikiss(Creature *pCreature) { return new boss_talon_king_ikissAI(pCreature); }
