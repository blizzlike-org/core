...
struct boss_darkweaver_sythAI : public ScriptedAI {
  ...
  void JustReachedHome() override { m_creature->RemoveGuardians(); }
...
UnitAI *GetAI_boss_darkweaver_syth(Creature *pCreature) { return new boss_darkweaver_sythAI(pCreature); }
