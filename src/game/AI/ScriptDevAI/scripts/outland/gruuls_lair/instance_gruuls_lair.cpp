...
void instance_gruuls_lair::Initialize() { memset(&m_auiEncounter, 0, sizeof(m_auiEncounter)); }
...
InstanceData *GetInstanceData_instance_gruuls_lair(Map *pMap) { return new instance_gruuls_lair(pMap); }
