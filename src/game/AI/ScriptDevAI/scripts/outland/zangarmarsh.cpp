...
UnitAI *GetAI_npc_cooshcoosh(Creature *pCreature) { return new npc_cooshcooshAI(pCreature); }
...
struct npc_kayra_longmaneAI : public npc_escortAI {
  ...
  void JustRespawned() override { m_creature->SetStandState(UNIT_STAND_STATE_KNEEL); }
  ...
  void WaypointReached(uint32 i) override {
    ...
    case 5:
      ...
      m_creature->SummonCreature(NPC_SLAVEBINDER, -916.4861f, 5355.635f, 18.25233f, 5.0f,
                                 TEMPSPAWN_TIMED_OOC_OR_DEAD_DESPAWN, 30000);
      m_creature->SummonCreature(NPC_SLAVEBINDER, -918.9288f, 5358.43f, 18.05894f, 5.0f,
                                 TEMPSPAWN_TIMED_OOC_OR_DEAD_DESPAWN, 30000);
      break;
    case 6:
    ...
    case 17:
      ...
      break;
    case 18: {
      Creature *spawn = m_creature->SummonCreature(NPC_SLAVEBINDER, -668.2899f, 5382.913f, 22.32479f, 5.0f,
                                                   TEMPSPAWN_TIMED_OOC_OR_DEAD_DESPAWN, 30000);
      DoScriptText(SAY_SLAVEBINDER_AMBUSH2, spawn, pPlayer);
      m_creature->SummonCreature(NPC_SLAVEBINDER, -669.2795f, 5386.802f, 23.01249f, 5.0f,
                                 TEMPSPAWN_TIMED_OOC_OR_DEAD_DESPAWN, 30000);
      break;
    }
    case 19:
...
UnitAI *GetAI_npc_kayra_longmane(Creature *pCreature) { return new npc_kayra_longmaneAI(pCreature); }
...
struct npc_fhwoorAI : public npc_escortAI {
  ...
  void WaypointReached(uint32 uiPointId) override {
    ...
    case 47:
      ...
      // spawn npcs
      m_creature->SummonCreature(NPC_ENCHANTRESS, 526.12f, 8136.96f, 21.64f, 0.57f, TEMPSPAWN_TIMED_OOC_OR_DEAD_DESPAWN,
                                 60000);
      m_creature->SummonCreature(NPC_SLAVEDRIVER, 524.09f, 8138.67f, 21.49f, 0.58f, TEMPSPAWN_TIMED_OOC_OR_DEAD_DESPAWN,
                                 60000);
      m_creature->SummonCreature(NPC_SLAVEDRIVER, 526.93f, 8133.88f, 21.56f, 0.58f, TEMPSPAWN_TIMED_OOC_OR_DEAD_DESPAWN,
                                 60000);
      break;
    case 71:
      ...
      // spawn npcs
      m_bIsAmbush = true;
      m_creature->SummonCreature(NPC_SSSLITH, 162.91f, 8192.08f, 22.55f, 5.98f, TEMPSPAWN_TIMED_OOC_OR_DEAD_DESPAWN,
                                 60000);
      m_creature->SummonCreature(NPC_ENCHANTRESS, 162.34f, 8193.99f, 22.85f, 5.98f, TEMPSPAWN_TIMED_OOC_OR_DEAD_DESPAWN,
                                 60000);
      m_creature->SummonCreature(NPC_SLAVEDRIVER, 163.07f, 8187.04f, 22.71f, 0.10f, TEMPSPAWN_TIMED_OOC_OR_DEAD_DESPAWN,
                                 60000);
...
UnitAI *GetAI_npc_fhwoor(Creature *pCreature) { return new npc_fhwoorAI(pCreature); }
...
struct npc_frostbiteAI : public ScriptedAI {
  ...
  void Reset() override { m_creature->CastSpell(m_creature, SPELL_FROSTBITE_ROTATE, TRIGGERED_NONE); }
...
UnitAI *GetAI_npc_frostbite(Creature *creature) { return new npc_frostbiteAI(creature); }
