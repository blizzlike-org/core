...
struct boss_warchief_kargath_bladefistAI : public ScriptedAI {
  ...
  void SpawnAssassin() {
    m_creature->SummonCreature(NPC_SHATTERED_ASSASSIN, AssassEntrance[0], AssassEntrance[1] + 8, AssassEntrance[2], 0,
  ...
  void UpdateAI(const uint32 uiDiff) override {
    ...
    } else // !m_bInBlade
    {
      ...
      if (m_uiSummonAssistantTimer < uiDiff) {
        switch (m_uiSummoned) {
        case 0:
          m_creature->SummonCreature(NPC_HEARTHEN_GUARD, AddsEntrance[0], AddsEntrance[1], AddsEntrance[2], 0.0f,
                                     TEMPSPAWN_TIMED_OOC_DESPAWN, 20000);
          break;
        case 1:
          m_creature->SummonCreature(NPC_REAVER_GUARD, AddsEntrance[0], AddsEntrance[1], AddsEntrance[2], 0.0f,
                                     TEMPSPAWN_TIMED_OOC_DESPAWN, 20000);
          break;
        case 2:
          m_creature->SummonCreature(NPC_SHARPSHOOTER_GUARD, AddsEntrance[0], AddsEntrance[1], AddsEntrance[2], 0.0f,
                                     TEMPSPAWN_TIMED_OOC_DESPAWN, 20000);
          break;
        }
...
UnitAI *GetAI_npc_blade_dance_target(Creature *pCreature) { return new npc_blade_dance_targetAI(pCreature); }
