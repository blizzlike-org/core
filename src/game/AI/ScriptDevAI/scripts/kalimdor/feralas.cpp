...
struct npc_oox22feAI : public npc_escortAI {
  ...
  void WaypointReached(uint32 i) override {
    ...
    case 31:
      DoScriptText(SAY_OOX_AMBUSH, m_creature);
      m_creature->SummonCreature(NPC_WOODPAW_REAVER, -4425.14f, 2075.87f, 47.77f, 3.77f, TEMPSPAWN_CORPSE_TIMED_DESPAWN,
                                 10000);
      m_creature->SummonCreature(NPC_WOODPAW_BRUTE, -4426.68f, 2077.98f, 47.57f, 3.77f, TEMPSPAWN_CORPSE_TIMED_DESPAWN,
                                 10000);
      m_creature->SummonCreature(NPC_WOODPAW_MYSTIC, -4428.33f, 2080.24f, 47.43f, 3.87f, TEMPSPAWN_CORPSE_TIMED_DESPAWN,
                                 10000);
      m_creature->SummonCreature(NPC_WOODPAW_ALPHA, -4430.04f, 2075.54f, 46.83f, 3.81f, TEMPSPAWN_CORPSE_TIMED_DESPAWN,
                                 10000);
      break;
    case 38:
...
UnitAI *GetAI_npc_oox22fe(Creature *pCreature) { return new npc_oox22feAI(pCreature); }
...
UnitAI *GetAI_npc_shay_leafrunner(Creature *pCreature) { return new npc_shay_leafrunnerAI(pCreature); }
...
struct npc_captured_sprite_darterAI : public npc_escortAI {
  ...
  void UpdateEscortAI(const uint32 diff) override {
    ...
    if (m_manaBurnTimer < diff) {
      if (Unit *target =
              m_creature->SelectAttackingTarget(ATTACKING_TARGET_RANDOM, 0, SPELL_MANA_BURN, SELECT_FLAG_POWER_MANA)) {
...
UnitAI *GetAI_npc_captured_sprite_darter(Creature *pCreature) { return new npc_captured_sprite_darterAI(pCreature); }
...
UnitAI *GetAI_npc_kindal_moonweaver(Creature *pCreature) { return new npc_kindal_moonweaverAI(pCreature); }
