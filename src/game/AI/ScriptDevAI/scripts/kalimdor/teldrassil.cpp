...
enum { SAY_AT_HOME = -1000323, EMOTE_AT_HOME = -1000324, QUEST_MIST = 938, NPC_ARYNIA = 3519, FACTION_DARNASSUS = 79 };
...
UnitAI *GetAI_npc_mist(Creature *pCreature) { return new npc_mistAI(pCreature); }
