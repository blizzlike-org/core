...
static const DialogueEntry aIntroDialogue[] = {{EMOTE_EYE_INTRO, NPC_MASTERS_EYE, 2000},
...
instance_temple_of_ahnqiraj::instance_temple_of_ahnqiraj(Map *pMap)
    : ScriptedInstance(pMap), DialogueHelper(aIntroDialogue), m_uiBugTrioDeathCount(0), m_uiCthunWhisperTimer(90000),
...
bool ProcessEventId_event_reset_cthun(uint32 /*eventId*/, Object *source, Object * /*target*/, bool /*isStart*/) {
  if (source->GetTypeId() == TYPEID_UNIT) {
    if (instance_temple_of_ahnqiraj *instance =
            (instance_temple_of_ahnqiraj *)((Creature *)source)->GetInstanceData()) {
