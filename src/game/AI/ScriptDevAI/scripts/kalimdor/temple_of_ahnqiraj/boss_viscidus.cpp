...
static const uint32 auiGlobSummonSpells[MAX_VISCIDUS_GLOBS] = {25865, 25866, 25867, 25868, 25869, 25870, 25871,
                                                               25872, 25873, 25874, 25875, 25876, 25877, 25878,
                                                               25879, 25880, 25881, 25882, 25883, 25884};
...
struct boss_viscidusAI : public CombatAI {
  boss_viscidusAI(Creature *creature)
      : CombatAI(creature, VISCIDUS_ACTION_MAX),
  ...
  void SetPhase(uint8 phase) {
    ...
    case PHASE_EXPLODED: {
      ...
      else if (DoCastSpellIfCan(m_creature, SPELL_VISCIDUS_EXPLODE, CAST_TRIGGERED | CAST_INTERRUPT_PREVIOUS) ==
               CAST_OK) {
