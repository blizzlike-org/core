...
static const uint32 aSpawnHatchlingsSpells[3] = {SPELL_SPAWN_VEKNISS_HATCHLING_1, SPELL_SPAWN_VEKNISS_HATCHLING_2,
                                                 SPELL_SPAWN_VEKNISS_HATCHLING_3};
...
struct boss_fankrissAI : public CombatAI {
  boss_fankrissAI(Creature *creature)
      : CombatAI(creature, FANKRISS_ACTION_MAX),
  ...
  void SummonedCreatureJustDied(Creature *summoned) override { summoned->ForcedDespawn(2000); }
  ...
  void OnEffectExecute(Spell *spell, SpellEffectIndex effIdx) const override {
    if (effIdx == EFFECT_INDEX_0) {
      ...
      case SPELL_ENTANGLE_1:
        spellId = SPELL_SPAWN_VEKNISS_HATCHLING_1;
        break;
      case SPELL_ENTANGLE_2:
        spellId = SPELL_SPAWN_VEKNISS_HATCHLING_2;
        break;
      case SPELL_ENTANGLE_3:
        spellId = SPELL_SPAWN_VEKNISS_HATCHLING_3;
        break;
      }
