...
struct npc_lazy_peonAI : public ScriptedAI {
  ...
  void RestartWakeTimer() {
    m_uiWakeTimer =
        urand(100000, 120000); // Random wakeup timer 1m40s to 2m, retail times unknown, 2m is duration of sleep aura
...
UnitAI *GetAI_npc_lazy_peon(Creature *pCreature) { return new npc_lazy_peonAI(pCreature); }

bool EffectDummyCreature_lazy_peon_spell(Unit *pCaster, uint32 uiSpellId, SpellEffectIndex uiEffIndex,
