...
struct npc_kittenAI : public FollowerAI {
  ...
  void MoveInLineOfSight(Unit *pWho) override {
    ...
    if (!m_creature->GetVictim() && !m_creature->HasFlag(UNIT_NPC_FLAGS, UNIT_NPC_FLAG_GOSSIP) &&
        HasFollowState(STATE_FOLLOW_INPROGRESS) && pWho->GetEntry() == NPC_WINNA) {
...
UnitAI *GetAI_npc_kitten(Creature *pCreature) { return new npc_kittenAI(pCreature); }

bool EffectDummyCreature_npc_kitten(Unit * /*pCaster*/, uint32 uiSpellId, SpellEffectIndex uiEffIndex,
...
UnitAI *GetAI_npc_niby_the_almighty(Creature *pCreature) { return new npc_niby_the_almightyAI(pCreature); }
    ...
    if (m_uiPhase < 4) {
      if (m_uiPhaseTimer < uiDiff) {
        ...
        case 2:
          ...
          break;
        case 3: // Attack
          m_creature->SetFactionTemporary(FACTION_HOSTILE,
                                          TEMPFACTION_RESTORE_COMBAT_STOP | TEMPFACTION_RESTORE_RESPAWN |
                                              TEMPFACTION_TOGGLE_IMMUNE_TO_PLAYER | TEMPFACTION_TOGGLE_IMMUNE_TO_NPC);
...
UnitAI *GetAI_npc_kroshius(Creature *pCreature) { return new npc_kroshiusAI(pCreature); }
...
struct npc_captured_arkonarinAI : public npc_escortAI {
  ...
  void ReceiveAIEvent(AIEventType eventType, Unit * /*pSender*/, Unit *pInvoker, uint32 uiMiscValue) override {
    if (eventType == AI_EVENT_START_ESCORT && pInvoker->GetTypeId() == TYPEID_PLAYER) {
      m_creature->SetStandState(UNIT_STAND_STATE_STAND);
      m_creature->SetFactionTemporary(FACTION_ESCORT_N_NEUTRAL_PASSIVE,
  ...
  void WaypointReached(uint32 uiPointId) override {
    ...
    case 42:
      ...
      m_creature->SummonCreature(NPC_JAEDENAR_LEGIONNAIRE, 5082.068f, -490.084f, 296.856f, 5.15f,
                                 TEMPSPAWN_TIMED_OOC_OR_DEAD_DESPAWN, 60000);
      m_creature->SummonCreature(NPC_JAEDENAR_LEGIONNAIRE, 5084.135f, -489.187f, 296.832f, 5.15f,
                                 TEMPSPAWN_TIMED_OOC_OR_DEAD_DESPAWN, 60000);
      m_creature->SummonCreature(NPC_JAEDENAR_LEGIONNAIRE, 5085.676f, -488.518f, 296.824f, 5.15f,
                                 TEMPSPAWN_TIMED_OOC_OR_DEAD_DESPAWN, 60000);
      break;
    case 44:
      SetRun(false);
    ...
    case 105:
      ...
      break;
    case 106:
      m_creature->SummonCreature(NPC_SPIRT_TREY, 4844.839f, -395.763f, 350.603f, 6.25f,
                                 TEMPSPAWN_TIMED_OOC_OR_DEAD_DESPAWN, 60000);
      break;
    case 107:
...
UnitAI *GetAI_npc_captured_arkonarin(Creature *pCreature) { return new npc_captured_arkonarinAI(pCreature); }
...
static const DialogueEntry aEpilogDialogue[] = {
    {SAY_CLEAR_PATH, NPC_AREI, 4000}, {SPELL_WITHER_STRIKE, 0, 5000},  {SAY_TRANSFORM, NPC_AREI, 3000},
    {SPELL_AREI_TRANSFORM, 0, 7000},  {QUEST_ID_ANCIENT_SPIRIT, 0, 0}, {0, 0, 0},
};

struct npc_areiAI : public npc_escortAI, private DialogueHelper {
  npc_areiAI(Creature *pCreature) : npc_escortAI(pCreature), DialogueHelper(aEpilogDialogue) {
  ...
  void Reset() override { m_uiWitherStrikeTimer = urand(1000, 4000); }
  ...
  void WaypointReached(uint32 uiPointId) override {
    if (uiPointId == 37) {
      ...
      m_creature->SummonCreature(NPC_IRONTREE_STOMPER, 6573.321f, -1195.213f, 442.489f, 0,
                                 TEMPSPAWN_TIMED_OOC_OR_DEAD_DESPAWN, 60000);
      m_creature->SummonCreature(NPC_IRONTREE_WANDERER, 6573.240f, -1213.475f, 443.643f, 0,
                                 TEMPSPAWN_TIMED_OOC_OR_DEAD_DESPAWN, 60000);
      m_creature->SummonCreature(NPC_IRONTREE_WANDERER, 6583.354f, -1209.811f, 444.769f, 0,
                                 TEMPSPAWN_TIMED_OOC_OR_DEAD_DESPAWN, 60000);
    }
  }
...
UnitAI *GetAI_npc_arei(Creature *pCreature) { return new npc_areiAI(pCreature); }
