...
enum { QUEST_SHATTERED_SALUTE = 2460 };
...
struct npc_shenthulAI : public ScriptedAI {
  ...
  void ReceiveEmote(Player *pPlayer, uint32 uiTextEmote) override {
    if (m_uiResetTimer && uiTextEmote == TEXTEMOTE_SALUTE &&
...
UnitAI *GetAI_npc_shenthul(Creature *pCreature) { return new npc_shenthulAI(pCreature); }
