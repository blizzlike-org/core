...
static const Locations aSpawnLocations[6] =  // Should be near the correct positions
    {{-768.949f, -174.413f, -25.87f, 3.09f}, // Left side
     {-768.888f, -164.238f, -25.87f, 3.09f}, {-768.951f, -153.911f, -25.88f, 3.09f},
...
static const SummonInformation aWaveSummonInformation[] = {
    {0, NPC_AKUMAI_SNAPJAW, {{1, 0}, {1, 1}, {1, 5}}},        {1, NPC_AKUMAI_SERVANT, {{1, 1}, {1, 4}, {0, 0}}},
    {2, NPC_BARBED_CRUSTACEAN, {{1, 0}, {1, 2}, {0, 0}}},     {2, NPC_BARBED_CRUSTACEAN, {{1, 3}, {1, 4}, {0, 0}}},
    {3, NPC_MURKSHALLOW_SOFTSHELL, {{2, 0}, {1, 1}, {2, 2}}}, {3, NPC_MURKSHALLOW_SOFTSHELL, {{1, 3}, {2, 4}, {2, 5}}}};
