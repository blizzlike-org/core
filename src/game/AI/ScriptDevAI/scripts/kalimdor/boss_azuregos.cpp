...
enum {
  ...
  SPELL_MARK_OF_FROST_AURA =
      23184, // Triggers 23186 on players that have 23182; unfortunatelly 23183 is missing from dbc
...
struct boss_azuregosAI : public ScriptedAI {
  ...
  void KilledUnit(Unit *pVictim) override {
    ...
    if (pVictim->GetTypeId() == TYPEID_PLAYER)
      pVictim->CastSpell(pVictim, SPELL_MARK_OF_FROST_PLAYER, TRIGGERED_OLD_TRIGGERED, nullptr, nullptr,
...
UnitAI *GetAI_boss_azuregos(Creature *pCreature) { return new boss_azuregosAI(pCreature); }
