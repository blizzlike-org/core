...
enum {
  ...
  SPELL_ARCANE_EXPLOSION =
      32614, // used by Dark Portal Crystal Stalker per 25% shield lost (handled in dummy effect for spell 32589)
...
static const PortalData afPortalLocation[] = {{-2030.832f, 7024.944f, 23.07182f, 3.141593f},
...
private:
  ...
  bool CheckConditionCriteriaMeet(Player const *pPlayer, uint32 uiInstanceConditionId,
                                  WorldObject const *pConditionSource, uint32 conditionSourceType) const override;
