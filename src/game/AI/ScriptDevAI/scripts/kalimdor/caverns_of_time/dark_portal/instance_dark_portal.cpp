...
instance_dark_portal::instance_dark_portal(Map *pMap)
    : ScriptedInstance(pMap), m_uiWorldState(0), m_uiWorldStateRiftCount(0), m_uiWorldStateShieldCount(100),
      m_uiSummonedCrystalCount(0), m_bHasIntroYelled(false), m_uiMedivhYellCount(1), m_uiNextPortalTimer(0),
      m_uiSummonCrystalTimer(0), m_uiSummonBeamStalkerTimer(0), m_uiCurrentRiftId(0), m_uiPostEventTimer(0),
      m_uiPostEventStep(0) {
  Initialize();
}

void instance_dark_portal::Initialize() { memset(&m_auiEncounter, 0, sizeof(m_auiEncounter)); }
    ...
    if (uiData == IN_PROGRESS) {
      if (Creature *pMedivh = GetSingleCreatureFromStorage(NPC_MEDIVH)) {
        if (pMedivh->IsAlive()) {
          ...
          if (Creature *pSaat =
                  GetSingleCreatureFromStorage(NPC_SAAT)) // Sa'at is not a questgiver while event is in progress
...
void instance_dark_portal::DoSpawnNextPortal() {
  if (Creature *pMedivh = GetSingleCreatureFromStorage(NPC_MEDIVH)) {
    ...
    // Summon next portal
    pMedivh->SummonCreature(NPC_TIME_RIFT, afPortalLocation[uiTmp].fX, afPortalLocation[uiTmp].fY,
                            afPortalLocation[uiTmp].fZ, afPortalLocation[uiTmp].fOrient, TEMPSPAWN_CORPSE_DESPAWN, 0);
  }
}
...
void instance_dark_portal::ExecutePostEventStep() {
  ...
  case POST_EVENT_3_SUMMON_ORCS_1: {
    if (Creature *pMedivh = GetSingleCreatureFromStorage(NPC_MEDIVH)) {
      pMedivh->SummonCreature(NPC_COUNCIL_ENFORCER, -2086.848f, 7132.722f, 34.67148f, 6.126106f, TEMPSPAWN_DEAD_DESPAWN,
                              0, true, true, 1);
      pMedivh->SummonCreature(NPC_COUNCIL_ENFORCER, -2087.195f, 7129.969f, 34.67148f, 6.143559f, TEMPSPAWN_DEAD_DESPAWN,
                              0, true, true, 2);
      pMedivh->SummonCreature(NPC_COUNCIL_ENFORCER, -2087.48f, 7127.273f, 34.67148f, 6.161012f, TEMPSPAWN_DEAD_DESPAWN,
                              0, true, true, 3);
      pMedivh->SummonCreature(NPC_COUNCIL_ENFORCER, -2087.801f, 7124.51f, 34.67148f, 6.178465f, TEMPSPAWN_DEAD_DESPAWN,
                              0, true, true, 4);
      pMedivh->SummonCreature(NPC_COUNCIL_ENFORCER, -2088.082f, 7121.888f, 34.67148f, 6.195919f, TEMPSPAWN_DEAD_DESPAWN,
                              0, true, true, 5);
      pMedivh->SummonCreature(NPC_COUNCIL_ENFORCER, -2088.386f, 7119.379f, 34.67148f, 6.213372f, TEMPSPAWN_DEAD_DESPAWN,
                              0, true, true, 6);
    }
  ...
  case POST_EVENT_4_SUMMON_ORCS_2: {
    if (Creature *pMedivh = GetSingleCreatureFromStorage(NPC_MEDIVH)) {
      pMedivh->SummonCreature(NPC_COUNCIL_ENFORCER, -2086.572f, 7132.635f, 34.67148f, 6.126106f, TEMPSPAWN_DEAD_DESPAWN,
                              0, true, true, 7);
      pMedivh->SummonCreature(NPC_COUNCIL_ENFORCER, -2086.985f, 7129.968f, 34.67148f, 6.143559f, TEMPSPAWN_DEAD_DESPAWN,
                              0, true, true, 8);
      pMedivh->SummonCreature(NPC_COUNCIL_ENFORCER, -2087.409f, 7127.203f, 34.67148f, 6.161012f, TEMPSPAWN_DEAD_DESPAWN,
                              0, true, true, 9);
      pMedivh->SummonCreature(NPC_COUNCIL_ENFORCER, -2087.883f, 7124.376f, 34.67148f, 6.178465f, TEMPSPAWN_DEAD_DESPAWN,
                              0, true, true, 10);
      pMedivh->SummonCreature(NPC_COUNCIL_ENFORCER, -2088.225f, 7121.99f, 34.67147f, 6.195919f, TEMPSPAWN_DEAD_DESPAWN,
                              0, true, true, 11);
      pMedivh->SummonCreature(NPC_COUNCIL_ENFORCER, -2088.599f, 7119.243f, 34.67148f, 6.213372f, TEMPSPAWN_DEAD_DESPAWN,
                              0, true, true, 12);
    }
  ...
  case POST_EVENT_5_SUMMON_ORCS_3: {
    if (Creature *pMedivh = GetSingleCreatureFromStorage(NPC_MEDIVH)) {
      pMedivh->SummonCreature(NPC_COUNCIL_ENFORCER, -2086.509f, 7132.678f, 34.67148f, 6.126106f, TEMPSPAWN_DEAD_DESPAWN,
                              0, true, true, 13);
      pMedivh->SummonCreature(NPC_COUNCIL_ENFORCER, -2086.954f, 7129.987f, 34.67148f, 6.143559f, TEMPSPAWN_DEAD_DESPAWN,
                              0, true, true, 14);
      pMedivh->SummonCreature(NPC_COUNCIL_ENFORCER, -2087.31f, 7127.19f, 34.67148f, 6.161012f, TEMPSPAWN_DEAD_DESPAWN,
                              0, true, true, 15);
      pMedivh->SummonCreature(NPC_COUNCIL_ENFORCER, -2087.646f, 7124.358f, 34.67148f, 6.178465f, TEMPSPAWN_DEAD_DESPAWN,
                              0, true, true, 16);
      pMedivh->SummonCreature(NPC_COUNCIL_ENFORCER, -2088.013f, 7121.874f, 34.67148f, 6.195919f, TEMPSPAWN_DEAD_DESPAWN,
                              0, true, true, 17);
      pMedivh->SummonCreature(NPC_COUNCIL_ENFORCER, -2088.501f, 7119.221f, 34.67148f, 6.213372f, TEMPSPAWN_DEAD_DESPAWN,
                              0, true, true, 18);
    }
    m_uiPostEventTimer = 2400;
    m_uiPostEventStep++;
  ...
  case POST_EVENT_6_SUMMON_ORCS_4: {
    if (Creature *pMedivh = GetSingleCreatureFromStorage(NPC_MEDIVH)) {
      pMedivh->SummonCreature(NPC_COUNCIL_ENFORCER, -2086.459f, 7132.609f, 34.67148f, 6.149603f, TEMPSPAWN_DEAD_DESPAWN,
                              0, true, true, 19);
      pMedivh->SummonCreature(NPC_COUNCIL_ENFORCER, -2086.878f, 7129.967f, 34.67148f, 6.097349f, TEMPSPAWN_DEAD_DESPAWN,
                              0, true, true, 20);
      pMedivh->SummonCreature(NPC_COUNCIL_ENFORCER, -2087.149f, 7127.205f, 34.67148f, 6.089332f, TEMPSPAWN_DEAD_DESPAWN,
                              0, true, true, 21);
      pMedivh->SummonCreature(NPC_COUNCIL_ENFORCER, -2087.488f, 7124.414f, 34.67148f, 6.143568f, TEMPSPAWN_DEAD_DESPAWN,
                              0, true, true, 22);
      pMedivh->SummonCreature(NPC_COUNCIL_ENFORCER, -2087.892f, 7121.918f, 34.67148f, 6.139006f, TEMPSPAWN_DEAD_DESPAWN,
                              0, true, true, 23);
      pMedivh->SummonCreature(NPC_COUNCIL_ENFORCER, -2088.388f, 7119.204f, 34.67148f, 6.178112f, TEMPSPAWN_DEAD_DESPAWN,
                              0, true, true, 24);
    }
...
bool instance_dark_portal::CheckConditionCriteriaMeet(Player const *pPlayer, uint32 uiInstanceConditionId,
  ...
  script_error_log("instance_dark_portal::CheckConditionCriteriaMeet called with unsupported Id %u. Called with param "
...
InstanceData *GetInstanceData_instance_dark_portal(Map *pMap) { return new instance_dark_portal(pMap); }
