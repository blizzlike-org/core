...
instance_wailing_caverns::instance_wailing_caverns(Map *pMap) : ScriptedInstance(pMap) { Initialize(); }

void instance_wailing_caverns::Initialize() { memset(&m_auiEncounter, 0, sizeof(m_auiEncounter)); }
