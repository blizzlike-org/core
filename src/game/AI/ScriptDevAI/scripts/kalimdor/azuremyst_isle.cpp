...
UnitAI *GetAI_npc_draenei_survivor(Creature *pCreature) { return new npc_draenei_survivorAI(pCreature); }
...
UnitAI *GetAI_npc_magwinAI(Creature *pCreature) { return new npc_magwinAI(pCreature); }
