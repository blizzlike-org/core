...
enum {
  SPELL_CORRUPTED_MIND =
      29201, // this triggers the following spells on targets (based on class): 29185, 29194, 29196, 29198
...
struct boss_loathebAI : public CombatAI {
  ...
  void ExecuteAction(uint32 action) override {
    ...
    case LOATHEB_REMOVE_CURSE: {
      ...
      if (decurseResult == SPELL_CAST_OK ||
          decurseResult == SPELL_FAILED_NOTHING_TO_DISPEL) // Don't throw an error if there is nothing to dispel
