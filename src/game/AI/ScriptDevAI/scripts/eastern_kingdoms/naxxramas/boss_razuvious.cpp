...
SD%Complete: 95%
SDComment: TODO: Deathknight Understudy are supposed to gain Mind Exhaustion debuff when released from player Mind
Control SDCategory: Naxxramas EndScriptData */
...
static const float resetZ =
    285.0f; // Above this altitude, Razuvious is outside his combat area (in the stairs) and should reset (leashing)
...
struct boss_razuviousAI : public ScriptedAI {
  ...
  void SpellHit(Unit * /*caster*/, const SpellEntry *spell) override {
    ...
    if (spell->Id == SPELL_TAUNT) {
      switch (urand(0, 3)) {
      case 0:
        DoScriptText(SAY_UNDERSTUDY_TAUNT_1, m_creature);
        break;
      case 1:
        DoScriptText(SAY_UNDERSTUDY_TAUNT_2, m_creature);
        break;
      case 2:
        DoScriptText(SAY_UNDERSTUDY_TAUNT_3, m_creature);
        break;
      case 3:
        DoScriptText(SAY_UNDERSTUDY_TAUNT_4, m_creature);
        break;
      }
    }
  }
...
UnitAI *GetAI_boss_razuvious(Creature *creature) { return new boss_razuviousAI(creature); }
