...
SD%Complete: 90
SDComment: Jandice's Illusions are missing their AoE immunity, they should only be vunerable to direct damage (missing
core feature ?) SDCategory: Scholomance EndScriptData */
...
UnitAI *GetAI_boss_jandicebarov(Creature *pCreature) { return new boss_jandicebarovAI(pCreature); }
