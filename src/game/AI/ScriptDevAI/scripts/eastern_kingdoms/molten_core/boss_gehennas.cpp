...
struct boss_gehennasAI : public CombatAI {
  ...
  void ExecuteAction(uint32 action) override {
    ...
    case GEHENNAS_RAIN_OF_FIRE: {
      if (Unit *target =
              m_creature->SelectAttackingTarget(ATTACKING_TARGET_RANDOM, 0, SPELL_RAIN_OF_FIRE, SELECT_FLAG_PLAYER))
...
UnitAI *GetAI_boss_gehennas(Creature *creature) { return new boss_gehennasAI(creature); }
