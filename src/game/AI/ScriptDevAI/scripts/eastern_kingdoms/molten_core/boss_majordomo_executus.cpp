...
enum {
  ...
  SPELL_SEPARATION_ANXIETY = 21094, // Aura cast on himself by Majordomo Executus, if adds move out of range, they will
                                    // cast spell 21095 on themselves
...
struct boss_majordomoAI : public CombatAI {
  ...
  void Aggro(Unit *who) override {
    ...
    // Majordomo Executus has a 100 yard aura to keep track of the distance of each of his adds, the Flamewaker Healers
    // will enrage if moved out of it
...
UnitAI *GetAI_boss_majordomo(Creature *creature) { return new boss_majordomoAI(creature); }
