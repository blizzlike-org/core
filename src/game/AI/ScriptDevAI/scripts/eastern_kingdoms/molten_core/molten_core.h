...
static const sRuneEncounters m_aMoltenCoreRunes[MAX_MOLTEN_RUNES] = {
    {GO_RUNE_KRESS, GO_CIRCLE_MAGMADAR, TYPE_MAGMADAR},  {GO_RUNE_MOHN, GO_CIRCLE_GEHENNAS, TYPE_GEHENNAS},
    {GO_RUNE_BLAZ, GO_CIRCLE_GARR, TYPE_GARR},           {GO_RUNE_MAZJ, GO_CIRCLE_SHAZZRAH, TYPE_SHAZZRAH},
    {GO_RUNE_ZETH, GO_CIRCLE_BARON_GEDDON, TYPE_GEDDON}, {GO_RUNE_THERI, GO_CIRCLE_GOLEMAGG, TYPE_GOLEMAGG},
