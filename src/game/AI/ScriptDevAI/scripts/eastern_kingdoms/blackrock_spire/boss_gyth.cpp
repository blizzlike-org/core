...
struct boss_gythAI : public ScriptedAI {
  ...
  void JustSummoned(Creature *pSummoned) override { DoScriptText(EMOTE_KNOCKED_OFF, pSummoned); }
...
UnitAI *GetAI_boss_gyth(Creature *pCreature) { return new boss_gythAI(pCreature); }
