...
struct boss_archaedasAI : public ScriptedAI {
  ...
  void KilledUnit(Unit * /*pVictim*/) override { DoScriptText(SAY_UNIT_SLAIN, m_creature); }
...
UnitAI *GetAI_boss_archaedas(Creature *pCreature) { return new boss_archaedasAI(pCreature); }
