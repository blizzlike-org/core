...
enum {
  ...
  // because we don't have the possibility to do that we'll just iterate through the players and set the phase mask
  // manually based on the battle status
...
static const uint32 aLightChampions[MAX_LIGHT_CHAMPIONS] = {NPC_KORFAX_CHAMPION_OF_THE_LIGHT,
                                                            ...
                                                            NPC_RAYNE};
static const uint32 aScourgeChampions[MAX_SCOURGE_CHAMPIONS] = {NPC_HIGHLORD_DARION_MOGRAINE, NPC_KOLTIRA_DEATHWEAVER,
                                                                NPC_ORBAZ_BLOODBANE, NPC_THASSARIAN};
