...
struct npc_daphne_stilwellAI : public npc_escortAI, public TimerManager {
  ...
  void Aggro(Unit * /*who*/) override { SetCombatMovement(false); }
...
UnitAI *GetAI_npc_daphne_stilwell(Creature *creature) { return new npc_daphne_stilwellAI(creature); }
...
struct npc_defias_traitorAI : public npc_escortAI {
  ...
  void Aggro(Unit *who) override { DoScriptText(urand(0, 1) ? SAY_AGGRO_1 : SAY_AGGRO_2, m_creature, who); }
...
UnitAI *GetAI_npc_defias_traitor(Creature *creature) { return new npc_defias_traitorAI(creature); }
