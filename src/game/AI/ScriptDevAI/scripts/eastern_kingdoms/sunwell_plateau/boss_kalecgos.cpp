...
struct boss_sathrovarrAI : public ScriptedAI {
  ...
  void Aggro(Unit * /*pWho*/) override {
    ...
    m_creature->SummonCreature(NPC_KALECGOS_HUMAN, aKalecHumanLoc[0], aKalecHumanLoc[1], aKalecHumanLoc[2],
                               aKalecHumanLoc[3], TEMPSPAWN_DEAD_DESPAWN, 0, true);
  }
  ...
  void JustDied(Unit * /*pKiller*/) override { DoScriptText(SAY_SATH_DEATH, m_creature); }
...
struct boss_kalecgos_humanoidAI : public ScriptedAI {
  ...
  void Aggro(Unit * /*pWho*/) override { DoScriptText(SAY_GOOD_AGGRO, m_creature); }
...
UnitAI *GetAI_boss_kalecgos(Creature *pCreature) { return new boss_kalecgosAI(pCreature); }

UnitAI *GetAI_boss_sathrovarr(Creature *pCreature) { return new boss_sathrovarrAI(pCreature); }

UnitAI *GetAI_boss_kalecgos_humanoid(Creature *pCreature) { return new boss_kalecgos_humanoidAI(pCreature); }

bool EffectDummyCreature_spell_spectral_realm_notify(Unit *pCaster, uint32 uiSpellId, SpellEffectIndex uiEffIndex,
