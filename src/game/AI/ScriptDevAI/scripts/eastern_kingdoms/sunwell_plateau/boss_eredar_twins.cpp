...
SD%Complete: 75
SDComment: A few spells are not working proper yet; Shadow image script needs improvement; Add invulnerability in phase
transition SDCategory: Sunwell Plateau EndScriptData */
...
static const DialogueEntry aIntroDialogue[] = {
    {SAY_INTRO_1, NPC_SACROLASH, 1000}, {SAY_INTRO_2, NPC_ALYTHESS, 1500},  {SAY_INTRO_3, NPC_SACROLASH, 1500},
    {SAY_INTRO_4, NPC_ALYTHESS, 1500},  {SAY_INTRO_5, NPC_SACROLASH, 1500}, {SAY_INTRO_6, NPC_ALYTHESS, 1500},
    {SAY_INTRO_7, NPC_SACROLASH, 2500}, {SAY_INTRO_8, NPC_ALYTHESS, 0},     {0, 0, 0},
};
...
struct boss_alythessAI : public ScriptedAI {
  boss_alythessAI(Creature *pCreature) : ScriptedAI(pCreature), m_introDialogue(aIntroDialogue) {
...
UnitAI *GetAI_boss_alythess(Creature *pCreature) { return new boss_alythessAI(pCreature); }

UnitAI *GetAI_boss_sacrolash(Creature *pCreature) { return new boss_sacrolashAI(pCreature); }

UnitAI *GetAI_npc_shadow_image(Creature *pCreature) { return new npc_shadow_imageAI(pCreature); }
