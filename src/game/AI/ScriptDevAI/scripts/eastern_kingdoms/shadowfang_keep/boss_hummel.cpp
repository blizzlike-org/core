...
struct boss_apothecary_hummelAI : public CombatAI {
  boss_apothecary_hummelAI(Creature *creature)
      : CombatAI(creature, HUMMEL_ACTION_MAX),
        m_instance(static_cast<instance_shadowfang_keep *>(creature->GetInstanceData())) {
...
struct npc_valentine_boss_managerAI : public ScriptedAI, private DialogueHelper {
  npc_valentine_boss_managerAI(Creature *pCreature) : ScriptedAI(pCreature), DialogueHelper(aIntroDialogue) {
