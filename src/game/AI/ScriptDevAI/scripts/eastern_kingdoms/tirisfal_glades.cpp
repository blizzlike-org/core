...
enum { QUEST_ULAG = 1819, NPC_ULAG = 6390, GO_TRIGGER = 104593, GO_DOOR = 176594 };
...
UnitAI *GetAI_npc_calvin_montague(Creature *pCreature) { return new npc_calvin_montagueAI(pCreature); }
