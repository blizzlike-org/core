...
struct boss_nefarianAI : public CombatAI {
  boss_nefarianAI(Creature *creature)
      : CombatAI(creature, NEFARIAN_ACTION_MAX),
  ...
  void HandleInitialYell() { DoScriptText(SAY_SHADOW_FLAME, m_creature); }
  ...
  void ExecuteAction(uint32 action) override {
    ...
    case NEFARIAN_CLASS_CALL: {
      ...
      if (Unit *target = m_creature->SelectAttackingTarget(ATTACKING_TARGET_RANDOM, 0, uint32(0), SELECT_FLAG_PLAYER)) {
        ...
        case CLASS_WARRIOR:
          spellId = SPELL_WARRIOR;
          textId = SAY_WARRIOR;
          break;
        case CLASS_PALADIN:
          spellId = SPELL_PALADIN;
          textId = SAY_PALADIN;
          break;
        case CLASS_HUNTER:
          spellId = SPELL_HUNTER;
          textId = SAY_HUNTER;
          break;
        case CLASS_ROGUE:
          spellId = SPELL_ROGUE;
          ...
          break;
        case CLASS_PRIEST:
          spellId = SPELL_PRIEST;
          textId = SAY_PRIEST;
          break;
        case CLASS_SHAMAN:
          spellId = SPELL_SHAMAN;
          textId = SAY_SHAMAN;
          break;
        case CLASS_MAGE:
          spellId = SPELL_MAGE;
