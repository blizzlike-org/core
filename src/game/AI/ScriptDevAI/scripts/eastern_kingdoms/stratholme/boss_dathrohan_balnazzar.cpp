...
struct boss_dathrohan_balnazzarAI : public ScriptedAI {
  ...
  void JustDied(Unit * /*Victim*/) override { DoScriptText(SAY_DEATH, m_creature); }
...
UnitAI *GetAI_boss_dathrohan_balnazzar(Creature *pCreature) { return new boss_dathrohan_balnazzarAI(pCreature); }
