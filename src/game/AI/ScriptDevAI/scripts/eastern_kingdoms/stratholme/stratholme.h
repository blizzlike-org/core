...
static const uint32 aGates[] = {GO_PORT_TRAP_GATE_1, GO_PORT_TRAP_GATE_2, GO_PORT_TRAP_GATE_3, GO_PORT_TRAP_GATE_4};

static const uint32 aPlaguedCritters[] = {NPC_PLAGUED_RAT, NPC_PLAGUED_MAGGOT, NPC_PLAGUED_INSECT};
...
static const int ScarletEventYells[] = {YELL_BASTION_BARRICADE, YELL_BASTION_STAIRS,      0,
                                        YELL_BASTION_ENTRANCE,  YELL_BASTION_HALL_LIGHTS, YELL_BASTION_INNER_1,
                                        YELL_BASTION_INNER_2};
...
static const EventLocation aDefensePoints[] = {
    ...
    {3661.89f, -3192.89f,
     126.691f} // Barricades before the last one (Courtyard): in last position for conveniently iterate over the table
};
...
static const EventLocation aScarletGuards[] =    // Spawned when players cleared some parts of the Bastion
    {{3598.213f, -3094.812f, 135.657f, 5.3425f}, // Hall of Lights
     {3602.198f, -3096.243f, 134.120f},          {3598.152f, -3098.927f, 134.120f},
     {3432.967f, -3069.643f, 136.529f, 5.3425f}, // Inner Bastion
     {3441.795f, -3077.431f, 135.000f},          {3437.445f, -3080.316f, 135.000f}};
...
static const EventLocation aScourgeInvaders[] = // Attack when players cleared some parts of the Bastion
    {{3614.702f, -3187.642f, 131.406f, 4.024f}, // Timmy. TIMMYYYYYYY !!!
     ...
     {3642.50f, -3106.24f, 314.18f, 0.5210f},   {3547.85f, -3076.46f, 135.00f, 2.2269f}, // Inner Bastion
     {3512.21f, -3066.85f, 135.00f, 3.7136f},   {3492.44f, -3077.72f, 135.00f, 2.1680f}, // Crimson Throne
     {3443.18f, -3083.90f, 135.01f, 2.1563f}};

static const EventLocation
    aScarletLastStand[] = // Positions remaining Scarlet defenders will move to if the position is lost
    {{3658.43f, -3178.07f, 126.696f, 5.23599f}, // Last barricade
     {3665.62f, -3173.88f, 126.551f, 5.02655f}, {3662.84f, -3175.15f, 126.559f, 5.11381f},
     {3656.91f, -3161.94f, 128.359f, 5.39307f}, // Bastion stairs
     {3664.29f, -3157.06f, 128.357f, 5.18363f}, {3661.57f, -3157.80f, 128.945f, 5.23599f}};
