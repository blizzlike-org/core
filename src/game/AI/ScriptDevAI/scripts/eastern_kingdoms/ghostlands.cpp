...
struct npc_ranger_lilathaAI : public npc_escortAI {
  ...
  void WaypointReached(uint32 i) override {
    ...
    case 1:
      ...
      m_creature->SetFactionTemporary(FACTION_SMOON_E, TEMPFACTION_RESTORE_RESPAWN |
    ...
    case 19:
      ...
      if (Creature *pSum1 = m_creature->SummonCreature(16342, 7627.083984f, -7532.538086f, 152.128616f, 1.082733f,
                                                       TEMPSPAWN_DEAD_DESPAWN, 0))
        pSum1->AI()->AttackStart(m_creature);
      if (Creature *pSum2 = m_creature->SummonCreature(16343, 7620.432129f, -7532.550293f, 152.454865f, 0.827478f,
                                                       TEMPSPAWN_DEAD_DESPAWN, 0))
...
UnitAI *GetAI_npc_ranger_lilathaAI(Creature *pCreature) { return new npc_ranger_lilathaAI(pCreature); }
