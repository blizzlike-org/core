  ...
  void WaypointReached(uint32 uiPointId) override {
    ...
    case 21:
      ...
      for (uint8 i = 0; i < MAX_STEELSHIFTERS; ++i) {
        ...
        m_creature->SummonCreature(NPC_DARK_IRON_STEELSHIFTER, fX, fY, fZ, 0, TEMPSPAWN_TIMED_OOC_OR_DEAD_DESPAWN,
                                   60000);
      }
      break;
    case 34:
...
UnitAI *GetAI_npc_dorius_stonetender(Creature *pCreature) { return new npc_dorius_stonetenderAI(pCreature); }
