...
enum { SPELL_THOUSAND_BLADES = 24649, SPELL_VANISH = 24699, SPELL_GOUGE = 24698, SPELL_TRASH = 3391 };
...
struct boss_renatakiAI : public ScriptedAI {
  ...
  void UpdateAI(const uint32 uiDiff) override {
    ...
    // Note: because the Vanish spell adds invisibility effect on the target, the timers won't be decreased during the
    // vanish phase
    if (m_uiAmbushTimer) {
...
UnitAI *GetAI_boss_renataki(Creature *pCreature) { return new boss_renatakiAI(pCreature); }
