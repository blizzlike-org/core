...
instance_magisters_terrace::instance_magisters_terrace(Map *pMap) : ScriptedInstance(pMap), m_uiDelrissaDeathCount(0) {
  Initialize();
}

void instance_magisters_terrace::Initialize() { memset(&m_auiEncounter, 0, sizeof(m_auiEncounter)); }
...
InstanceData *GetInstanceData_instance_magisters_terrace(Map *pMap) { return new instance_magisters_terrace(pMap); }
