...
struct npc_professor_phizzlethorpeAI : public npc_escortAI {
  ...
  void WaypointReached(uint32 uiPointId) override {
    ...
    case 9:
      ...
      break;
    case 10:
      m_creature->SummonCreature(ENTRY_VENGEFUL_SURGE, -2056.41f, -2144.01f, 20.59f, 5.70f,
                                 TEMPSPAWN_TIMED_OOC_OR_CORPSE_DESPAWN, 600000);
      m_creature->SummonCreature(ENTRY_VENGEFUL_SURGE, -2050.17f, -2140.02f, 19.54f, 5.17f,
                                 TEMPSPAWN_TIMED_OOC_OR_CORPSE_DESPAWN, 600000);
      break;
    case 11:
...
UnitAI *GetAI_npc_professor_phizzlethorpe(Creature *pCreature) { return new npc_professor_phizzlethorpeAI(pCreature); }
...
UnitAI *GetAI_npc_kinelory(Creature *pCreature) { return new npc_kineloryAI(pCreature); }
