...
enum { SPELL_SHADOWWORDPAIN = 14032, SPELL_MANABURN = 14033, SPELL_PSYCHICSCREAM = 13704, SPELL_SHADOWSHIELD = 12040 };
...
struct boss_high_interrogator_gerstahnAI : public ScriptedAI {
  ...
  void UpdateAI(const uint32 uiDiff) override {
    ...
    if (m_uiManaBurnTimer < uiDiff) {
      if (Unit *pTarget =
              m_creature->SelectAttackingTarget(ATTACKING_TARGET_RANDOM, 0, SPELL_MANABURN, SELECT_FLAG_POWER_MANA)) {
