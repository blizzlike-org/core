...
enum {
  ...
  FACTION_IRONFORGE =
      122, // Faction used by Phalanx when Plugger is killed (yes, friendly to Alliance, Hostile to Horde, very strange)
...
static const uint32 aPatronsEmotes[] = {EMOTE_ONESHOT_EXCLAMATION, EMOTE_ONESHOT_CHEER, EMOTE_ONESHOT_CHEER,
                                        EMOTE_ONESHOT_LAUGH,       EMOTE_ONESHOT_LAUGH, EMOTE_ONESHOT_LAUGH};
...
static const float aBarPatrolPositions[2][4] = {{872.7059f, -232.5491f, -43.7525f, 2.069044f},
...
static const uint32 aTombDwarfes[MAX_DWARFS] = {NPC_ANGERREL, NPC_SEETHREL, NPC_DOPEREL, NPC_GLOOMREL,
                                                NPC_VILEREL,  NPC_HATEREL,  NPC_DOOMREL};
