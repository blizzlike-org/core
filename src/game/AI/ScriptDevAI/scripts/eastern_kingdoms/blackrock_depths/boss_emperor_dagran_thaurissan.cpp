...
struct boss_emperor_dagran_thaurissanAI : public ScriptedAI {
  ...
  void KilledUnit(Unit * /*pVictim*/) override { DoScriptText(YELL_SLAY, m_creature); }
...
UnitAI *GetAI_boss_moira_bronzebeard(Creature *pCreature) { return new boss_moira_bronzebeardAI(pCreature); }
