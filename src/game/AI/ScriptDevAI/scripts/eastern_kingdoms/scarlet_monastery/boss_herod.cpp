...
UnitAI *GetAI_boss_herod(Creature *pCreature) { return new boss_herodAI(pCreature); }
...
UnitAI *GetAI_mob_scarlet_trainee(Creature *pCreature) { return new mob_scarlet_traineeAI(pCreature); }
