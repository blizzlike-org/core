...
UnitAI *GetAI_boss_headless_horseman(Creature *pCreature) { return new boss_headless_horsemanAI(pCreature); }
...
UnitAI *GetAI_boss_head_of_horseman(Creature *pCreature) { return new boss_head_of_horsemanAI(pCreature); }
