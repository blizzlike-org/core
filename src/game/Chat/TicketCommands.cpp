...
bool ChatHandler::HandleTicketGoCommand(char *args) {
  ...
  return HandleGoHelper(m_session->GetPlayer(), ticket->GetMapId(), ticket->GetPositionX(), ticket->GetPositionY(), &z,
                        &o);
}
...
bool ChatHandler::HandleTicketCommand(char *args) { return HandleTicketReadCommand(args); }
