...
/// Camera - object-receiver. Receives broadcast packets from nearby worldobjects, object visibility changes and sends
/// them to client
class Camera {
...
public:
  ...
  template <class T> void UpdateVisibilityOf(T *target, UpdateData &data, WorldObjectSet &vis);
