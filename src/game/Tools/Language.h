...
enum MangosStrings {
  ...
  LANG_WAYPOINT_INFO_UNK_SCRIPTID =
      250,                       // ScriptID set to non-existing id %u, add it to DBScriptsEngine and reload the table.
  ...
  LANG_BG_GROUP_MEMBER_ALREADY_IN_QUEUE = 730, // "Someone in your party is already in this battleground queue. (S)he
                                               // must leave it before joining as group."
  ...
  LANG_CANNOT_GO_TO_BG_FROM_BG = 736, // "You cannot teleport to a battleground from another battleground. Please leave
                                      // the current battleground first."
  ...
  LANG_COMMAND_TICKET_UNSEEN =
      1514, // "[%s]: Ticket has not been seen by a GM yet"
  ...
  LANG_COMMAND_TICKETS_LISTING_FOOTER =
      1524, // "| Quick actions: |c00FFFFFF<Shift+click>|r on ticket id tag to read the ticket"
  ...
  LANG_TICKET_BROADCAST_SURVEY =
      1548, // "[Tickets]: [%s] has been successfully surveyed"
  ...
  LANG_TICKET_DETAILS_LINE_SUMMARY =
      1560, // "| %s L|c00FFFFFF%u|r ticket #|c00FFFFFF%u|r in category: |c00FFFFFF%s|r (|c00FFFFFF%u|r)"
  LANG_TICKET_DETAILS_LINE_AUTHOR =
      1561, // "| Player: |Hplayer:%s|h|c00FFFFFF<%s>|r|h (GUID |c00FFFFFF%010u|r) [|c00FFFFFF%s|r] |c00FF1A1A%s|r"
  ...
  LANG_TICKET_DETAILS_LINE_ASSIGNED =
      1568, // "| Last assigned to: |Hplayer:%s|h|c00FFFFFF<%s>|r|h (GUID |c00FFFFFF%010u|r)"
  ...
  LANG_TICKET_DETAILS_ACTION_NOTE =
      1579, // "NOTE"
            //                                  = 1580              // Reserved for potential ticket action string
  LANG_TICKETS_NOTIFICATIONS =
      1581, // "Ticket notifications"
