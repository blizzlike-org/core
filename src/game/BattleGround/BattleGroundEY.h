...
enum EYHonorIntervals { EY_NORMAL_HONOR_INTERVAL = 260, EY_WEEKEND_HONOR_INTERVAL = 160 };

enum EYScore { EY_WARNING_NEAR_VICTORY_SCORE = 1800, EY_MAX_TEAM_SCORE = 2000 };
...
static const uint32 eyGraveyards[EY_MAX_NODES] = {GRAVEYARD_FEL_REAVER_RUINS, GRAVEYARD_BLOOD_ELF_TOWER,
                                                  GRAVEYARD_DRAENEI_RUINS, GRAVEYARD_MAGE_TOWER};
static const uint32 eyTriggers[EY_MAX_NODES] = {AREATRIGGER_FEL_REAVER_RUINS_BUFF, AREATRIGGER_BLOOD_ELF_TOWER_BUFF,
                                                AREATRIGGER_DRAENEI_RUINS_BUFF, AREATRIGGER_MAGE_TOWER_BUFF};
...
static const EYTowerEvent eyTowerEvents[EY_MAX_NODES][4] = {
    {
        {EVENT_FEL_REAVER_RUINS_PROGRESS_ALLIANCE, ALLIANCE, LANG_BG_EY_HAS_TAKEN_A_B_TOWER,
         WORLD_STATE_EY_FEL_REAVER_RUINS_ALLIANCE},
        {EVENT_FEL_REAVER_RUINS_PROGRESS_HORDE, HORDE, LANG_BG_EY_HAS_TAKEN_H_F_RUINS,
         WORLD_STATE_EY_FEL_REAVER_RUINS_HORDE},
        {EVENT_FEL_REAVER_RUINS_NEUTRAL_HORDE, TEAM_NONE, LANG_BG_EY_HAS_LOST_A_F_RUINS,
         WORLD_STATE_EY_FEL_REAVER_RUINS_NEUTRAL},
        {EVENT_FEL_REAVER_RUINS_NEUTRAL_ALLIANCE, TEAM_NONE, LANG_BG_EY_HAS_LOST_H_F_RUINS,
         WORLD_STATE_EY_FEL_REAVER_RUINS_NEUTRAL},
    },
    {
        {EVENT_BLOOD_ELF_TOWER_PROGRESS_ALLIANCE, ALLIANCE, LANG_BG_EY_HAS_TAKEN_A_B_TOWER,
         WORLD_STATE_EY_BLOOD_ELF_TOWER_ALLIANCE},
        {EVENT_BLOOD_ELF_TOWER_PROGRESS_HORDE, HORDE, LANG_BG_EY_HAS_TAKEN_H_B_TOWER,
         WORLD_STATE_EY_BLOOD_ELF_TOWER_HORDE},
        {EVENT_BLOOD_ELF_TOWER_NEUTRAL_HORDE, TEAM_NONE, LANG_BG_EY_HAS_LOST_A_B_TOWER,
         WORLD_STATE_EY_BLOOD_ELF_TOWER_NEUTRAL},
        {EVENT_BLOOD_ELF_TOWER_NEUTRAL_ALLIANCE, TEAM_NONE, LANG_BG_EY_HAS_LOST_H_B_TOWER,
         WORLD_STATE_EY_BLOOD_ELF_TOWER_NEUTRAL},
    },
    {
        {EVENT_DRAENEI_RUINS_PROGRESS_ALLIANCE, ALLIANCE, LANG_BG_EY_HAS_TAKEN_A_D_RUINS,
        ...
        {EVENT_DRAENEI_RUINS_NEUTRAL_HORDE, TEAM_NONE, LANG_BG_EY_HAS_LOST_A_D_RUINS,
         WORLD_STATE_EY_DRAENEI_RUINS_NEUTRAL},
        {EVENT_DRAENEI_RUINS_NEUTRAL_ALLIANCE, TEAM_NONE, LANG_BG_EY_HAS_LOST_H_D_RUINS,
         WORLD_STATE_EY_DRAENEI_RUINS_NEUTRAL},
    },
    {
        {EVENT_MAGE_TOWER_PROGRESS_ALLIANCE, ALLIANCE, LANG_BG_EY_HAS_TAKEN_A_M_TOWER,
        ...
        {EVENT_MAGE_TOWER_NEUTRAL_ALLIANCE, TEAM_NONE, LANG_BG_EY_HAS_LOST_H_M_TOWER,
         WORLD_STATE_EY_MAGE_TOWER_NEUTRAL},
    },
};

static const uint32 eyTowers[EY_MAX_NODES] = {GO_CAPTURE_POINT_FEL_REAVER_RUINS, GO_CAPTURE_POINT_BLOOD_ELF_TOWER,
                                              GO_CAPTURE_POINT_DRAENEI_RUINS, GO_CAPTURE_POINT_MAGE_TOWER};
