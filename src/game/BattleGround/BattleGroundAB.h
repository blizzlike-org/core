...
enum ABScores { BG_AB_WARNING_NEAR_VICTORY_SCORE = 1800, BG_AB_MAX_TEAM_SCORE = 2000 };
...
const uint32 abDefaultStates[BG_AB_MAX_NODES] = {BG_AB_OP_STABLE_ICON, BG_AB_OP_BLACKSMITH_ICON, BG_AB_OP_FARM_ICON,
                                                 BG_AB_OP_LUMBERMILL_ICON, BG_AB_OP_GOLDMINE_ICON};

// occupied world states
const uint32 abOccupiedStates[PVP_TEAM_COUNT][BG_AB_MAX_NODES] = {
    {BG_AB_OP_STABLE_STATE_A, BG_AB_OP_BLACKSMITH_STATE_A, BG_AB_OP_FARM_STATE_A, BG_AB_OP_LUMBERMILL_STATE_A,
     BG_AB_OP_GOLDMINE_STATE_A},
    {BG_AB_OP_STABLE_STATE_H, BG_AB_OP_BLACKSMITH_STATE_H, BG_AB_OP_FARM_STATE_H, BG_AB_OP_LUMBERMILL_STATE_H,
     BG_AB_OP_GOLDMINE_STATE_H}};

// contested world states
const uint32 abContestedStates[PVP_TEAM_COUNT][BG_AB_MAX_NODES] = {
    {BG_AB_OP_STABLE_STATE_CON_A, BG_AB_OP_BLACKSMITH_STATE_CON_A, BG_AB_OP_FARM_STATE_CON_A,
     BG_AB_OP_LUMBERMILL_STATE_CON_A, BG_AB_OP_GOLDMINE_STATE_CON_A},
    {BG_AB_OP_STABLE_STATE_CON_H, BG_AB_OP_BLACKSMITH_STATE_CON_H, BG_AB_OP_FARM_STATE_CON_H,
     BG_AB_OP_LUMBERMILL_STATE_CON_H, BG_AB_OP_GOLDMINE_STATE_CON_H}};
...
// WorldSafeLocs ids
const uint32 abGraveyardIds[BG_AB_MAX_NODES] = {AB_GRAVEYARD_STABLES, AB_GRAVEYARD_BLACKSMITH, AB_GRAVEYARD_FARM,
                                                AB_GRAVEYARD_LUMBER_MILL, AB_GRAVEYARD_GOLD_MINE};
