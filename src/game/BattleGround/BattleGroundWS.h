...
static const WarsongData wsgFlagData[PVP_TEAM_COUNT][BG_WS_FLAG_ACTIONS_TOTAL] = {
    {
        {BG_WS_FLAG_ACTION_PICKEDUP, LANG_BG_WS_PICKEDUP_AF, BG_WS_SOUND_ALLIANCE_FLAG_PICKED_UP,
         BG_WS_SPELL_SILVERWING_FLAG, CHAT_MSG_BG_SYSTEM_ALLIANCE},
        {BG_WS_FLAG_ACTION_RETURNED, LANG_BG_WS_RETURNED_AF, BG_WS_SOUND_FLAG_RETURNED, BG_WS_SPELL_SILVERWING_FLAG,
         CHAT_MSG_BG_SYSTEM_ALLIANCE},
        {BG_WS_FLAG_ACTION_DROPPED, LANG_BG_WS_DROPPED_AF, 0, BG_WS_SPELL_SILVERWING_FLAG_DROPPED,
         CHAT_MSG_BG_SYSTEM_ALLIANCE},
        {BG_WS_FLAG_ACTION_CAPTURED, LANG_BG_WS_CAPTURED_AF, BG_WS_SOUND_FLAG_CAPTURED_ALLIANCE, 0,
         CHAT_MSG_BG_SYSTEM_ALLIANCE},
        {BG_WS_FLAG_ACTION_RESPAWN, LANG_BG_WS_ALLIANCE_FLAG_RESPAWNED, BG_WS_SOUND_FLAGS_RESPAWNED, 0,
         CHAT_MSG_BG_SYSTEM_NEUTRAL},
    },
    {
        {BG_WS_FLAG_ACTION_PICKEDUP, LANG_BG_WS_PICKEDUP_HF, BG_WS_SOUND_HORDE_FLAG_PICKED_UP, BG_WS_SPELL_WARSONG_FLAG,
         CHAT_MSG_BG_SYSTEM_HORDE},
        {BG_WS_FLAG_ACTION_RETURNED, LANG_BG_WS_RETURNED_HF, BG_WS_SOUND_FLAG_RETURNED, BG_WS_SPELL_WARSONG_FLAG,
         CHAT_MSG_BG_SYSTEM_HORDE},
        {BG_WS_FLAG_ACTION_DROPPED, LANG_BG_WS_DROPPED_HF, 0, BG_WS_SPELL_WARSONG_FLAG_DROPPED,
         CHAT_MSG_BG_SYSTEM_HORDE},
        {BG_WS_FLAG_ACTION_CAPTURED, LANG_BG_WS_CAPTURED_HF, BG_WS_SOUND_FLAG_CAPTURED_HORDE, 0,
         CHAT_MSG_BG_SYSTEM_HORDE},
        {BG_WS_FLAG_ACTION_RESPAWN, LANG_BG_WS_HORDE_FLAG_RESPAWNED, BG_WS_SOUND_FLAGS_RESPAWNED, 0,
         CHAT_MSG_BG_SYSTEM_NEUTRAL},
    }};
...
private:
  ...
  // Update flag world state; BG_WS_FLAG_STATE_WAIT_RESPAWN (1) for no flag icon; BG_WS_FLAG_STATE_ON_PLAYER (2) for the
  // flag icon
  void UpdateFlagState(Team team, uint32 value) {
    UpdateWorldState(team == ALLIANCE ? BG_WS_STATE_FLAG_ALLIANCE : BG_WS_STATE_FLAG_HORDE, value);
  }
