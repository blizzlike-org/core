...
enum AVGenericVariables {
  ...
  BG_AV_MAX_NODE_DISTANCE = 25, // distance in which players are still counted in range of a banner (for alliance towers
                                // this is calculated from the center of the tower)
...
enum AVSpells {
  BG_AV_SPELL_COMPLETE_AV_QUEST =
      23658, // complete quests 7141 and 7142; cast individually per team, because spell completes both quests at once
...
enum AVSounds {
  ...
  BG_AV_SOUND_ALLIANCE_GOOD = 8173, // if something good happens for the team:  wins(maybe only through killing the
                                    // boss), captures mine or grave, destroys tower and defends grave
  BG_AV_SOUND_HORDE_GOOD = 8213,
  BG_AV_SOUND_BOTH_TOWER_DEFEND = 8192,

  BG_AV_SOUND_ALLIANCE_CAPTAIN =
      8232, // gets called when someone attacks them and at the beginning after 3min + rand(x) * 10sec (maybe buff)
...
enum AVStates { POINT_ASSAULTED = 0, POINT_CONTROLLED = 1 };
...
const uint32 avGraveyardEntries[BG_AV_MAX_GRAVEYARDS] = {
    BG_AV_GRAVE_STORM_AID, BG_AV_GRAVE_STORM_GRAVE,   BG_AV_GRAVE_STONE_GRAVE,
    BG_AV_GRAVE_SNOWFALL,  BG_AV_GRAVE_ICE_GRAVE,     BG_AV_GRAVE_FROSTWOLF,
    BG_AV_GRAVE_FROST_HUT, BG_AV_GRAVE_MAIN_ALLIANCE, BG_AV_GRAVE_MAIN_HORDE};
...
const AlteracNodeStates avNodeWorldStates[BG_AV_MAX_NODES] = {
    // Alliance graveyards
    {BG_AV_STATE_GY_DUN_BALDAR_A, BG_AV_STATE_GY_DUN_BALDAR_A_GREY, BG_AV_STATE_GY_DUN_BALDAR_H,
     BG_AV_STATE_GY_DUN_BALDAR_H_GREY},
    {BG_AV_STATE_GY_STORMPIKE_A, BG_AV_STATE_GY_STORMPIKE_A_GREY, BG_AV_STATE_GY_STORMPIKE_H,
     BG_AV_STATE_GY_STORMPIKE_H_GREY},
    {BG_AV_STATE_GY_STONEHEARTH_A, BG_AV_STATE_GY_STONEHEARTH_A_GREY, BG_AV_STATE_GY_STONEHEARTH_H,
     BG_AV_STATE_GY_STONEHEARTH_H_GREY},

    // Center graveyard
    {BG_AV_STATE_GY_SNOWFALL_A, BG_AV_STATE_GY_SNOWFALL_A_GREY, BG_AV_STATE_GY_SNOWFALL_H,
     BG_AV_STATE_GY_SNOWFALL_H_GREY},

    // Horde graveyards
    {BG_AV_STATE_GY_ICEBLOOD_A, BG_AV_STATE_GY_ICEBLOOD_A_GREY, BG_AV_STATE_GY_ICEBLOOD_H,
     BG_AV_STATE_GY_ICEBLOOD_H_GREY},
    {BG_AV_STATE_GY_FROSTWOLF_A, BG_AV_STATE_GY_FROSTWOLF_A_GREY, BG_AV_STATE_GY_FROSTWOLF_H,
     BG_AV_STATE_GY_FROSTWOLF_H_GREY},
    {BG_AV_STATE_GY_FROST_KEEP_A, BG_AV_STATE_GY_FROST_KEEP_A_GREY, BG_AV_STATE_GY_FROST_KEEP_H,
     BG_AV_STATE_GY_FROST_KEEP_H_GREY},

    // Alliance towers
    {BG_AV_STATE_SOUTH_BUNKER_A, BG_AV_STATE_SOUTH_BUNKER_A_GREY, BG_AV_STATE_SOUTH_BUNKER_H,
     BG_AV_STATE_SOUTH_BUNKER_H_GREY},
    {BG_AV_STATE_NORTH_BUNKER_A, BG_AV_STATE_NORTH_BUNKER_A_GREY, BG_AV_STATE_NORTH_BUNKER_H,
     BG_AV_STATE_NORTH_BUNKER_H_GREY},
    {BG_AV_STATE_ICEWING_BUNKER_A, BG_AV_STATE_ICEWING_BUNKER_A_GREY, BG_AV_STATE_ICEWING_BUNKER_H,
     BG_AV_STATE_ICEWING_BUNKER_H_GREY},
    {BG_AV_STATE_STONE_BUNKER_A, BG_AV_STATE_STONE_BUNKER_A_GREY, BG_AV_STATE_STONE_BUNKER_H,
     BG_AV_STATE_STONE_BUNKER_H_GREY},

    // Horde towers
    {BG_AV_STATE_ICEBLOOD_TOWER_A, BG_AV_STATE_ICEBLOOD_TOWER_A_GREY, BG_AV_STATE_ICEBLOOD_TOWER_H,
     BG_AV_STATE_ICEBLOOD_TOWER_H_GREY},
    {BG_AV_STATE_TOWER_POINT_A, BG_AV_STATE_TOWER_POINT_A_GREY, BG_AV_STATE_TOWER_POINT_H,
     BG_AV_STATE_TOWER_POINT_H_GREY},
    {BG_AV_STATE_FROSTWOLF_EAST_A, BG_AV_STATE_FROSTWOLF_EAST_A_GREY, BG_AV_STATE_FROSTWOLF_EAST_H,
     BG_AV_STATE_FROSTWOLF_EAST_H_GREY},
    {BG_AV_STATE_FROSTWOLF_WEST_A, BG_AV_STATE_FROSTWOLF_WEST_A_GREY, BG_AV_STATE_FROSTWOLF_WEST_H,
     BG_AV_STATE_FROSTWOLF_WEST_H_GREY},
};
...
public:
  BattleGroundAVScore()
      : graveyardsAssaulted(0), graveyardsDefended(0), towersAssaulted(0), towersDefended(0), secondaryObjectives(0){};
...
public:
  ...
  // Conditions
  bool IsConditionFulfilled(Player const *source, uint32 conditionId, WorldObject const *conditionSource,
                            uint32 conditionSourceType) override;
